...
public final class DiskTypeAggregatedList implements ApiMessage {
  ...
  public static Builder newBuilder(DiskTypeAggregatedList prototype) {
  ...
  public static DiskTypeAggregatedList getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }
  private static final DiskTypeAggregatedList DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new DiskTypeAggregatedList();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(DiskTypeAggregatedList other) {
      if (other == DiskTypeAggregatedList.getDefaultInstance()) return this;
      if (other.getId() != null) {
        this.id = other.id;
      }
    ...
    Builder(DiskTypeAggregatedList source) {
      this.id = source.id;
    ...
    public DiskTypeAggregatedList build() {
      ...
      return new DiskTypeAggregatedList(
        id,
        items,
        kind,
        nextPageToken,
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof DiskTypeAggregatedList) {
