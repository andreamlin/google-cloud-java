...
public class RegionOperationStubSettings extends StubSettings<RegionOperationStubSettings> {
  ...
  private final UnaryCallSettings<DeleteRegionOperationHttpRequest, nullTypeName> deleteRegionOperationSettings;
   ...
   */
  public UnaryCallSettings<DeleteRegionOperationHttpRequest, nullTypeName> deleteRegionOperationSettings() {
  ...
  public static class Builder extends StubSettings.Builder<RegionOperationStubSettings, Builder> {
    ...
    private final UnaryCallSettings.Builder<DeleteRegionOperationHttpRequest, nullTypeName> deleteRegionOperationSettings;
     ...
     */
    public UnaryCallSettings.Builder<DeleteRegionOperationHttpRequest, nullTypeName> deleteRegionOperationSettings() {
      return deleteRegionOperationSettings;
    }
