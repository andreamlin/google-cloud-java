...
public class GlobalOperationStubSettings extends StubSettings<GlobalOperationStubSettings> {
  ...
  private final UnaryCallSettings<DeleteGlobalOperationHttpRequest, nullTypeName> deleteGlobalOperationSettings;
   ...
   */
  public UnaryCallSettings<DeleteGlobalOperationHttpRequest, nullTypeName> deleteGlobalOperationSettings() {
  ...
  public static class Builder extends StubSettings.Builder<GlobalOperationStubSettings, Builder> {
    ...
    private final UnaryCallSettings.Builder<DeleteGlobalOperationHttpRequest, nullTypeName> deleteGlobalOperationSettings;
     ...
     */
    public UnaryCallSettings.Builder<DeleteGlobalOperationHttpRequest, nullTypeName> deleteGlobalOperationSettings() {
      return deleteGlobalOperationSettings;
    }
