...
public class GlobalOperationClient implements BackgroundResource {
   ...
   * try (GlobalOperationClient globalOperationClient = GlobalOperationClient.create()) {
   *   ProjectName project = ProjectName.of("[PROJECT]");
   *   for (Operation element : globalOperationClient.aggregatedListGlobalOperations(project.toString()).iterateAll()) {
   *     // doThingsWith(element);
   *   }
   * }
   * </code></pre>
   ...
   */
  @BetaApi
  public final UnaryCallable<DeleteGlobalOperationHttpRequest, nullTypeName> deleteGlobalOperationCallable() {
