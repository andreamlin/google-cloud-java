...
public final class TargetInstanceAggregatedList implements ApiMessage {
  ...
  private final TargetInstancesScopedList items;
  ...
  private TargetInstanceAggregatedList(
      String id,
      TargetInstancesScopedList items,
      String kind,
  ...
  public TargetInstancesScopedList getItems() {
    return items;
  }
  ...
  public static class Builder {
    private String id;
    private TargetInstancesScopedList items;
    private String kind;
    ...
    public Builder setItems(TargetInstancesScopedList items) {
      this.items = items;
      return this;
    }
