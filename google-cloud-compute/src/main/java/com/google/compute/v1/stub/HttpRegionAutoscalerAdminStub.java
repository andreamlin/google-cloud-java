...
@BetaApi
public class HttpRegionAutoscalerAdminStub extends RegionAutoscalerAdminStub {
  ...
  public static final HttpRegionAutoscalerAdminStub create(RegionAutoscalerAdminSettings settings) throws IOException {
    return new HttpRegionAutoscalerAdminStub(settings, ClientContext.create(settings));
  }

  public static final HttpRegionAutoscalerAdminStub create(ClientContext clientContext) throws IOException {
    return new HttpRegionAutoscalerAdminStub(RegionAutoscalerAdminSettings.defaultBuilder().build(), clientContext);
  }

  /**
   * Constructs an instance of HttpRegionAutoscalerAdminStub, using the given settings.
   * This is protected so that it is easy to make a subclass, but otherwise, the static
   * factory methods should be preferred.
   */
  protected HttpRegionAutoscalerAdminStub(RegionAutoscalerAdminSettings settings, ClientContext clientContext) throws IOException {
