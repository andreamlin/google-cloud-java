...
import com.google.compute.v1.HealthCheckAdminSettings;
...
@BetaApi
public class HttpJsonHealthCheckAdminStub extends HealthCheckAdminStub {
  ...
  public static final HttpJsonHealthCheckAdminStub create(HealthCheckAdminSettings settings) throws IOException {
    return new HttpJsonHealthCheckAdminStub(settings, ClientContext.create(settings));
  }

  public static final HttpJsonHealthCheckAdminStub create(ClientContext clientContext) throws IOException {
    return new HttpJsonHealthCheckAdminStub(HealthCheckAdminSettings.defaultBuilder().build(), clientContext);
  }

  /**
   * Constructs an instance of HttpJsonHealthCheckAdminStub, using the given settings.
   * This is protected so that it is easy to make a subclass, but otherwise, the static
   * factory methods should be preferred.
   */
  protected HttpJsonHealthCheckAdminStub(HealthCheckAdminSettings settings, ClientContext clientContext) throws IOException {
