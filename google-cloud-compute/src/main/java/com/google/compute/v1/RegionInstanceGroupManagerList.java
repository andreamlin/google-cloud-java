...
public final class RegionInstanceGroupManagerList implements ApiMessage {
  ...
  public List<InstanceGroupManager> getItems() {
    return items;
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(RegionInstanceGroupManagerList other) {
      if (other == RegionInstanceGroupManagerList.getDefaultInstance()) return this;
      if (other.getId() != null) {
        this.id = other.id;
      }
    ...
    Builder(RegionInstanceGroupManagerList source) {
      this.id = source.id;
