...
@BetaApi
public class HttpJsonLicensAdminStub extends LicensAdminStub {
  ...
  public static final HttpJsonLicensAdminStub create(LicensAdminSettings settings) throws IOException {
    return new HttpJsonLicensAdminStub(settings, ClientContext.create(settings));
  }

  public static final HttpJsonLicensAdminStub create(ClientContext clientContext) throws IOException {
    return new HttpJsonLicensAdminStub(LicensAdminSettings.defaultBuilder().build(), clientContext);
  }

  /**
   * Constructs an instance of HttpJsonLicensAdminStub, using the given settings.
   * This is protected so that it is easy to make a subclass, but otherwise, the static
   * factory methods should be preferred.
   */
  protected HttpJsonLicensAdminStub(LicensAdminSettings settings, ClientContext clientContext) throws IOException {
