...
@BetaApi
public class HttpDiskTypeAdminStub extends DiskTypeAdminStub {
  ...
  public static final HttpDiskTypeAdminStub create(DiskTypeAdminSettings settings) throws IOException {
    return new HttpDiskTypeAdminStub(settings, ClientContext.create(settings));
  }

  public static final HttpDiskTypeAdminStub create(ClientContext clientContext) throws IOException {
    return new HttpDiskTypeAdminStub(DiskTypeAdminSettings.defaultBuilder().build(), clientContext);
  }

  /**
   * Constructs an instance of HttpDiskTypeAdminStub, using the given settings.
   * This is protected so that it is easy to make a subclass, but otherwise, the static
   * factory methods should be preferred.
   */
  protected HttpDiskTypeAdminStub(DiskTypeAdminSettings settings, ClientContext clientContext) throws IOException {
