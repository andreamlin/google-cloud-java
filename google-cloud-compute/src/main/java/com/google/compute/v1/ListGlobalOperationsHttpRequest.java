...
@Generated("by GAPIC")
@BetaApi
public final class ListGlobalOperationsHttpRequest implements ApiMessage {
  ...
  private ListGlobalOperationsHttpRequest() {
  ...
  public static Builder newBuilder(ListGlobalOperationsHttpRequest prototype) {
  ...
  public static ListGlobalOperationsHttpRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }
  private static final ListGlobalOperationsHttpRequest DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new ListGlobalOperationsHttpRequest();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(ListGlobalOperationsHttpRequest other) {
      if (other == ListGlobalOperationsHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(ListGlobalOperationsHttpRequest source) {
    ...
    public ListGlobalOperationsHttpRequest build() {
      String missing = "";
      ...
      return new ListGlobalOperationsHttpRequest(
        access_token,
        callback,
        fields,
        filter,
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof ListGlobalOperationsHttpRequest) {
      ListGlobalOperationsHttpRequest that = (ListGlobalOperationsHttpRequest) o;
      return
