...
@BetaApi
public class HttpJsonProjectAdminStub extends ProjectAdminStub {
  ...
  public static final HttpJsonProjectAdminStub create(ProjectAdminSettings settings) throws IOException {
    return new HttpJsonProjectAdminStub(settings, ClientContext.create(settings));
  }

  public static final HttpJsonProjectAdminStub create(ClientContext clientContext) throws IOException {
    return new HttpJsonProjectAdminStub(ProjectAdminSettings.defaultBuilder().build(), clientContext);
  }

  /**
   * Constructs an instance of HttpJsonProjectAdminStub, using the given settings.
   * This is protected so that it is easy to make a subclass, but otherwise, the static
   * factory methods should be preferred.
   */
  protected HttpJsonProjectAdminStub(ProjectAdminSettings settings, ClientContext clientContext) throws IOException {
