...
public final class VpnTunnelAggregatedList implements ApiMessage {
  ...
  public static Builder newBuilder(VpnTunnelAggregatedList prototype) {
  ...
  public static VpnTunnelAggregatedList getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }
  private static final VpnTunnelAggregatedList DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new VpnTunnelAggregatedList();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(VpnTunnelAggregatedList other) {
      if (other == VpnTunnelAggregatedList.getDefaultInstance()) return this;
      if (other.getId() != null) {
        this.id = other.id;
      }
    ...
    Builder(VpnTunnelAggregatedList source) {
      this.id = source.id;
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof VpnTunnelAggregatedList) {
