...
@BetaApi
public class InstanceGroupManagerStubSettings extends StubSettings<InstanceGroupManagerStubSettings> {
  /**
   ...
   */
  public static class Builder extends StubSettings.Builder<InstanceGroupManagerStubSettings, Builder> {
