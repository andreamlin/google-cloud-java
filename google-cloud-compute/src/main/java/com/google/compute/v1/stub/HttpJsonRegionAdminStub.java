...
import com.google.compute.v1.RegionAdminSettings;
...
@BetaApi
public class HttpJsonRegionAdminStub extends RegionAdminStub {
  ...
  public static final HttpJsonRegionAdminStub create(RegionAdminSettings settings) throws IOException {
    return new HttpJsonRegionAdminStub(settings, ClientContext.create(settings));
  }

  public static final HttpJsonRegionAdminStub create(ClientContext clientContext) throws IOException {
    return new HttpJsonRegionAdminStub(RegionAdminSettings.defaultBuilder().build(), clientContext);
  }

  /**
   * Constructs an instance of HttpJsonRegionAdminStub, using the given settings.
   * This is protected so that it is easy to make a subclass, but otherwise, the static
   * factory methods should be preferred.
   */
  protected HttpJsonRegionAdminStub(RegionAdminSettings settings, ClientContext clientContext) throws IOException {
