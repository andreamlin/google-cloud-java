...
@BetaApi
public class HttpRegionAdminStub extends RegionAdminStub {
  ...
  public static final HttpRegionAdminStub create(RegionAdminSettings settings) throws IOException {
    return new HttpRegionAdminStub(settings, ClientContext.create(settings));
  }

  public static final HttpRegionAdminStub create(ClientContext clientContext) throws IOException {
    return new HttpRegionAdminStub(RegionAdminSettings.defaultBuilder().build(), clientContext);
  }

  /**
   * Constructs an instance of HttpRegionAdminStub, using the given settings.
   * This is protected so that it is easy to make a subclass, but otherwise, the static
   * factory methods should be preferred.
   */
  protected HttpRegionAdminStub(RegionAdminSettings settings, ClientContext clientContext) throws IOException {
