...
public final class SwitchToCustomModeNetworkHttpRequest implements ApiMessage {
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(SwitchToCustomModeNetworkHttpRequest other) {
      if (other == SwitchToCustomModeNetworkHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(SwitchToCustomModeNetworkHttpRequest source) {
