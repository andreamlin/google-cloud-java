...
@Generated("by GAPIC")
@BetaApi
public final class ListDiskTypesHttpRequest implements ApiMessage {
  ...
  private ListDiskTypesHttpRequest() {
  ...
  public static Builder newBuilder(ListDiskTypesHttpRequest prototype) {
  ...
  public static ListDiskTypesHttpRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }
  private static final ListDiskTypesHttpRequest DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new ListDiskTypesHttpRequest();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(ListDiskTypesHttpRequest other) {
      if (other == ListDiskTypesHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(ListDiskTypesHttpRequest source) {
    ...
    public ListDiskTypesHttpRequest build() {
      String missing = "";
      ...
      return new ListDiskTypesHttpRequest(
        access_token,
        callback,
        fields,
        filter,
    ...
    public final Builder setZoneWithDiskTypesZoneName(DiskTypesZoneName value) {
      if (value == null) {
        return
            setProject("").          setZone("")
            ;
    ...
    public final DiskTypesZoneName getZoneAsDiskTypesZoneName() {
      return DiskTypesZoneName.create(
          getProject(),
          getZone()
          );
    }
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof ListDiskTypesHttpRequest) {
      ListDiskTypesHttpRequest that = (ListDiskTypesHttpRequest) o;
      return
