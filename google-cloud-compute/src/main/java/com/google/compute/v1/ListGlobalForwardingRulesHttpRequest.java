...
public final class ListGlobalForwardingRulesHttpRequest implements ApiMessage {
  ...
  private ListGlobalForwardingRulesHttpRequest() {
  ...
  public static Builder newBuilder(ListGlobalForwardingRulesHttpRequest prototype) {
  ...
  public static ListGlobalForwardingRulesHttpRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }
  private static final ListGlobalForwardingRulesHttpRequest DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new ListGlobalForwardingRulesHttpRequest();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(ListGlobalForwardingRulesHttpRequest other) {
      if (other == ListGlobalForwardingRulesHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(ListGlobalForwardingRulesHttpRequest source) {
    ...
    public ListGlobalForwardingRulesHttpRequest build() {
      String missing = "";
      ...
      return new ListGlobalForwardingRulesHttpRequest(
        access_token,
        callback,
        fields,
        filter,
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof ListGlobalForwardingRulesHttpRequest) {
      ListGlobalForwardingRulesHttpRequest that = (ListGlobalForwardingRulesHttpRequest) o;
      return
