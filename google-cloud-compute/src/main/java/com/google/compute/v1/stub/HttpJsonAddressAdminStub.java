...
import com.google.compute.v1.AddressAdminSettings;
...
@BetaApi
public class HttpJsonAddressAdminStub extends AddressAdminStub {
  ...
  public static final HttpJsonAddressAdminStub create(AddressAdminSettings settings) throws IOException {
    return new HttpJsonAddressAdminStub(settings, ClientContext.create(settings));
  }

  public static final HttpJsonAddressAdminStub create(ClientContext clientContext) throws IOException {
    return new HttpJsonAddressAdminStub(AddressAdminSettings.defaultBuilder().build(), clientContext);
  }

  /**
   * Constructs an instance of HttpJsonAddressAdminStub, using the given settings.
   * This is protected so that it is easy to make a subclass, but otherwise, the static
   * factory methods should be preferred.
   */
  protected HttpJsonAddressAdminStub(AddressAdminSettings settings, ClientContext clientContext) throws IOException {
