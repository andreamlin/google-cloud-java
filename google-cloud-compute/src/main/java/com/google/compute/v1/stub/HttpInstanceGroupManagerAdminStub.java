...
@BetaApi
public class HttpInstanceGroupManagerAdminStub extends InstanceGroupManagerAdminStub {
  ...
  public static final HttpInstanceGroupManagerAdminStub create(InstanceGroupManagerAdminSettings settings) throws IOException {
    return new HttpInstanceGroupManagerAdminStub(settings, ClientContext.create(settings));
  }

  public static final HttpInstanceGroupManagerAdminStub create(ClientContext clientContext) throws IOException {
    return new HttpInstanceGroupManagerAdminStub(InstanceGroupManagerAdminSettings.defaultBuilder().build(), clientContext);
  }

  /**
   * Constructs an instance of HttpInstanceGroupManagerAdminStub, using the given settings.
   * This is protected so that it is easy to make a subclass, but otherwise, the static
   * factory methods should be preferred.
   */
  protected HttpInstanceGroupManagerAdminStub(InstanceGroupManagerAdminSettings settings, ClientContext clientContext) throws IOException {
