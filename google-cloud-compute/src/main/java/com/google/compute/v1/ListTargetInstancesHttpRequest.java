...
public final class ListTargetInstancesHttpRequest implements ApiMessage {
  ...
  private ListTargetInstancesHttpRequest() {
  ...
  public static Builder newBuilder(ListTargetInstancesHttpRequest prototype) {
  ...
  public static ListTargetInstancesHttpRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }
  private static final ListTargetInstancesHttpRequest DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new ListTargetInstancesHttpRequest();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(ListTargetInstancesHttpRequest other) {
      if (other == ListTargetInstancesHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(ListTargetInstancesHttpRequest source) {
    ...
    public ListTargetInstancesHttpRequest build() {
      String missing = "";
      ...
      return new ListTargetInstancesHttpRequest(
        access_token,
        callback,
        fields,
        filter,
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof ListTargetInstancesHttpRequest) {
      ListTargetInstancesHttpRequest that = (ListTargetInstancesHttpRequest) o;
      return
