...
@BetaApi
public class HttpRegionInstanceGroupAdminStub extends RegionInstanceGroupAdminStub {
  ...
  public static final HttpRegionInstanceGroupAdminStub create(RegionInstanceGroupAdminSettings settings) throws IOException {
    return new HttpRegionInstanceGroupAdminStub(settings, ClientContext.create(settings));
  }

  public static final HttpRegionInstanceGroupAdminStub create(ClientContext clientContext) throws IOException {
    return new HttpRegionInstanceGroupAdminStub(RegionInstanceGroupAdminSettings.defaultBuilder().build(), clientContext);
  }

  /**
   * Constructs an instance of HttpRegionInstanceGroupAdminStub, using the given settings.
   * This is protected so that it is easy to make a subclass, but otherwise, the static
   * factory methods should be preferred.
   */
  protected HttpRegionInstanceGroupAdminStub(RegionInstanceGroupAdminSettings settings, ClientContext clientContext) throws IOException {
