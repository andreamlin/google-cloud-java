...
@Generated("by GAPIC")
@BetaApi
public final class ListBackendServicesHttpRequest implements ApiMessage {
  ...
  private ListBackendServicesHttpRequest() {
  ...
  public static Builder newBuilder(ListBackendServicesHttpRequest prototype) {
  ...
  public static ListBackendServicesHttpRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }
  private static final ListBackendServicesHttpRequest DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new ListBackendServicesHttpRequest();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(ListBackendServicesHttpRequest other) {
      if (other == ListBackendServicesHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(ListBackendServicesHttpRequest source) {
    ...
    public ListBackendServicesHttpRequest build() {
      String missing = "";
      ...
      return new ListBackendServicesHttpRequest(
        access_token,
        callback,
        fields,
        filter,
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof ListBackendServicesHttpRequest) {
      ListBackendServicesHttpRequest that = (ListBackendServicesHttpRequest) o;
      return
