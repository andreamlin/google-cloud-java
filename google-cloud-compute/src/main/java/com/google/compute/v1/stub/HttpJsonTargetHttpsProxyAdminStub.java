...
@BetaApi
public class HttpJsonTargetHttpsProxyAdminStub extends TargetHttpsProxyAdminStub {
  ...
  public static final HttpJsonTargetHttpsProxyAdminStub create(TargetHttpsProxyAdminSettings settings) throws IOException {
    return new HttpJsonTargetHttpsProxyAdminStub(settings, ClientContext.create(settings));
  }

  public static final HttpJsonTargetHttpsProxyAdminStub create(ClientContext clientContext) throws IOException {
    return new HttpJsonTargetHttpsProxyAdminStub(TargetHttpsProxyAdminSettings.defaultBuilder().build(), clientContext);
  }

  /**
   * Constructs an instance of HttpJsonTargetHttpsProxyAdminStub, using the given settings.
   * This is protected so that it is easy to make a subclass, but otherwise, the static
   * factory methods should be preferred.
   */
  protected HttpJsonTargetHttpsProxyAdminStub(TargetHttpsProxyAdminSettings settings, ClientContext clientContext) throws IOException {
