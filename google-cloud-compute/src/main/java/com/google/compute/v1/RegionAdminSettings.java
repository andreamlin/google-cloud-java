...
/**
 * Settings class to configure an instance of {@link RegionAdminClient}.
 *
 ...
 * <pre>
 * <code>
 * RegionAdminSettings.Builder regionAdminSettingsBuilder =
 *     RegionAdminSettings.defaultBuilder();
 * regionAdminSettingsBuilder.getRegionSettings().getRetrySettingsBuilder()
 *     .setTotalTimeout(Duration.ofSeconds(30));
 * RegionAdminSettings regionAdminSettings = regionAdminSettingsBuilder.build();
 * </code>
 * </pre>
 */
@Generated("by GAPIC v0.0.5")
@BetaApi
public class RegionAdminSettings extends ClientSettings {
  /**
  ...
  private static String getGapicVersion() {
    if (gapicVersion == null) {
      gapicVersion = PropertiesProvider.loadProperty(
          RegionAdminSettings.class, PROPERTIES_FILE, META_VERSION_KEY);
  ...
  private RegionAdminSettings(Builder settingsBuilder) throws IOException {
    super(
  ...
  /**
   * Builder for RegionAdminSettings.
   */
  public static class Builder extends ClientSettings.Builder {
    ...
    private Builder(RegionAdminSettings settings) {
      super(settings);
    ...
    @Override
    public RegionAdminSettings build() throws IOException {
      return new RegionAdminSettings(this);
    }
  }
}