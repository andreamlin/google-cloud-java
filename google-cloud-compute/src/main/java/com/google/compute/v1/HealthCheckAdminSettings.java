...
import com.google.compute.v1.stub.HttpJsonHealthCheckAdminStub;
...
/**
 * Settings class to configure an instance of {@link HealthCheckAdminClient}.
 *
 ...
 * <pre>
 * <code>
 * HealthCheckAdminSettings.Builder healthCheckAdminSettingsBuilder =
 *     HealthCheckAdminSettings.defaultBuilder();
 * healthCheckAdminSettingsBuilder.deleteHealthCheckSettings().getRetrySettingsBuilder()
 *     .setTotalTimeout(Duration.ofSeconds(30));
 * HealthCheckAdminSettings healthCheckAdminSettings = healthCheckAdminSettingsBuilder.build();
 * </code>
 * </pre>
 */
@Generated("by GAPIC v0.0.5")
@BetaApi
public class HealthCheckAdminSettings extends ClientSettings {
  /**
  ...
  public HealthCheckAdminStub createStub() throws IOException {
    if (getTransportProvider().getTransportName().equals(HttpJsonTransport.getHttpJsonTransportName())) {
      return HttpJsonHealthCheckAdminStub.create(this);
    } else {
  ...
  private static String getGapicVersion() {
    if (gapicVersion == null) {
      gapicVersion = PropertiesProvider.loadProperty(
          HealthCheckAdminSettings.class, PROPERTIES_FILE, META_VERSION_KEY);
  ...
  private HealthCheckAdminSettings(Builder settingsBuilder) throws IOException {
    super(
  ...
  /**
   * Builder for HealthCheckAdminSettings.
   */
  public static class Builder extends ClientSettings.Builder {
    ...
    private Builder(HealthCheckAdminSettings settings) {
      super(settings);
    ...
    @Override
    public HealthCheckAdminSettings build() throws IOException {
      return new HealthCheckAdminSettings(this);
    }
  }
}