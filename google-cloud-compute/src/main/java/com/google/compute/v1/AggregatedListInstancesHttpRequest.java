...
public final class AggregatedListInstancesHttpRequest implements ApiMessage {
  ...
  private AggregatedListInstancesHttpRequest() {
  ...
  public static Builder newBuilder(AggregatedListInstancesHttpRequest prototype) {
  ...
  public static AggregatedListInstancesHttpRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }
  private static final AggregatedListInstancesHttpRequest DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new AggregatedListInstancesHttpRequest();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(AggregatedListInstancesHttpRequest other) {
      if (other == AggregatedListInstancesHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(AggregatedListInstancesHttpRequest source) {
    ...
    public AggregatedListInstancesHttpRequest build() {
      String missing = "";
      ...
      return new AggregatedListInstancesHttpRequest(
        access_token,
        callback,
        fields,
        filter,
    ...
    public final Builder setProjectWithInstancesProjectName(InstancesProjectName value) {
      if (value == null) {
        return
            setProject("")
            ;
    ...
    public final InstancesProjectName getProjectAsInstancesProjectName() {
      return InstancesProjectName.create(
          getProject()
          );
    }
  }
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof AggregatedListInstancesHttpRequest) {
      AggregatedListInstancesHttpRequest that = (AggregatedListInstancesHttpRequest) o;
      return
