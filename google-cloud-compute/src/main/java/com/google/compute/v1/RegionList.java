...
@Generated("by GAPIC")
@BetaApi
public final class RegionList implements ApiMessage {
  ...
  public List<Region> getItemsList() {
    return items;
  }
  ...
  public static Builder newBuilder(RegionList prototype) {
  ...
  private static final RegionList DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new RegionList();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(RegionList other) {
      if (other == RegionList.getDefaultInstance()) return this;
      if (other.getId() != null) {
        this.id = other.id;
      }
    ...
    public Builder addAllItems(List<Region> items) {
      if (this.items == null) {
    ...
    public Builder addItems(Region items) {
