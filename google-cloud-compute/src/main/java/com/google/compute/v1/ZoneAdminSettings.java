...
/**
 * Settings class to configure an instance of {@link ZoneAdminClient}.
 *
 ...
 * <pre>
 * <code>
 * ZoneAdminSettings.Builder zoneAdminSettingsBuilder =
 *     ZoneAdminSettings.defaultBuilder();
 * zoneAdminSettingsBuilder.getZoneSettings().getRetrySettingsBuilder()
 *     .setTotalTimeout(Duration.ofSeconds(30));
 * ZoneAdminSettings zoneAdminSettings = zoneAdminSettingsBuilder.build();
 * </code>
 * </pre>
 */
@Generated("by GAPIC v0.0.5")
@BetaApi
public class ZoneAdminSettings extends ClientSettings {
  /**
  ...
  private final SimpleCallSettings<GetZoneHttpRequest, Zone> getZoneSettings;
   ...
   */
  public SimpleCallSettings<GetZoneHttpRequest, Zone> getZoneSettings() {
  ...
  private static String getGapicVersion() {
    if (gapicVersion == null) {
      gapicVersion = PropertiesProvider.loadProperty(
          ZoneAdminSettings.class, PROPERTIES_FILE, META_VERSION_KEY);
  ...
  private ZoneAdminSettings(Builder settingsBuilder) throws IOException {
    super(
  ...
  /**
   * Builder for ZoneAdminSettings.
   */
  public static class Builder extends ClientSettings.Builder {
    private final ImmutableList<UnaryCallSettings.Builder> unaryMethodSettingsBuilders;

    private final SimpleCallSettings.Builder<GetZoneHttpRequest, Zone> getZoneSettings;
    ...
    private Builder(ClientContext clientContext) {
      ...
      getZoneSettings = SimpleCallSettings.newBuilder();
    ...
    private Builder(ZoneAdminSettings settings) {
      super(settings);
     ...
     */
    public SimpleCallSettings.Builder<GetZoneHttpRequest, Zone> getZoneSettings() {
      return getZoneSettings;
    }
    ...
    @Override
    public ZoneAdminSettings build() throws IOException {
      return new ZoneAdminSettings(this);
    }
  }
}