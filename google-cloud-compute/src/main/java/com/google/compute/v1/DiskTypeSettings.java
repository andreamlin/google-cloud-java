...
import com.google.compute.v1.stub.HttpJsonDiskTypeStub;
 ...
 * diskTypeSettingsBuilder.getDiskTypeSettings().getRetrySettingsBuilder()
...
public class DiskTypeSettings extends ClientSettings {
  ...
  private static String getGapicVersion() {
    if (gapicVersion == null) {
      gapicVersion = PropertiesProvider.loadProperty(
          DiskTypeSettings.class, PROPERTIES_FILE, META_VERSION_KEY);
  ...
  public static class Builder extends ClientSettings.Builder {
    ...
    private Builder(DiskTypeSettings settings) {
      super(settings);
