...
public final class DeleteTargetPoolHttpRequest implements ApiMessage {
  ...
  private DeleteTargetPoolHttpRequest() {
  ...
  public static Builder newBuilder(DeleteTargetPoolHttpRequest prototype) {
  ...
  public static DeleteTargetPoolHttpRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }
  private static final DeleteTargetPoolHttpRequest DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new DeleteTargetPoolHttpRequest();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(DeleteTargetPoolHttpRequest other) {
      if (other == DeleteTargetPoolHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(DeleteTargetPoolHttpRequest source) {
    ...
    public DeleteTargetPoolHttpRequest build() {
      String missing = "";
      ...
      return new DeleteTargetPoolHttpRequest(
        access_token,
        callback,
        fields,
        key,
  ...
  public String toString() {
    return "DeleteTargetPoolHttpRequest{"
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof DeleteTargetPoolHttpRequest) {
      DeleteTargetPoolHttpRequest that = (DeleteTargetPoolHttpRequest) o;
      return
