...
@Generated("by GAPIC")
@BetaApi
public final class ListTargetVpnGatewaysHttpRequest implements ApiMessage {
  ...
  private ListTargetVpnGatewaysHttpRequest() {
  ...
  public static Builder newBuilder(ListTargetVpnGatewaysHttpRequest prototype) {
  ...
  public static ListTargetVpnGatewaysHttpRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }
  private static final ListTargetVpnGatewaysHttpRequest DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new ListTargetVpnGatewaysHttpRequest();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(ListTargetVpnGatewaysHttpRequest other) {
      if (other == ListTargetVpnGatewaysHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(ListTargetVpnGatewaysHttpRequest source) {
    ...
    public ListTargetVpnGatewaysHttpRequest build() {
      String missing = "";
      ...
      return new ListTargetVpnGatewaysHttpRequest(
        access_token,
        callback,
        fields,
        filter,
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof ListTargetVpnGatewaysHttpRequest) {
      ListTargetVpnGatewaysHttpRequest that = (ListTargetVpnGatewaysHttpRequest) o;
      return
