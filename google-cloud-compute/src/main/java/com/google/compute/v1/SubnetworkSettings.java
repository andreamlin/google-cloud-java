...
import com.google.compute.v1.stub.HttpJsonSubnetworkStub;
...
public class SubnetworkSettings extends ClientSettings {
  ...
  private static String getGapicVersion() {
    if (gapicVersion == null) {
      gapicVersion = PropertiesProvider.loadProperty(
          SubnetworkSettings.class, PROPERTIES_FILE, META_VERSION_KEY);
  ...
  public static class Builder extends ClientSettings.Builder {
    ...
    private Builder(SubnetworkSettings settings) {
      super(settings);
