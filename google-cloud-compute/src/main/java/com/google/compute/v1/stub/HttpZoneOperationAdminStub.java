...
public class HttpZoneOperationAdminStub extends ZoneOperationAdminStub {
  ...
  public static final HttpZoneOperationAdminStub create(ZoneOperationAdminSettings settings) throws IOException {
    return new HttpZoneOperationAdminStub(settings, ClientContext.create(settings));
  }

  public static final HttpZoneOperationAdminStub create(ClientContext clientContext) throws IOException {
    return new HttpZoneOperationAdminStub(ZoneOperationAdminSettings.defaultBuilder().build(), clientContext);
  }

  /**
   * Constructs an instance of HttpZoneOperationAdminStub, using the given settings.
   * This is protected so that it is easy to make a subclass, but otherwise, the static
   * factory methods should be preferred.
   */
  protected HttpZoneOperationAdminStub(ZoneOperationAdminSettings settings, ClientContext clientContext) throws IOException {
