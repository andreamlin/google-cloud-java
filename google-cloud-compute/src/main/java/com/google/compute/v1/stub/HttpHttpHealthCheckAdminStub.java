...
@BetaApi
public class HttpHttpHealthCheckAdminStub extends HttpHealthCheckAdminStub {
  ...
  public static final HttpHttpHealthCheckAdminStub create(HttpHealthCheckAdminSettings settings) throws IOException {
    return new HttpHttpHealthCheckAdminStub(settings, ClientContext.create(settings));
  }

  public static final HttpHttpHealthCheckAdminStub create(ClientContext clientContext) throws IOException {
    return new HttpHttpHealthCheckAdminStub(HttpHealthCheckAdminSettings.defaultBuilder().build(), clientContext);
  }

  /**
   * Constructs an instance of HttpHttpHealthCheckAdminStub, using the given settings.
   * This is protected so that it is easy to make a subclass, but otherwise, the static
   * factory methods should be preferred.
   */
  protected HttpHttpHealthCheckAdminStub(HttpHealthCheckAdminSettings settings, ClientContext clientContext) throws IOException {
