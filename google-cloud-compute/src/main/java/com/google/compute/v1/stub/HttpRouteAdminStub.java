...
@BetaApi
public class HttpRouteAdminStub extends RouteAdminStub {
  ...
  public static final HttpRouteAdminStub create(RouteAdminSettings settings) throws IOException {
    return new HttpRouteAdminStub(settings, ClientContext.create(settings));
  }

  public static final HttpRouteAdminStub create(ClientContext clientContext) throws IOException {
    return new HttpRouteAdminStub(RouteAdminSettings.defaultBuilder().build(), clientContext);
  }

  /**
   * Constructs an instance of HttpRouteAdminStub, using the given settings.
   * This is protected so that it is easy to make a subclass, but otherwise, the static
   * factory methods should be preferred.
   */
  protected HttpRouteAdminStub(RouteAdminSettings settings, ClientContext clientContext) throws IOException {
