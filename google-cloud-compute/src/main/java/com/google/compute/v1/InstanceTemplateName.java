...
public final class InstanceTemplateName implements ResourceName {
  ...
  public static ResourceNameFactory<InstanceTemplateName> newFactory() {
    return new ResourceNameFactory<InstanceTemplateName>() {
      public InstanceTemplateName parse(String formattedString) {return InstanceTemplateName.parse(formattedString);}
    };
  }
