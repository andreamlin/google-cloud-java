...
public final class AggregatedListAutoscalersHttpRequest implements ApiMessage {
  ...
  private AggregatedListAutoscalersHttpRequest() {
  ...
  public static Builder newBuilder(AggregatedListAutoscalersHttpRequest prototype) {
  ...
  public static AggregatedListAutoscalersHttpRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }
  private static final AggregatedListAutoscalersHttpRequest DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new AggregatedListAutoscalersHttpRequest();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(AggregatedListAutoscalersHttpRequest other) {
      if (other == AggregatedListAutoscalersHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(AggregatedListAutoscalersHttpRequest source) {
    ...
    public AggregatedListAutoscalersHttpRequest build() {
      String missing = "";
      ...
      return new AggregatedListAutoscalersHttpRequest(
        access_token,
        callback,
        fields,
        filter,
    ...
    public final Builder setProjectWithAutoscalersProjectName(AutoscalersProjectName value) {
      if (value == null) {
        return
            setProject("")
            ;
    ...
    public final AutoscalersProjectName getProjectAsAutoscalersProjectName() {
      return AutoscalersProjectName.create(
          getProject()
          );
    }
  }
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof AggregatedListAutoscalersHttpRequest) {
      AggregatedListAutoscalersHttpRequest that = (AggregatedListAutoscalersHttpRequest) o;
      return
