...
@Generated("by GAPIC")
@BetaApi
public final class ListFirewallsHttpRequest implements ApiMessage {
  ...
  private ListFirewallsHttpRequest() {
  ...
  public static Builder newBuilder(ListFirewallsHttpRequest prototype) {
  ...
  public static ListFirewallsHttpRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }
  private static final ListFirewallsHttpRequest DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new ListFirewallsHttpRequest();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(ListFirewallsHttpRequest other) {
      if (other == ListFirewallsHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(ListFirewallsHttpRequest source) {
    ...
    public ListFirewallsHttpRequest build() {
      String missing = "";
      ...
      return new ListFirewallsHttpRequest(
        access_token,
        callback,
        fields,
        filter,
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof ListFirewallsHttpRequest) {
      ListFirewallsHttpRequest that = (ListFirewallsHttpRequest) o;
      return
