...
@BetaApi
public class HttpDiskAdminStub extends DiskAdminStub {
  ...
  public static final HttpDiskAdminStub create(DiskAdminSettings settings) throws IOException {
    return new HttpDiskAdminStub(settings, ClientContext.create(settings));
  }

  public static final HttpDiskAdminStub create(ClientContext clientContext) throws IOException {
    return new HttpDiskAdminStub(DiskAdminSettings.defaultBuilder().build(), clientContext);
  }

  /**
   * Constructs an instance of HttpDiskAdminStub, using the given settings.
   * This is protected so that it is easy to make a subclass, but otherwise, the static
   * factory methods should be preferred.
   */
  protected HttpDiskAdminStub(DiskAdminSettings settings, ClientContext clientContext) throws IOException {
