...
@BetaApi
public class HttpGlobalOperationAdminStub extends GlobalOperationAdminStub {
  ...
  public static final HttpGlobalOperationAdminStub create(GlobalOperationAdminSettings settings) throws IOException {
    return new HttpGlobalOperationAdminStub(settings, ClientContext.create(settings));
  }

  public static final HttpGlobalOperationAdminStub create(ClientContext clientContext) throws IOException {
    return new HttpGlobalOperationAdminStub(GlobalOperationAdminSettings.defaultBuilder().build(), clientContext);
  }

  /**
   * Constructs an instance of HttpGlobalOperationAdminStub, using the given settings.
   * This is protected so that it is easy to make a subclass, but otherwise, the static
   * factory methods should be preferred.
   */
  protected HttpGlobalOperationAdminStub(GlobalOperationAdminSettings settings, ClientContext clientContext) throws IOException {
