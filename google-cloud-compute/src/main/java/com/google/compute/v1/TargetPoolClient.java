...
public class TargetPoolClient implements BackgroundResource {
   ...
   * try (TargetPoolClient targetPoolClient = TargetPoolClient.create()) {
   *
   *   ApiFuture&lt;Operation&gt; future = targetPoolClient.addHealthCheckTargetPoolCallable().futureCall();
   *   // Do something
   ...
   * try (TargetPoolClient targetPoolClient = TargetPoolClient.create()) {
   *
   *   Operation response = targetPoolClient.addInstanceTargetPool();
   * }
   * </code></pre>
   *
   ...
   * try (TargetPoolClient targetPoolClient = TargetPoolClient.create()) {
   *
   *   ApiFuture&lt;Operation&gt; future = targetPoolClient.addInstanceTargetPoolCallable().futureCall();
   *   // Do something
   *   Operation response = future.get();
   * }
   * </code></pre>
   ...
   * try (TargetPoolClient targetPoolClient = TargetPoolClient.create()) {
   *
   *   for (TargetPool element : targetPoolClient.aggregatedListTargetPools().iterateAll()) {
   ...
   * try (TargetPoolClient targetPoolClient = TargetPoolClient.create()) {
   *
   *   ApiFuture&lt;AggregatedListTargetPoolsPagedResponse&gt; future = targetPoolClient.aggregatedListTargetPoolsPagedCallable().futureCall();
   *   // Do something
   ...
   *
   *   while (true) {
   *     TargetPoolAggregatedList response = targetPoolClient.aggregatedListTargetPoolsCallable().call();
   ...
   * try (TargetPoolClient targetPoolClient = TargetPoolClient.create()) {
   *
   *   Operation response = targetPoolClient.deleteTargetPool();
   * }
   * </code></pre>
   *
   ...
   * try (TargetPoolClient targetPoolClient = TargetPoolClient.create()) {
   *
   *   ApiFuture&lt;Operation&gt; future = targetPoolClient.deleteTargetPoolCallable().futureCall();
   *   // Do something
   *   Operation response = future.get();
   * }
   * </code></pre>
   ...
   * try (TargetPoolClient targetPoolClient = TargetPoolClient.create()) {
   *
   *   TargetPool response = targetPoolClient.getTargetPool();
   * }
   * </code></pre>
   *
   ...
   * try (TargetPoolClient targetPoolClient = TargetPoolClient.create()) {
   *
   *   ApiFuture&lt;TargetPool&gt; future = targetPoolClient.getTargetPoolCallable().futureCall();
   *   // Do something
   ...
   * try (TargetPoolClient targetPoolClient = TargetPoolClient.create()) {
   *
   *   TargetPoolInstanceHealth response = targetPoolClient.getHealthTargetPool();
   * }
   * </code></pre>
   *
   ...
   * try (TargetPoolClient targetPoolClient = TargetPoolClient.create()) {
   *
   *   ApiFuture&lt;TargetPoolInstanceHealth&gt; future = targetPoolClient.getHealthTargetPoolCallable().futureCall();
   *   // Do something
   ...
   * try (TargetPoolClient targetPoolClient = TargetPoolClient.create()) {
   *
   *   Operation response = targetPoolClient.insertTargetPool();
   * }
   * </code></pre>
   *
   ...
   * try (TargetPoolClient targetPoolClient = TargetPoolClient.create()) {
   *
   *   ApiFuture&lt;Operation&gt; future = targetPoolClient.insertTargetPoolCallable().futureCall();
   *   // Do something
   *   Operation response = future.get();
   * }
   * </code></pre>
   ...
   * try (TargetPoolClient targetPoolClient = TargetPoolClient.create()) {
   *
   *   for (TargetPool element : targetPoolClient.listTargetPools().iterateAll()) {
   *     // doThingsWith(element);
   *   }
   * }
   * </code></pre>
   ...
   * try (TargetPoolClient targetPoolClient = TargetPoolClient.create()) {
   *
   *   ApiFuture&lt;ListTargetPoolsPagedResponse&gt; future = targetPoolClient.listTargetPoolsPagedCallable().futureCall();
   *   // Do something
   *   for (TargetPool element : future.get().iterateAll()) {
   *     // doThingsWith(element);
   *   }
   ...
   *
   *   while (true) {
   *     TargetPoolList response = targetPoolClient.listTargetPoolsCallable().call();
   ...
   * try (TargetPoolClient targetPoolClient = TargetPoolClient.create()) {
   *
   *   Operation response = targetPoolClient.removeHealthCheckTargetPool();
   * }
   * </code></pre>
   *
   ...
   * try (TargetPoolClient targetPoolClient = TargetPoolClient.create()) {
   *
   *   ApiFuture&lt;Operation&gt; future = targetPoolClient.removeHealthCheckTargetPoolCallable().futureCall();
   *   // Do something
   *   Operation response = future.get();
   * }
   * </code></pre>
   ...
   * try (TargetPoolClient targetPoolClient = TargetPoolClient.create()) {
   *
   *   Operation response = targetPoolClient.removeInstanceTargetPool();
   * }
   * </code></pre>
   *
   ...
   * try (TargetPoolClient targetPoolClient = TargetPoolClient.create()) {
   *
   *   ApiFuture&lt;Operation&gt; future = targetPoolClient.removeInstanceTargetPoolCallable().futureCall();
   *   // Do something
   *   Operation response = future.get();
   * }
   * </code></pre>
   ...
   * try (TargetPoolClient targetPoolClient = TargetPoolClient.create()) {
   *
   *   Operation response = targetPoolClient.setBackupTargetPool();
   * }
   * </code></pre>
   *
   ...
   * try (TargetPoolClient targetPoolClient = TargetPoolClient.create()) {
   *
   *   ApiFuture&lt;Operation&gt; future = targetPoolClient.setBackupTargetPoolCallable().futureCall();
   *   // Do something
   *   Operation response = future.get();
   * }
   * </code></pre>
