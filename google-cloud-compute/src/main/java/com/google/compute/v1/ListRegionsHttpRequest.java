...
public final class ListRegionsHttpRequest implements ApiMessage {
  ...
  private ListRegionsHttpRequest() {
  ...
  public static Builder newBuilder(ListRegionsHttpRequest prototype) {
  ...
  public static ListRegionsHttpRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }
  private static final ListRegionsHttpRequest DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new ListRegionsHttpRequest();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(ListRegionsHttpRequest other) {
      if (other == ListRegionsHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(ListRegionsHttpRequest source) {
    ...
    public ListRegionsHttpRequest build() {
      String missing = "";
      ...
      return new ListRegionsHttpRequest(
        access_token,
        callback,
        fields,
        filter,
    ...
    public final Builder setProjectWithRegionsProjectName(RegionsProjectName value) {
      if (value == null) {
        return
            setProject("")
            ;
    ...
    public final RegionsProjectName getProjectAsRegionsProjectName() {
      return RegionsProjectName.create(
          getProject()
          );
    }
  }
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof ListRegionsHttpRequest) {
      ListRegionsHttpRequest that = (ListRegionsHttpRequest) o;
      return
