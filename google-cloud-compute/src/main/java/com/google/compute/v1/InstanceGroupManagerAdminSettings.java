...
import com.google.compute.v1.stub.HttpJsonInstanceGroupManagerAdminStub;
...
/**
 * Settings class to configure an instance of {@link InstanceGroupManagerAdminClient}.
 *
 ...
 * <pre>
 * <code>
 * InstanceGroupManagerAdminSettings.Builder instanceGroupManagerAdminSettingsBuilder =
 *     InstanceGroupManagerAdminSettings.defaultBuilder();
 * instanceGroupManagerAdminSettingsBuilder.abandonInstancesInstanceGroupManagerSettings().getRetrySettingsBuilder()
 *     .setTotalTimeout(Duration.ofSeconds(30));
 * InstanceGroupManagerAdminSettings instanceGroupManagerAdminSettings = instanceGroupManagerAdminSettingsBuilder.build();
 * </code>
 * </pre>
 */
@Generated("by GAPIC v0.0.5")
@BetaApi
public class InstanceGroupManagerAdminSettings extends ClientSettings {
  /**
  ...
  public InstanceGroupManagerAdminStub createStub() throws IOException {
    if (getTransportProvider().getTransportName().equals(HttpJsonTransport.getHttpJsonTransportName())) {
      return HttpJsonInstanceGroupManagerAdminStub.create(this);
    } else {
  ...
  private static String getGapicVersion() {
    if (gapicVersion == null) {
      gapicVersion = PropertiesProvider.loadProperty(
          InstanceGroupManagerAdminSettings.class, PROPERTIES_FILE, META_VERSION_KEY);
  ...
  private InstanceGroupManagerAdminSettings(Builder settingsBuilder) throws IOException {
    super(
  ...
  /**
   * Builder for InstanceGroupManagerAdminSettings.
   */
  public static class Builder extends ClientSettings.Builder {
    ...
    private Builder(InstanceGroupManagerAdminSettings settings) {
      super(settings);
    ...
    @Override
    public InstanceGroupManagerAdminSettings build() throws IOException {
      return new InstanceGroupManagerAdminSettings(this);
    }
  }
}