 ...
 * </pre>
 *
 * <p>Note: close() needs to be called on the globalOperationAdminClient object to clean up resources such
 ...
 * returned.
 *
 * <p>This class can be customized by passing in a custom instance of GlobalOperationAdminSettings to
 * create(). For example:
 *
 ...
 * <pre>
 * <code>
 * GlobalOperationAdminSettings globalOperationAdminSettings =
 *     GlobalOperationAdminSettings.defaultBuilder()
 *         .setCredentialsProvider(FixedCredentialsProvider.create(myCredentials))
 *         .build();
 * GlobalOperationAdminClient globalOperationAdminClient =
 *     GlobalOperationAdminClient.create(globalOperationAdminSettings);
 * </code>
 * </pre>
 *
 ...
 * GlobalOperationAdminSettings globalOperationAdminSettings =
 *     GlobalOperationAdminSettings.defaultBuilder()
 *         .setTransportProvider(GlobalOperationAdminSettings.defaultGrpcTransportProviderBuilder()
 *             .setChannelProvider(GlobalOperationAdminSettings.defaultGrpcChannelProviderBuilder()
...
@BetaApi
public class GlobalOperationAdminClient implements BackgroundResource {
  private final GlobalOperationAdminSettings settings;
  private final GlobalOperationAdminStub stub;



  /**
   * Constructs an instance of GlobalOperationAdminClient with default settings.
   */
  public static final GlobalOperationAdminClient create() throws IOException {
    return create(GlobalOperationAdminSettings.defaultBuilder().build());
  }

  /**
   * Constructs an instance of GlobalOperationAdminClient, using the given settings.
   * The channels are created based on the settings passed in, or defaults for any
   * settings that are not set.
   */
  public static final GlobalOperationAdminClient create(GlobalOperationAdminSettings settings) throws IOException {
    return new GlobalOperationAdminClient(settings);
  }

  /**
   * Constructs an instance of GlobalOperationAdminClient, using the given stub for making calls. This is for
   * advanced usage - prefer to use GlobalOperationAdminSettings}.
   */
  public static final GlobalOperationAdminClient create(GlobalOperationAdminStub stub) {
    return new GlobalOperationAdminClient(stub);
  }
   ...
   */
  protected GlobalOperationAdminClient(GlobalOperationAdminSettings settings) throws IOException {
    this.settings = settings;
    this.stub = settings.createStub();
  }

  protected GlobalOperationAdminClient(GlobalOperationAdminStub stub) {
    this.settings = null;
    this.stub = stub;
  }

  public final GlobalOperationAdminSettings getSettings() {
    return settings;
  }

  public GlobalOperationAdminStub getStub() {
    return stub;
  }
   ...
   * try (GlobalOperationAdminClient globalOperationAdminClient = GlobalOperationAdminClient.create()) {
   *
   *   for (Operation element : globalOperationAdminClient.aggregatedListGlobalOperations().iterateAll()) {
   ...
   * try (GlobalOperationAdminClient globalOperationAdminClient = GlobalOperationAdminClient.create()) {
   *
   *   ApiFuture&lt;AggregatedListGlobalOperationsPagedResponse&gt; future = globalOperationAdminClient.aggregatedListGlobalOperationsPagedCallable().futureCall();
   *   // Do something
   ...
   *
   *   while (true) {
   *     OperationAggregatedList response = globalOperationAdminClient.aggregatedListGlobalOperationsCallable().call();
   ...
   * try (GlobalOperationAdminClient globalOperationAdminClient = GlobalOperationAdminClient.create()) {
   *
   *   ApiFuture&lt;Void&gt; future = globalOperationAdminClient.deleteGlobalOperationCallable().futureCall();
   *   // Do something
   *   future.get();
   * }
   * </code></pre>
   ...
   * try (GlobalOperationAdminClient globalOperationAdminClient = GlobalOperationAdminClient.create()) {
   *
   *   Operation response = globalOperationAdminClient.getGlobalOperation();
   * }
   * </code></pre>
   *
   ...
   * try (GlobalOperationAdminClient globalOperationAdminClient = GlobalOperationAdminClient.create()) {
   *
   *   ApiFuture&lt;Operation&gt; future = globalOperationAdminClient.getGlobalOperationCallable().futureCall();
   *   // Do something
   ...
   * try (GlobalOperationAdminClient globalOperationAdminClient = GlobalOperationAdminClient.create()) {
   *
   *   for (Operation element : globalOperationAdminClient.listGlobalOperations().iterateAll()) {
   *     // doThingsWith(element);
   *   }
   * }
   * </code></pre>
   ...
   * try (GlobalOperationAdminClient globalOperationAdminClient = GlobalOperationAdminClient.create()) {
   *
   *   ApiFuture&lt;ListGlobalOperationsPagedResponse&gt; future = globalOperationAdminClient.listGlobalOperationsPagedCallable().futureCall();
   *   // Do something
   *   for (Operation element : future.get().iterateAll()) {
   *     // doThingsWith(element);
   *   }
   ...
   *
   *   while (true) {
   *     OperationList response = globalOperationAdminClient.listGlobalOperationsCallable().call();
