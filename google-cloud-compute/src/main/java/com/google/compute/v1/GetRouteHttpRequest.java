...
public final class GetRouteHttpRequest implements ApiMessage {
  ...
  private GetRouteHttpRequest(
    ...
    RouteName resourceName = RouteName.parse(route);
    mapBuilder.put("project", resourceName.getProject());
    mapBuilder.put("route", resourceName.getRoute());
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(GetRouteHttpRequest other) {
      if (other == GetRouteHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(GetRouteHttpRequest source) {
