...
public final class AggregatedListInstanceGroupManagersHttpRequest implements ApiMessage {
  ...
  public static Builder newBuilder(AggregatedListInstanceGroupManagersHttpRequest prototype) {
  ...
  public static AggregatedListInstanceGroupManagersHttpRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }
  private static final AggregatedListInstanceGroupManagersHttpRequest DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new AggregatedListInstanceGroupManagersHttpRequest();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(AggregatedListInstanceGroupManagersHttpRequest other) {
      if (other == AggregatedListInstanceGroupManagersHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(AggregatedListInstanceGroupManagersHttpRequest source) {
    ...
    public AggregatedListInstanceGroupManagersHttpRequest build() {
      String missing = "";
      ...
      return new AggregatedListInstanceGroupManagersHttpRequest(
        access_token,
        callback,
        fields,
        filter,
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof AggregatedListInstanceGroupManagersHttpRequest) {
      AggregatedListInstanceGroupManagersHttpRequest that = (AggregatedListInstanceGroupManagersHttpRequest) o;
      return
