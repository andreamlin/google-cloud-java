...
import com.google.compute.v1.UrlMapAdminSettings;
import com.google.compute.v1.UrlMapList;
import com.google.compute.v1.UrlMapName;
import com.google.compute.v1.UrlMapsProjectName;
...
@BetaApi
public class HttpJsonUrlMapAdminStub extends UrlMapAdminStub {
  ...
  public static final HttpJsonUrlMapAdminStub create(UrlMapAdminSettings settings) throws IOException {
    return new HttpJsonUrlMapAdminStub(settings, ClientContext.create(settings));
  }

  public static final HttpJsonUrlMapAdminStub create(ClientContext clientContext) throws IOException {
    return new HttpJsonUrlMapAdminStub(UrlMapAdminSettings.defaultBuilder().build(), clientContext);
  }

  /**
   * Constructs an instance of HttpJsonUrlMapAdminStub, using the given settings.
   * This is protected so that it is easy to make a subclass, but otherwise, the static
   * factory methods should be preferred.
   */
  protected HttpJsonUrlMapAdminStub(UrlMapAdminSettings settings, ClientContext clientContext) throws IOException {
