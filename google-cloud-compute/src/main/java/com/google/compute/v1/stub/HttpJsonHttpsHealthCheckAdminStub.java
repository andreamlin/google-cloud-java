...
import com.google.compute.v1.HttpsHealthCheckAdminSettings;
import com.google.compute.v1.HttpsHealthCheckList;
import com.google.compute.v1.HttpsHealthCheckName;
import com.google.compute.v1.HttpsHealthChecksProjectName;
...
@BetaApi
public class HttpJsonHttpsHealthCheckAdminStub extends HttpsHealthCheckAdminStub {
  ...
  public static final HttpJsonHttpsHealthCheckAdminStub create(HttpsHealthCheckAdminSettings settings) throws IOException {
    return new HttpJsonHttpsHealthCheckAdminStub(settings, ClientContext.create(settings));
  }

  public static final HttpJsonHttpsHealthCheckAdminStub create(ClientContext clientContext) throws IOException {
    return new HttpJsonHttpsHealthCheckAdminStub(HttpsHealthCheckAdminSettings.defaultBuilder().build(), clientContext);
  }

  /**
   * Constructs an instance of HttpJsonHttpsHealthCheckAdminStub, using the given settings.
   * This is protected so that it is easy to make a subclass, but otherwise, the static
   * factory methods should be preferred.
   */
  protected HttpJsonHttpsHealthCheckAdminStub(HttpsHealthCheckAdminSettings settings, ClientContext clientContext) throws IOException {
