...
@BetaApi
public class HttpUrlMapAdminStub extends UrlMapAdminStub {
  ...
  public static final HttpUrlMapAdminStub create(UrlMapAdminSettings settings) throws IOException {
    return new HttpUrlMapAdminStub(settings, ClientContext.create(settings));
  }

  public static final HttpUrlMapAdminStub create(ClientContext clientContext) throws IOException {
    return new HttpUrlMapAdminStub(UrlMapAdminSettings.defaultBuilder().build(), clientContext);
  }

  /**
   * Constructs an instance of HttpUrlMapAdminStub, using the given settings.
   * This is protected so that it is easy to make a subclass, but otherwise, the static
   * factory methods should be preferred.
   */
  protected HttpUrlMapAdminStub(UrlMapAdminSettings settings, ClientContext clientContext) throws IOException {
