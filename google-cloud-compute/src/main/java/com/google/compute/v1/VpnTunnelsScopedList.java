...
public final class VpnTunnelsScopedList implements ApiMessage {
  ...
  public Map<String, List<String>> populateFieldsInMap(Set<String> fieldNames) {
    ...
    if (fieldNames.contains("vpnTunnels") && vpnTunnels != null) {
      fieldMap.put("vpnTunnels", Collections.singletonList(String.valueOf(vpnTunnels)));
    }
  ...
  public static class Builder {
    ...
    public Builder setVpnTunnels(List<VpnTunnel> vpnTunnels) {
      this.vpnTunnels = vpnTunnels;
      return this;
    }
    ...
    public Builder clone() {
      ...
      newBuilder.setVpnTunnels(this.vpnTunnels);
