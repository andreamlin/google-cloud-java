...
public final class RemoveInstanceTargetPoolHttpRequest implements ApiMessage {
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(RemoveInstanceTargetPoolHttpRequest other) {
      if (other == RemoveInstanceTargetPoolHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(RemoveInstanceTargetPoolHttpRequest source) {
