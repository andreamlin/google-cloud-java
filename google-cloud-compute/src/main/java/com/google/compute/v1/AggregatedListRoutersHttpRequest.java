...
public final class AggregatedListRoutersHttpRequest implements ApiMessage {
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(AggregatedListRoutersHttpRequest other) {
      if (other == AggregatedListRoutersHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(AggregatedListRoutersHttpRequest source) {
    ...
    public final Builder setProjectWithRoutersProjectName(RoutersProjectName value) {
      if (value == null) {
        return
            setProject("")
            ;
    ...
    public final RoutersProjectName getProjectAsRoutersProjectName() {
      return RoutersProjectName.create(
          getProject()
          );
    }
  }
