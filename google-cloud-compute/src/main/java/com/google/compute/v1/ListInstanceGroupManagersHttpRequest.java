...
public final class ListInstanceGroupManagersHttpRequest implements ApiMessage {
  ...
  private ListInstanceGroupManagersHttpRequest() {
  ...
  public static Builder newBuilder(ListInstanceGroupManagersHttpRequest prototype) {
  ...
  public static ListInstanceGroupManagersHttpRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }
  private static final ListInstanceGroupManagersHttpRequest DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new ListInstanceGroupManagersHttpRequest();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(ListInstanceGroupManagersHttpRequest other) {
      if (other == ListInstanceGroupManagersHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(ListInstanceGroupManagersHttpRequest source) {
    ...
    public ListInstanceGroupManagersHttpRequest build() {
      String missing = "";
      ...
      return new ListInstanceGroupManagersHttpRequest(
        access_token,
        callback,
        fields,
        filter,
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof ListInstanceGroupManagersHttpRequest) {
      ListInstanceGroupManagersHttpRequest that = (ListInstanceGroupManagersHttpRequest) o;
      return
