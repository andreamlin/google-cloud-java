...
public final class AggregatedListMachineTypesHttpRequest implements ApiMessage {
  ...
  private AggregatedListMachineTypesHttpRequest() {
  ...
  public static Builder newBuilder(AggregatedListMachineTypesHttpRequest prototype) {
  ...
  public static AggregatedListMachineTypesHttpRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }
  private static final AggregatedListMachineTypesHttpRequest DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new AggregatedListMachineTypesHttpRequest();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(AggregatedListMachineTypesHttpRequest other) {
      if (other == AggregatedListMachineTypesHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(AggregatedListMachineTypesHttpRequest source) {
    ...
    public AggregatedListMachineTypesHttpRequest build() {
      String missing = "";
      ...
      return new AggregatedListMachineTypesHttpRequest(
        access_token,
        callback,
        fields,
        filter,
    ...
    public final Builder setProjectWithMachineTypesProjectName(MachineTypesProjectName value) {
      if (value == null) {
        return
            setProject("")
            ;
    ...
    public final MachineTypesProjectName getProjectAsMachineTypesProjectName() {
      return MachineTypesProjectName.create(
          getProject()
          );
    }
  }
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof AggregatedListMachineTypesHttpRequest) {
      AggregatedListMachineTypesHttpRequest that = (AggregatedListMachineTypesHttpRequest) o;
      return
