...
@Generated("by GAPIC")
@BetaApi
public final class FirewallList implements ApiMessage {
  private final String id;
  private final List<Firewall> items;
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(FirewallList other) {
      if (other == FirewallList.getDefaultInstance()) return this;
      if (other.getId() != null) {
        this.id = other.id;
      }
    ...
    public Builder setItems(List<Firewall> items) {
      this.items = items;
      return this;
    }
