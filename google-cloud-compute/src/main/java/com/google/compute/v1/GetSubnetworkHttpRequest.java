...
public final class GetSubnetworkHttpRequest implements ApiMessage {
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(GetSubnetworkHttpRequest other) {
      if (other == GetSubnetworkHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(GetSubnetworkHttpRequest source) {
