...
@BetaApi
public class HttpTargetSslProxyAdminStub extends TargetSslProxyAdminStub {
  ...
  public static final HttpTargetSslProxyAdminStub create(TargetSslProxyAdminSettings settings) throws IOException {
    return new HttpTargetSslProxyAdminStub(settings, ClientContext.create(settings));
  }

  public static final HttpTargetSslProxyAdminStub create(ClientContext clientContext) throws IOException {
    return new HttpTargetSslProxyAdminStub(TargetSslProxyAdminSettings.defaultBuilder().build(), clientContext);
  }

  /**
   * Constructs an instance of HttpTargetSslProxyAdminStub, using the given settings.
   * This is protected so that it is easy to make a subclass, but otherwise, the static
   * factory methods should be preferred.
   */
  protected HttpTargetSslProxyAdminStub(TargetSslProxyAdminSettings settings, ClientContext clientContext) throws IOException {
