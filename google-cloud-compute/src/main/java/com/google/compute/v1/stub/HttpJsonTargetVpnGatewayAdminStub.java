...
import com.google.compute.v1.TargetVpnGatewayAdminSettings;
...
@BetaApi
public class HttpJsonTargetVpnGatewayAdminStub extends TargetVpnGatewayAdminStub {
  ...
  public static final HttpJsonTargetVpnGatewayAdminStub create(TargetVpnGatewayAdminSettings settings) throws IOException {
    return new HttpJsonTargetVpnGatewayAdminStub(settings, ClientContext.create(settings));
  }

  public static final HttpJsonTargetVpnGatewayAdminStub create(ClientContext clientContext) throws IOException {
    return new HttpJsonTargetVpnGatewayAdminStub(TargetVpnGatewayAdminSettings.defaultBuilder().build(), clientContext);
  }

  /**
   * Constructs an instance of HttpJsonTargetVpnGatewayAdminStub, using the given settings.
   * This is protected so that it is easy to make a subclass, but otherwise, the static
   * factory methods should be preferred.
   */
  protected HttpJsonTargetVpnGatewayAdminStub(TargetVpnGatewayAdminSettings settings, ClientContext clientContext) throws IOException {
