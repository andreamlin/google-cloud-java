...
@BetaApi
public class HttpAutoscalerAdminStub extends AutoscalerAdminStub {
  ...
  public static final HttpAutoscalerAdminStub create(AutoscalerAdminSettings settings) throws IOException {
    return new HttpAutoscalerAdminStub(settings, ClientContext.create(settings));
  }

  public static final HttpAutoscalerAdminStub create(ClientContext clientContext) throws IOException {
    return new HttpAutoscalerAdminStub(AutoscalerAdminSettings.defaultBuilder().build(), clientContext);
  }

  /**
   * Constructs an instance of HttpAutoscalerAdminStub, using the given settings.
   * This is protected so that it is easy to make a subclass, but otherwise, the static
   * factory methods should be preferred.
   */
  protected HttpAutoscalerAdminStub(AutoscalerAdminSettings settings, ClientContext clientContext) throws IOException {
