...
public final class HttpsHealthCheckName implements ResourceName {
  ...
  public static ResourceNameFactory<HttpsHealthCheckName> newFactory() {
    return new ResourceNameFactory<HttpsHealthCheckName>() {
      public HttpsHealthCheckName parse(String formattedString) {return HttpsHealthCheckName.parse(formattedString);}
    };
  }
