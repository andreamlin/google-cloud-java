...
public final class AddInstanceTargetPoolHttpRequest implements ApiMessage {
  ...
  public String getFieldStringValue(String fieldName) {
    ...
    if (fieldName.equals("targetPoolsAddInstanceRequestResource")) {
      return String.valueOf(targetPoolsAddInstanceRequestResource);
    }
  ...
  @Nullable
  @Override
  public TargetPoolsAddInstanceRequest getApiMessageRequestBody() {
  ...
  public static class Builder {
    ...
    private TargetPoolsAddInstanceRequest targetPoolsAddInstanceRequestResource;
    private String userIp;

    Builder() {}

    public Builder mergeFrom(AddInstanceTargetPoolHttpRequest other) {
      if (other == AddInstanceTargetPoolHttpRequest.getDefaultInstance()) return this;
      ...
      if (other.getTargetPoolsAddInstanceRequestResource() != null) {
        this.targetPoolsAddInstanceRequestResource = other.targetPoolsAddInstanceRequestResource;
      }
    ...
    Builder(AddInstanceTargetPoolHttpRequest source) {
      ...
      this.targetPoolsAddInstanceRequestResource = source.targetPoolsAddInstanceRequestResource;
