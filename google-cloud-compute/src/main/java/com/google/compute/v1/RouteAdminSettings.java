...
import com.google.compute.v1.stub.HttpJsonRouteAdminStub;
...
/**
 * Settings class to configure an instance of {@link RouteAdminClient}.
 *
 ...
 * <pre>
 * <code>
 * RouteAdminSettings.Builder routeAdminSettingsBuilder =
 *     RouteAdminSettings.defaultBuilder();
 * routeAdminSettingsBuilder.deleteRouteSettings().getRetrySettingsBuilder()
 *     .setTotalTimeout(Duration.ofSeconds(30));
 * RouteAdminSettings routeAdminSettings = routeAdminSettingsBuilder.build();
 * </code>
 * </pre>
 */
@Generated("by GAPIC v0.0.5")
@BetaApi
public class RouteAdminSettings extends ClientSettings {
  /**
  ...
  public RouteAdminStub createStub() throws IOException {
    if (getTransportProvider().getTransportName().equals(HttpJsonTransport.getHttpJsonTransportName())) {
      return HttpJsonRouteAdminStub.create(this);
    } else {
  ...
  private static String getGapicVersion() {
    if (gapicVersion == null) {
      gapicVersion = PropertiesProvider.loadProperty(
          RouteAdminSettings.class, PROPERTIES_FILE, META_VERSION_KEY);
  ...
  private RouteAdminSettings(Builder settingsBuilder) throws IOException {
    super(
  ...
  /**
   * Builder for RouteAdminSettings.
   */
  public static class Builder extends ClientSettings.Builder {
    ...
    private Builder(RouteAdminSettings settings) {
      super(settings);
    ...
    @Override
    public RouteAdminSettings build() throws IOException {
      return new RouteAdminSettings(this);
    }
  }
}