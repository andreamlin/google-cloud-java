...
public final class ListHttpHealthChecksHttpRequest implements ApiMessage {
  ...
  private ListHttpHealthChecksHttpRequest() {
  ...
  public static Builder newBuilder(ListHttpHealthChecksHttpRequest prototype) {
  ...
  public static ListHttpHealthChecksHttpRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }
  private static final ListHttpHealthChecksHttpRequest DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new ListHttpHealthChecksHttpRequest();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(ListHttpHealthChecksHttpRequest other) {
      if (other == ListHttpHealthChecksHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(ListHttpHealthChecksHttpRequest source) {
    ...
    public ListHttpHealthChecksHttpRequest build() {
      String missing = "";
      ...
      return new ListHttpHealthChecksHttpRequest(
        access_token,
        callback,
        fields,
        filter,
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof ListHttpHealthChecksHttpRequest) {
      ListHttpHealthChecksHttpRequest that = (ListHttpHealthChecksHttpRequest) o;
      return
