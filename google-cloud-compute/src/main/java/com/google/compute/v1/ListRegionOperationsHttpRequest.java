...
public final class ListRegionOperationsHttpRequest implements ApiMessage {
  ...
  private ListRegionOperationsHttpRequest() {
  ...
  public static Builder newBuilder(ListRegionOperationsHttpRequest prototype) {
  ...
  public static ListRegionOperationsHttpRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }
  private static final ListRegionOperationsHttpRequest DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new ListRegionOperationsHttpRequest();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(ListRegionOperationsHttpRequest other) {
      if (other == ListRegionOperationsHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(ListRegionOperationsHttpRequest source) {
    ...
    public ListRegionOperationsHttpRequest build() {
      String missing = "";
      ...
      return new ListRegionOperationsHttpRequest(
        access_token,
        callback,
        fields,
        filter,
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof ListRegionOperationsHttpRequest) {
      ListRegionOperationsHttpRequest that = (ListRegionOperationsHttpRequest) o;
      return
