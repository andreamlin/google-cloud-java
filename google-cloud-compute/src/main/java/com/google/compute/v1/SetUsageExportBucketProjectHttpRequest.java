...
public final class SetUsageExportBucketProjectHttpRequest implements ApiMessage {
  ...
  private SetUsageExportBucketProjectHttpRequest() {
  ...
  @Nullable
  @Override
  public UsageExportLocation getApiMessageRequestBody() {
  ...
  public static Builder newBuilder(SetUsageExportBucketProjectHttpRequest prototype) {
  ...
  public static SetUsageExportBucketProjectHttpRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }
  private static final SetUsageExportBucketProjectHttpRequest DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new SetUsageExportBucketProjectHttpRequest();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(SetUsageExportBucketProjectHttpRequest other) {
      if (other == SetUsageExportBucketProjectHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(SetUsageExportBucketProjectHttpRequest source) {
    ...
    public Builder setUsageExportLocationResource(UsageExportLocation usageExportLocationResource) {
      this.usageExportLocationResource = usageExportLocationResource;
      return this;
    }
    ...
    public SetUsageExportBucketProjectHttpRequest build() {
      ...
      return new SetUsageExportBucketProjectHttpRequest(
        access_token,
        callback,
        fields,
        key,
  ...
  public String toString() {
    return "SetUsageExportBucketProjectHttpRequest{"
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof SetUsageExportBucketProjectHttpRequest) {
      SetUsageExportBucketProjectHttpRequest that = (SetUsageExportBucketProjectHttpRequest) o;
      return
