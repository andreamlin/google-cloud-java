...
/**
 * Settings class to configure an instance of {@link HttpHealthCheckAdminClient}.
 *
 ...
 * <pre>
 * <code>
 * HttpHealthCheckAdminSettings.Builder httpHealthCheckAdminSettingsBuilder =
 *     HttpHealthCheckAdminSettings.defaultBuilder();
 * httpHealthCheckAdminSettingsBuilder.deleteHttpHealthCheckSettings().getRetrySettingsBuilder()
 *     .setTotalTimeout(Duration.ofSeconds(30));
 * HttpHealthCheckAdminSettings httpHealthCheckAdminSettings = httpHealthCheckAdminSettingsBuilder.build();
 * </code>
 * </pre>
 */
@Generated("by GAPIC v0.0.5")
@BetaApi
public class HttpHealthCheckAdminSettings extends ClientSettings {
  /**
  ...
  private final SimpleCallSettings<DeleteHttpHealthCheckHttpRequest, Operation> deleteHttpHealthCheckSettings;
  private final SimpleCallSettings<GetHttpHealthCheckHttpRequest, HttpHealthCheck> getHttpHealthCheckSettings;
  private final SimpleCallSettings<InsertHttpHealthCheckHttpRequest, Operation> insertHttpHealthCheckSettings;
  ...
  private final SimpleCallSettings<PatchHttpHealthCheckHttpRequest, Operation> patchHttpHealthCheckSettings;
  private final SimpleCallSettings<UpdateHttpHealthCheckHttpRequest, Operation> updateHttpHealthCheckSettings;

  /**
   * Returns the object with the settings used for calls to deleteHttpHealthCheck.
   */
  public SimpleCallSettings<DeleteHttpHealthCheckHttpRequest, Operation> deleteHttpHealthCheckSettings() {
   ...
   */
  public SimpleCallSettings<GetHttpHealthCheckHttpRequest, HttpHealthCheck> getHttpHealthCheckSettings() {
   ...
   */
  public SimpleCallSettings<InsertHttpHealthCheckHttpRequest, Operation> insertHttpHealthCheckSettings() {
   ...
   */
  public SimpleCallSettings<PatchHttpHealthCheckHttpRequest, Operation> patchHttpHealthCheckSettings() {
   ...
   */
  public SimpleCallSettings<UpdateHttpHealthCheckHttpRequest, Operation> updateHttpHealthCheckSettings() {
  ...
  private static String getGapicVersion() {
    if (gapicVersion == null) {
      gapicVersion = PropertiesProvider.loadProperty(
          HttpHealthCheckAdminSettings.class, PROPERTIES_FILE, META_VERSION_KEY);
  ...
  private HttpHealthCheckAdminSettings(Builder settingsBuilder) throws IOException {
    super(
  ...
  /**
   * Builder for HttpHealthCheckAdminSettings.
   */
  public static class Builder extends ClientSettings.Builder {
    private final ImmutableList<UnaryCallSettings.Builder> unaryMethodSettingsBuilders;

    private final SimpleCallSettings.Builder<DeleteHttpHealthCheckHttpRequest, Operation> deleteHttpHealthCheckSettings;
    private final SimpleCallSettings.Builder<GetHttpHealthCheckHttpRequest, HttpHealthCheck> getHttpHealthCheckSettings;
    private final SimpleCallSettings.Builder<InsertHttpHealthCheckHttpRequest, Operation> insertHttpHealthCheckSettings;
    ...
    private final SimpleCallSettings.Builder<PatchHttpHealthCheckHttpRequest, Operation> patchHttpHealthCheckSettings;
    private final SimpleCallSettings.Builder<UpdateHttpHealthCheckHttpRequest, Operation> updateHttpHealthCheckSettings;
    ...
    private Builder(ClientContext clientContext) {
      ...
      deleteHttpHealthCheckSettings = SimpleCallSettings.newBuilder();

      getHttpHealthCheckSettings = SimpleCallSettings.newBuilder();

      insertHttpHealthCheckSettings = SimpleCallSettings.newBuilder();

      listHttpHealthChecksSettings = PagedCallSettings.newBuilder(
          LIST_HTTP_HEALTH_CHECKS_PAGE_STR_FACT);

      patchHttpHealthCheckSettings = SimpleCallSettings.newBuilder();

      updateHttpHealthCheckSettings = SimpleCallSettings.newBuilder();
    ...
    private Builder(HttpHealthCheckAdminSettings settings) {
      super(settings);
     ...
     */
    public SimpleCallSettings.Builder<DeleteHttpHealthCheckHttpRequest, Operation> deleteHttpHealthCheckSettings() {
      return deleteHttpHealthCheckSettings;
    }
     ...
     */
    public SimpleCallSettings.Builder<GetHttpHealthCheckHttpRequest, HttpHealthCheck> getHttpHealthCheckSettings() {
      return getHttpHealthCheckSettings;
    }
     ...
     */
    public SimpleCallSettings.Builder<InsertHttpHealthCheckHttpRequest, Operation> insertHttpHealthCheckSettings() {
      return insertHttpHealthCheckSettings;
    }
     ...
     */
    public SimpleCallSettings.Builder<PatchHttpHealthCheckHttpRequest, Operation> patchHttpHealthCheckSettings() {
      return patchHttpHealthCheckSettings;
    }
     ...
     */
    public SimpleCallSettings.Builder<UpdateHttpHealthCheckHttpRequest, Operation> updateHttpHealthCheckSettings() {
      return updateHttpHealthCheckSettings;
    }

    @Override
    public HttpHealthCheckAdminSettings build() throws IOException {
      return new HttpHealthCheckAdminSettings(this);
    }
  }
}