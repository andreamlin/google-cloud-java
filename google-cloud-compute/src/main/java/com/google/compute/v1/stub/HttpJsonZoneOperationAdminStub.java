...
@BetaApi
public class HttpJsonZoneOperationAdminStub extends ZoneOperationAdminStub {
  ...
  public static final HttpJsonZoneOperationAdminStub create(ZoneOperationAdminSettings settings) throws IOException {
    return new HttpJsonZoneOperationAdminStub(settings, ClientContext.create(settings));
  }

  public static final HttpJsonZoneOperationAdminStub create(ClientContext clientContext) throws IOException {
    return new HttpJsonZoneOperationAdminStub(ZoneOperationAdminSettings.defaultBuilder().build(), clientContext);
  }

  /**
   * Constructs an instance of HttpJsonZoneOperationAdminStub, using the given settings.
   * This is protected so that it is easy to make a subclass, but otherwise, the static
   * factory methods should be preferred.
   */
  protected HttpJsonZoneOperationAdminStub(ZoneOperationAdminSettings settings, ClientContext clientContext) throws IOException {
