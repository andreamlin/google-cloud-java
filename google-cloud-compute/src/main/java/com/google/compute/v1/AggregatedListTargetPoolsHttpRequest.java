...
public final class AggregatedListTargetPoolsHttpRequest implements ApiMessage {
  ...
  private AggregatedListTargetPoolsHttpRequest() {
  ...
  public static Builder newBuilder(AggregatedListTargetPoolsHttpRequest prototype) {
  ...
  public static AggregatedListTargetPoolsHttpRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }
  private static final AggregatedListTargetPoolsHttpRequest DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new AggregatedListTargetPoolsHttpRequest();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(AggregatedListTargetPoolsHttpRequest other) {
      if (other == AggregatedListTargetPoolsHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(AggregatedListTargetPoolsHttpRequest source) {
    ...
    public AggregatedListTargetPoolsHttpRequest build() {
      String missing = "";
      ...
      return new AggregatedListTargetPoolsHttpRequest(
        access_token,
        callback,
        fields,
        filter,
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof AggregatedListTargetPoolsHttpRequest) {
      AggregatedListTargetPoolsHttpRequest that = (AggregatedListTargetPoolsHttpRequest) o;
      return
