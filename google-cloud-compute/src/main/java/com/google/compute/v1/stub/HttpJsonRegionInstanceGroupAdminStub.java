...
import com.google.compute.v1.RegionInstanceGroupAdminSettings;
...
import com.google.compute.v1.RegionInstanceGroupsRegionName;
...
@BetaApi
public class HttpJsonRegionInstanceGroupAdminStub extends RegionInstanceGroupAdminStub {
  ...
  public static final HttpJsonRegionInstanceGroupAdminStub create(RegionInstanceGroupAdminSettings settings) throws IOException {
    return new HttpJsonRegionInstanceGroupAdminStub(settings, ClientContext.create(settings));
  }

  public static final HttpJsonRegionInstanceGroupAdminStub create(ClientContext clientContext) throws IOException {
    return new HttpJsonRegionInstanceGroupAdminStub(RegionInstanceGroupAdminSettings.defaultBuilder().build(), clientContext);
  }

  /**
   * Constructs an instance of HttpJsonRegionInstanceGroupAdminStub, using the given settings.
   * This is protected so that it is easy to make a subclass, but otherwise, the static
   * factory methods should be preferred.
   */
  protected HttpJsonRegionInstanceGroupAdminStub(RegionInstanceGroupAdminSettings settings, ClientContext clientContext) throws IOException {
