...
@BetaApi
public class HttpBackendServiceAdminStub extends BackendServiceAdminStub {
  ...
  public static final HttpBackendServiceAdminStub create(BackendServiceAdminSettings settings) throws IOException {
    return new HttpBackendServiceAdminStub(settings, ClientContext.create(settings));
  }

  public static final HttpBackendServiceAdminStub create(ClientContext clientContext) throws IOException {
    return new HttpBackendServiceAdminStub(BackendServiceAdminSettings.defaultBuilder().build(), clientContext);
  }

  /**
   * Constructs an instance of HttpBackendServiceAdminStub, using the given settings.
   * This is protected so that it is easy to make a subclass, but otherwise, the static
   * factory methods should be preferred.
   */
  protected HttpBackendServiceAdminStub(BackendServiceAdminSettings settings, ClientContext clientContext) throws IOException {
