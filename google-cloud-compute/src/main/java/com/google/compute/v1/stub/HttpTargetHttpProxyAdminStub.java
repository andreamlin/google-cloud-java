...
@BetaApi
public class HttpTargetHttpProxyAdminStub extends TargetHttpProxyAdminStub {
  ...
  public static final HttpTargetHttpProxyAdminStub create(TargetHttpProxyAdminSettings settings) throws IOException {
    return new HttpTargetHttpProxyAdminStub(settings, ClientContext.create(settings));
  }

  public static final HttpTargetHttpProxyAdminStub create(ClientContext clientContext) throws IOException {
    return new HttpTargetHttpProxyAdminStub(TargetHttpProxyAdminSettings.defaultBuilder().build(), clientContext);
  }

  /**
   * Constructs an instance of HttpTargetHttpProxyAdminStub, using the given settings.
   * This is protected so that it is easy to make a subclass, but otherwise, the static
   * factory methods should be preferred.
   */
  protected HttpTargetHttpProxyAdminStub(TargetHttpProxyAdminSettings settings, ClientContext clientContext) throws IOException {
