...
public final class AggregatedListVpnTunnelsHttpRequest implements ApiMessage {
  ...
  private AggregatedListVpnTunnelsHttpRequest() {
  ...
  public static Builder newBuilder(AggregatedListVpnTunnelsHttpRequest prototype) {
  ...
  public static AggregatedListVpnTunnelsHttpRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }
  private static final AggregatedListVpnTunnelsHttpRequest DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new AggregatedListVpnTunnelsHttpRequest();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(AggregatedListVpnTunnelsHttpRequest other) {
      if (other == AggregatedListVpnTunnelsHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(AggregatedListVpnTunnelsHttpRequest source) {
    ...
    public AggregatedListVpnTunnelsHttpRequest build() {
      String missing = "";
      ...
      return new AggregatedListVpnTunnelsHttpRequest(
        access_token,
        callback,
        fields,
        filter,
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof AggregatedListVpnTunnelsHttpRequest) {
      AggregatedListVpnTunnelsHttpRequest that = (AggregatedListVpnTunnelsHttpRequest) o;
      return
