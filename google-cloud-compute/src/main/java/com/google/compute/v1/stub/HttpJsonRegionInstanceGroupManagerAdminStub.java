...
import com.google.compute.v1.RegionInstanceGroupManagerAdminSettings;
...
import com.google.compute.v1.RegionInstanceGroupManagersRegionName;
...
@BetaApi
public class HttpJsonRegionInstanceGroupManagerAdminStub extends RegionInstanceGroupManagerAdminStub {
  ...
  public static final HttpJsonRegionInstanceGroupManagerAdminStub create(RegionInstanceGroupManagerAdminSettings settings) throws IOException {
    return new HttpJsonRegionInstanceGroupManagerAdminStub(settings, ClientContext.create(settings));
  }

  public static final HttpJsonRegionInstanceGroupManagerAdminStub create(ClientContext clientContext) throws IOException {
    return new HttpJsonRegionInstanceGroupManagerAdminStub(RegionInstanceGroupManagerAdminSettings.defaultBuilder().build(), clientContext);
  }

  /**
   * Constructs an instance of HttpJsonRegionInstanceGroupManagerAdminStub, using the given settings.
   * This is protected so that it is easy to make a subclass, but otherwise, the static
   * factory methods should be preferred.
   */
  protected HttpJsonRegionInstanceGroupManagerAdminStub(RegionInstanceGroupManagerAdminSettings settings, ClientContext clientContext) throws IOException {
