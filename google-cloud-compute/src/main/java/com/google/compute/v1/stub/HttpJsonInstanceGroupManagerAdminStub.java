...
import com.google.compute.v1.InstanceGroupManagerAdminSettings;
...
@BetaApi
public class HttpJsonInstanceGroupManagerAdminStub extends InstanceGroupManagerAdminStub {
  ...
  public static final HttpJsonInstanceGroupManagerAdminStub create(InstanceGroupManagerAdminSettings settings) throws IOException {
    return new HttpJsonInstanceGroupManagerAdminStub(settings, ClientContext.create(settings));
  }

  public static final HttpJsonInstanceGroupManagerAdminStub create(ClientContext clientContext) throws IOException {
    return new HttpJsonInstanceGroupManagerAdminStub(InstanceGroupManagerAdminSettings.defaultBuilder().build(), clientContext);
  }

  /**
   * Constructs an instance of HttpJsonInstanceGroupManagerAdminStub, using the given settings.
   * This is protected so that it is easy to make a subclass, but otherwise, the static
   * factory methods should be preferred.
   */
  protected HttpJsonInstanceGroupManagerAdminStub(InstanceGroupManagerAdminSettings settings, ClientContext clientContext) throws IOException {
