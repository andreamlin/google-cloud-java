...
public final class ListRegionAutoscalersHttpRequest implements ApiMessage {
  ...
  public static Builder newBuilder(ListRegionAutoscalersHttpRequest prototype) {
  ...
  private static final ListRegionAutoscalersHttpRequest DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new ListRegionAutoscalersHttpRequest();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(ListRegionAutoscalersHttpRequest other) {
      if (other == ListRegionAutoscalersHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(ListRegionAutoscalersHttpRequest source) {
    ...
    public ListRegionAutoscalersHttpRequest build() {
      ...
      return new ListRegionAutoscalersHttpRequest(
        access_token,
        callback,
        fields,
        filter,
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof ListRegionAutoscalersHttpRequest) {
      ListRegionAutoscalersHttpRequest that = (ListRegionAutoscalersHttpRequest) o;
      return
