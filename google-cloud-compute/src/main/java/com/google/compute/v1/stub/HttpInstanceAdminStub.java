...
import com.google.compute.v1.InstancesProjectName;
...
import com.google.compute.v1.InstancesZoneName;
...
@BetaApi
public class HttpInstanceAdminStub extends InstanceAdminStub {
  ...
  public static final HttpInstanceAdminStub create(InstanceAdminSettings settings) throws IOException {
    return new HttpInstanceAdminStub(settings, ClientContext.create(settings));
  }

  public static final HttpInstanceAdminStub create(ClientContext clientContext) throws IOException {
    return new HttpInstanceAdminStub(InstanceAdminSettings.defaultBuilder().build(), clientContext);
  }

  /**
   * Constructs an instance of HttpInstanceAdminStub, using the given settings.
   * This is protected so that it is easy to make a subclass, but otherwise, the static
   * factory methods should be preferred.
   */
  protected HttpInstanceAdminStub(InstanceAdminSettings settings, ClientContext clientContext) throws IOException {
