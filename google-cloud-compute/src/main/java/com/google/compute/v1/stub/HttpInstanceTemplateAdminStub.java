...
@BetaApi
public class HttpInstanceTemplateAdminStub extends InstanceTemplateAdminStub {
  ...
  public static final HttpInstanceTemplateAdminStub create(InstanceTemplateAdminSettings settings) throws IOException {
    return new HttpInstanceTemplateAdminStub(settings, ClientContext.create(settings));
  }

  public static final HttpInstanceTemplateAdminStub create(ClientContext clientContext) throws IOException {
    return new HttpInstanceTemplateAdminStub(InstanceTemplateAdminSettings.defaultBuilder().build(), clientContext);
  }

  /**
   * Constructs an instance of HttpInstanceTemplateAdminStub, using the given settings.
   * This is protected so that it is easy to make a subclass, but otherwise, the static
   * factory methods should be preferred.
   */
  protected HttpInstanceTemplateAdminStub(InstanceTemplateAdminSettings settings, ClientContext clientContext) throws IOException {
