...
@BetaApi
public class HttpJsonRouterAdminStub extends RouterAdminStub {
  ...
  public static final HttpJsonRouterAdminStub create(RouterAdminSettings settings) throws IOException {
    return new HttpJsonRouterAdminStub(settings, ClientContext.create(settings));
  }

  public static final HttpJsonRouterAdminStub create(ClientContext clientContext) throws IOException {
    return new HttpJsonRouterAdminStub(RouterAdminSettings.defaultBuilder().build(), clientContext);
  }

  /**
   * Constructs an instance of HttpJsonRouterAdminStub, using the given settings.
   * This is protected so that it is easy to make a subclass, but otherwise, the static
   * factory methods should be preferred.
   */
  protected HttpJsonRouterAdminStub(RouterAdminSettings settings, ClientContext clientContext) throws IOException {
