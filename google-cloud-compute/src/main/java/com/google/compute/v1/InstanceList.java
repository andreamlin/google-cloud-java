...
@Generated("by GAPIC")
@BetaApi
public final class InstanceList implements ApiMessage {
  ...
  public List<Instance> getItemsList() {
    return items;
  }
  ...
  public static Builder newBuilder(InstanceList prototype) {
  ...
  private static final InstanceList DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new InstanceList();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(InstanceList other) {
      if (other == InstanceList.getDefaultInstance()) return this;
      if (other.getId() != null) {
        this.id = other.id;
      }
    ...
    public Builder addAllItems(List<Instance> items) {
      if (this.items == null) {
    ...
    public Builder addItems(Instance items) {
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof InstanceList) {
      InstanceList that = (InstanceList) o;
      return
