...
@BetaApi
public class HttpRegionInstanceGroupManagerAdminStub extends RegionInstanceGroupManagerAdminStub {
  ...
  public static final HttpRegionInstanceGroupManagerAdminStub create(RegionInstanceGroupManagerAdminSettings settings) throws IOException {
    return new HttpRegionInstanceGroupManagerAdminStub(settings, ClientContext.create(settings));
  }

  public static final HttpRegionInstanceGroupManagerAdminStub create(ClientContext clientContext) throws IOException {
    return new HttpRegionInstanceGroupManagerAdminStub(RegionInstanceGroupManagerAdminSettings.defaultBuilder().build(), clientContext);
  }

  /**
   * Constructs an instance of HttpRegionInstanceGroupManagerAdminStub, using the given settings.
   * This is protected so that it is easy to make a subclass, but otherwise, the static
   * factory methods should be preferred.
   */
  protected HttpRegionInstanceGroupManagerAdminStub(RegionInstanceGroupManagerAdminSettings settings, ClientContext clientContext) throws IOException {
