...
public final class HttpsHealthCheckList implements ApiMessage {
  ...
  public List<HttpsHealthCheck> getItems() {
    return items;
  }
  ...
  public static Builder newBuilder(HttpsHealthCheckList prototype) {
  ...
  private static final HttpsHealthCheckList DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new HttpsHealthCheckList();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(HttpsHealthCheckList other) {
      if (other == HttpsHealthCheckList.getDefaultInstance()) return this;
      if (other.getId() != null) {
        this.id = other.id;
      }
    ...
    Builder(HttpsHealthCheckList source) {
      this.id = source.id;
    ...
    public Builder setItems(List<HttpsHealthCheck> items) {
      this.items = items;
      return this;
    }
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof HttpsHealthCheckList) {
      HttpsHealthCheckList that = (HttpsHealthCheckList) o;
      return
