...
public final class StartWithEncryptionKeyInstanceHttpRequest implements ApiMessage {
  ...
  private StartWithEncryptionKeyInstanceHttpRequest() {
    ...
    this.fields = null;
    this.instance = null;
    this.instancesStartWithEncryptionKeyRequestResource = null;
    this.key = null;
  ...
  @Nullable
  @Override
  public InstancesStartWithEncryptionKeyRequest getApiMessageRequestBody() {
  ...
  public static class Builder {
    ...
    private InstancesStartWithEncryptionKeyRequest instancesStartWithEncryptionKeyRequestResource;
    private String key;
    ...
    public Builder mergeFrom(StartWithEncryptionKeyInstanceHttpRequest other) {
      if (other == StartWithEncryptionKeyInstanceHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(StartWithEncryptionKeyInstanceHttpRequest source) {
