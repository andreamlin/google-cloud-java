...
public final class AggregatedListBackendServicesHttpRequest implements ApiMessage {
  ...
  private AggregatedListBackendServicesHttpRequest() {
  ...
  public static Builder newBuilder(AggregatedListBackendServicesHttpRequest prototype) {
  ...
  public static AggregatedListBackendServicesHttpRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }
  private static final AggregatedListBackendServicesHttpRequest DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new AggregatedListBackendServicesHttpRequest();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(AggregatedListBackendServicesHttpRequest other) {
      if (other == AggregatedListBackendServicesHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(AggregatedListBackendServicesHttpRequest source) {
    ...
    public AggregatedListBackendServicesHttpRequest build() {
      String missing = "";
      ...
      return new AggregatedListBackendServicesHttpRequest(
        access_token,
        callback,
        fields,
        filter,
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof AggregatedListBackendServicesHttpRequest) {
      AggregatedListBackendServicesHttpRequest that = (AggregatedListBackendServicesHttpRequest) o;
      return
