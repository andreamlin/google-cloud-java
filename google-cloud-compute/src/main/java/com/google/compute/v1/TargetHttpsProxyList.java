...
@Generated("by GAPIC")
@BetaApi
public final class TargetHttpsProxyList implements ApiMessage {
  private final String id;
  private final List<TargetHttpsProxy> items;
  ...
  public List<TargetHttpsProxy> getItemsList() {
    return items;
  }
  ...
  public static class Builder {
    private String id;
    private List<TargetHttpsProxy> items;
    private String kind;
    ...
    public Builder mergeFrom(TargetHttpsProxyList other) {
      if (other == TargetHttpsProxyList.getDefaultInstance()) return this;
      if (other.getId() != null) {
        this.id = other.id;
      }
    ...
    Builder(TargetHttpsProxyList source) {
      this.id = source.id;
    ...
    public Builder addAllItems(List<TargetHttpsProxy> items) {
      if (this.items == null) {
    ...
    public Builder addItems(TargetHttpsProxy items) {
