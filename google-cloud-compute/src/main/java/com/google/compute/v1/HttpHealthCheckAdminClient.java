 ...
 * </pre>
 *
 * <p>Note: close() needs to be called on the httpHealthCheckAdminClient object to clean up resources such
 ...
 * returned.
 *
 * <p>This class can be customized by passing in a custom instance of HttpHealthCheckAdminSettings to
 * create(). For example:
 *
 ...
 * <pre>
 * <code>
 * HttpHealthCheckAdminSettings httpHealthCheckAdminSettings =
 *     HttpHealthCheckAdminSettings.defaultBuilder()
 *         .setCredentialsProvider(FixedCredentialsProvider.create(myCredentials))
 *         .build();
 * HttpHealthCheckAdminClient httpHealthCheckAdminClient =
 *     HttpHealthCheckAdminClient.create(httpHealthCheckAdminSettings);
 * </code>
 * </pre>
 *
 ...
 * HttpHealthCheckAdminSettings httpHealthCheckAdminSettings =
 *     HttpHealthCheckAdminSettings.defaultBuilder()
 *         .setTransportProvider(HttpHealthCheckAdminSettings.defaultGrpcTransportProviderBuilder()
 *             .setChannelProvider(HttpHealthCheckAdminSettings.defaultGrpcChannelProviderBuilder()
...
@BetaApi
public class HttpHealthCheckAdminClient implements BackgroundResource {
  private final HttpHealthCheckAdminSettings settings;
  private final HttpHealthCheckAdminStub stub;



  /**
   * Constructs an instance of HttpHealthCheckAdminClient with default settings.
   */
  public static final HttpHealthCheckAdminClient create() throws IOException {
    return create(HttpHealthCheckAdminSettings.defaultBuilder().build());
  }

  /**
   * Constructs an instance of HttpHealthCheckAdminClient, using the given settings.
   * The channels are created based on the settings passed in, or defaults for any
   * settings that are not set.
   */
  public static final HttpHealthCheckAdminClient create(HttpHealthCheckAdminSettings settings) throws IOException {
    return new HttpHealthCheckAdminClient(settings);
  }

  /**
   * Constructs an instance of HttpHealthCheckAdminClient, using the given stub for making calls. This is for
   * advanced usage - prefer to use HttpHealthCheckAdminSettings}.
   */
  public static final HttpHealthCheckAdminClient create(HttpHealthCheckAdminStub stub) {
    return new HttpHealthCheckAdminClient(stub);
  }
   ...
   */
  protected HttpHealthCheckAdminClient(HttpHealthCheckAdminSettings settings) throws IOException {
    this.settings = settings;
    this.stub = settings.createStub();
  }

  protected HttpHealthCheckAdminClient(HttpHealthCheckAdminStub stub) {
    this.settings = null;
    this.stub = stub;
  }

  public final HttpHealthCheckAdminSettings getSettings() {
    return settings;
  }

  public HttpHealthCheckAdminStub getStub() {
    return stub;
  }
   ...
   * try (HttpHealthCheckAdminClient httpHealthCheckAdminClient = HttpHealthCheckAdminClient.create()) {
   *
   *   ApiFuture&lt;Operation&gt; future = httpHealthCheckAdminClient.deleteHttpHealthCheckCallable().futureCall();
   *   // Do something
   ...
   * try (HttpHealthCheckAdminClient httpHealthCheckAdminClient = HttpHealthCheckAdminClient.create()) {
   *
   *   HttpHealthCheck response = httpHealthCheckAdminClient.getHttpHealthCheck();
   * }
   * </code></pre>
   *
   ...
   * try (HttpHealthCheckAdminClient httpHealthCheckAdminClient = HttpHealthCheckAdminClient.create()) {
   *
   *   ApiFuture&lt;HttpHealthCheck&gt; future = httpHealthCheckAdminClient.getHttpHealthCheckCallable().futureCall();
   *   // Do something
   ...
   * try (HttpHealthCheckAdminClient httpHealthCheckAdminClient = HttpHealthCheckAdminClient.create()) {
   *
   *   Operation response = httpHealthCheckAdminClient.insertHttpHealthCheck();
   * }
   * </code></pre>
   *
   * @param project Project ID for this request.
   * @param httpHealthCheck An HttpHealthCheck resource. This resource defines a template for how individual instances should be checked for health, via HTTP.
   * @throws com.google.api.gax.rpc.ApiException if the remote call fails
   */
  @BetaApi
  public final Operation insertHttpHealthCheck(HttpHealthChecksProjectName project, HttpHealthCheck httpHealthCheck) {
   ...
   * try (HttpHealthCheckAdminClient httpHealthCheckAdminClient = HttpHealthCheckAdminClient.create()) {
   *
   *   ApiFuture&lt;Operation&gt; future = httpHealthCheckAdminClient.insertHttpHealthCheckCallable().futureCall();
   *   // Do something
   *   Operation response = future.get();
   * }
   * </code></pre>
   ...
   * try (HttpHealthCheckAdminClient httpHealthCheckAdminClient = HttpHealthCheckAdminClient.create()) {
   *
   *   for (HttpHealthCheck element : httpHealthCheckAdminClient.listHttpHealthChecks().iterateAll()) {
   ...
   * try (HttpHealthCheckAdminClient httpHealthCheckAdminClient = HttpHealthCheckAdminClient.create()) {
   *
   *   ApiFuture&lt;ListHttpHealthChecksPagedResponse&gt; future = httpHealthCheckAdminClient.listHttpHealthChecksPagedCallable().futureCall();
   *   // Do something
   ...
   *
   *   while (true) {
   *     HttpHealthCheckList response = httpHealthCheckAdminClient.listHttpHealthChecksCallable().call();
   ...
   * try (HttpHealthCheckAdminClient httpHealthCheckAdminClient = HttpHealthCheckAdminClient.create()) {
   *
   *   Operation response = httpHealthCheckAdminClient.patchHttpHealthCheck();
   * }
   * </code></pre>
   *
   ...
   */
  @BetaApi
  public final Operation patchHttpHealthCheck(HttpHealthCheckName httpHealthCheck, HttpHealthCheck httpHealthCheck) {
   ...
   * try (HttpHealthCheckAdminClient httpHealthCheckAdminClient = HttpHealthCheckAdminClient.create()) {
   *
   *   ApiFuture&lt;Operation&gt; future = httpHealthCheckAdminClient.patchHttpHealthCheckCallable().futureCall();
   *   // Do something
   *   Operation response = future.get();
   * }
   * </code></pre>
   ...
   * try (HttpHealthCheckAdminClient httpHealthCheckAdminClient = HttpHealthCheckAdminClient.create()) {
   *
   *   Operation response = httpHealthCheckAdminClient.updateHttpHealthCheck();
   * }
   * </code></pre>
   *
   * @param httpHealthCheck Name of the HttpHealthCheck resource to update.
   ...
   */
  @BetaApi
  public final Operation updateHttpHealthCheck(HttpHealthCheckName httpHealthCheck, HttpHealthCheck httpHealthCheck) {
   ...
   * try (HttpHealthCheckAdminClient httpHealthCheckAdminClient = HttpHealthCheckAdminClient.create()) {
   *
   *   ApiFuture&lt;Operation&gt; future = httpHealthCheckAdminClient.updateHttpHealthCheckCallable().futureCall();
   *   // Do something
   *   Operation response = future.get();
   * }
   * </code></pre>
