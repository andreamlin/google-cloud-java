...
import com.google.compute.v1.stub.HttpJsonTargetInstanceAdminStub;
...
/**
 * Settings class to configure an instance of {@link TargetInstanceAdminClient}.
 *
 ...
 * <pre>
 * <code>
 * TargetInstanceAdminSettings.Builder targetInstanceAdminSettingsBuilder =
 *     TargetInstanceAdminSettings.defaultBuilder();
 * targetInstanceAdminSettingsBuilder.deleteTargetInstanceSettings().getRetrySettingsBuilder()
 *     .setTotalTimeout(Duration.ofSeconds(30));
 * TargetInstanceAdminSettings targetInstanceAdminSettings = targetInstanceAdminSettingsBuilder.build();
 * </code>
 * </pre>
 */
@Generated("by GAPIC v0.0.5")
@BetaApi
public class TargetInstanceAdminSettings extends ClientSettings {
  /**
  ...
  public TargetInstanceAdminStub createStub() throws IOException {
    if (getTransportProvider().getTransportName().equals(HttpJsonTransport.getHttpJsonTransportName())) {
      return HttpJsonTargetInstanceAdminStub.create(this);
    } else {
  ...
  private static String getGapicVersion() {
    if (gapicVersion == null) {
      gapicVersion = PropertiesProvider.loadProperty(
          TargetInstanceAdminSettings.class, PROPERTIES_FILE, META_VERSION_KEY);
  ...
  private TargetInstanceAdminSettings(Builder settingsBuilder) throws IOException {
    super(
  ...
  /**
   * Builder for TargetInstanceAdminSettings.
   */
  public static class Builder extends ClientSettings.Builder {
    ...
    private Builder(TargetInstanceAdminSettings settings) {
      super(settings);
    ...
    @Override
    public TargetInstanceAdminSettings build() throws IOException {
      return new TargetInstanceAdminSettings(this);
    }
  }
}