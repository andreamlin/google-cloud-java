...
public final class UpdateRegionBackendServiceHttpRequest implements ApiMessage {
  ...
  public static Builder newBuilder(UpdateRegionBackendServiceHttpRequest prototype) {
  ...
  public static UpdateRegionBackendServiceHttpRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }
  private static final UpdateRegionBackendServiceHttpRequest DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new UpdateRegionBackendServiceHttpRequest();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(UpdateRegionBackendServiceHttpRequest other) {
      if (other == UpdateRegionBackendServiceHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(UpdateRegionBackendServiceHttpRequest source) {
    ...
    public UpdateRegionBackendServiceHttpRequest build() {
      ...
      return new UpdateRegionBackendServiceHttpRequest(
        access_token,
        backendService,
  ...
  public String toString() {
    return "UpdateRegionBackendServiceHttpRequest{"
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof UpdateRegionBackendServiceHttpRequest) {
      UpdateRegionBackendServiceHttpRequest that = (UpdateRegionBackendServiceHttpRequest) o;
      return
