...
import com.google.compute.v1.InstanceTemplateAdminSettings;
...
@BetaApi
public class HttpJsonInstanceTemplateAdminStub extends InstanceTemplateAdminStub {
  ...
  public static final HttpJsonInstanceTemplateAdminStub create(InstanceTemplateAdminSettings settings) throws IOException {
    return new HttpJsonInstanceTemplateAdminStub(settings, ClientContext.create(settings));
  }

  public static final HttpJsonInstanceTemplateAdminStub create(ClientContext clientContext) throws IOException {
    return new HttpJsonInstanceTemplateAdminStub(InstanceTemplateAdminSettings.defaultBuilder().build(), clientContext);
  }

  /**
   * Constructs an instance of HttpJsonInstanceTemplateAdminStub, using the given settings.
   * This is protected so that it is easy to make a subclass, but otherwise, the static
   * factory methods should be preferred.
   */
  protected HttpJsonInstanceTemplateAdminStub(InstanceTemplateAdminSettings settings, ClientContext clientContext) throws IOException {
