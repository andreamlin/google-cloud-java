...
@BetaApi
public class HttpTargetInstanceAdminStub extends TargetInstanceAdminStub {
  ...
  public static final HttpTargetInstanceAdminStub create(TargetInstanceAdminSettings settings) throws IOException {
    return new HttpTargetInstanceAdminStub(settings, ClientContext.create(settings));
  }

  public static final HttpTargetInstanceAdminStub create(ClientContext clientContext) throws IOException {
    return new HttpTargetInstanceAdminStub(TargetInstanceAdminSettings.defaultBuilder().build(), clientContext);
  }

  /**
   * Constructs an instance of HttpTargetInstanceAdminStub, using the given settings.
   * This is protected so that it is easy to make a subclass, but otherwise, the static
   * factory methods should be preferred.
   */
  protected HttpTargetInstanceAdminStub(TargetInstanceAdminSettings settings, ClientContext clientContext) throws IOException {
