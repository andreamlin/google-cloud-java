...
@BetaApi
public class RegionSettings extends ClientSettings<RegionSettings> {
  /**
  ...
  public static TransportChannelProvider defaultTransportChannelProvider() {
    return RegionStubSettings.defaultTransportChannelProvider();
  }
  ...
  protected RegionSettings(Builder settingsBuilder) throws IOException {
   ...
   */
  public static class Builder extends ClientSettings.Builder<RegionSettings, Builder> {
    protected Builder() throws IOException {
      this((ClientContext) null);
    }

    protected Builder(ClientContext clientContext) {
      super(RegionStubSettings.newBuilder(clientContext));
    }

    private static Builder createDefault() {
      return new Builder(RegionStubSettings.newBuilder());
    }

    protected Builder(RegionSettings settings) {
      super(settings.getStubSettings().toBuilder());
    }

    protected Builder(RegionStubSettings.Builder stubSettings) {
      super(stubSettings);
    }
