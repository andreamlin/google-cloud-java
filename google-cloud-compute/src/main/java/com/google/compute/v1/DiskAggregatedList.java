...
public final class DiskAggregatedList implements ApiMessage {
  ...
  private final DisksScopedList items;
  ...
  public DisksScopedList getItems() {
    return items;
  }
  ...
  public static class Builder {
    ...
    public Builder setItems(DisksScopedList items) {
      this.items = items;
      return this;
    }
