...
@BetaApi
public class HttpJsonRegionOperationAdminStub extends RegionOperationAdminStub {
  ...
  public static final HttpJsonRegionOperationAdminStub create(RegionOperationAdminSettings settings) throws IOException {
    return new HttpJsonRegionOperationAdminStub(settings, ClientContext.create(settings));
  }

  public static final HttpJsonRegionOperationAdminStub create(ClientContext clientContext) throws IOException {
    return new HttpJsonRegionOperationAdminStub(RegionOperationAdminSettings.defaultBuilder().build(), clientContext);
  }

  /**
   * Constructs an instance of HttpJsonRegionOperationAdminStub, using the given settings.
   * This is protected so that it is easy to make a subclass, but otherwise, the static
   * factory methods should be preferred.
   */
  protected HttpJsonRegionOperationAdminStub(RegionOperationAdminSettings settings, ClientContext clientContext) throws IOException {
