...
import com.google.compute.v1.NetworkAdminSettings;
...
@BetaApi
public class HttpJsonNetworkAdminStub extends NetworkAdminStub {
  ...
  public static final HttpJsonNetworkAdminStub create(NetworkAdminSettings settings) throws IOException {
    return new HttpJsonNetworkAdminStub(settings, ClientContext.create(settings));
  }

  public static final HttpJsonNetworkAdminStub create(ClientContext clientContext) throws IOException {
    return new HttpJsonNetworkAdminStub(NetworkAdminSettings.defaultBuilder().build(), clientContext);
  }

  /**
   * Constructs an instance of HttpJsonNetworkAdminStub, using the given settings.
   * This is protected so that it is easy to make a subclass, but otherwise, the static
   * factory methods should be preferred.
   */
  protected HttpJsonNetworkAdminStub(NetworkAdminSettings settings, ClientContext clientContext) throws IOException {
