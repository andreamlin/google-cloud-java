...
@Generated("by GAPIC")
@BetaApi
public final class SnapshotList implements ApiMessage {
  private final String id;
  private final List<Snapshot> items;
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(SnapshotList other) {
      if (other == SnapshotList.getDefaultInstance()) return this;
      if (other.getId() != null) {
        this.id = other.id;
      }
    ...
    public Builder addAllItems(List<Snapshot> items) {
      if (this.items == null) {
    ...
    public Builder addItems(Snapshot items) {
