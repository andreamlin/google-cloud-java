...
public final class AggregatedListTargetVpnGatewaysHttpRequest implements ApiMessage {
  ...
  private AggregatedListTargetVpnGatewaysHttpRequest() {
  ...
  public static Builder newBuilder(AggregatedListTargetVpnGatewaysHttpRequest prototype) {
  ...
  public static AggregatedListTargetVpnGatewaysHttpRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }
  private static final AggregatedListTargetVpnGatewaysHttpRequest DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new AggregatedListTargetVpnGatewaysHttpRequest();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(AggregatedListTargetVpnGatewaysHttpRequest other) {
      if (other == AggregatedListTargetVpnGatewaysHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(AggregatedListTargetVpnGatewaysHttpRequest source) {
    ...
    public AggregatedListTargetVpnGatewaysHttpRequest build() {
      String missing = "";
      ...
      return new AggregatedListTargetVpnGatewaysHttpRequest(
        access_token,
        callback,
        fields,
        filter,
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof AggregatedListTargetVpnGatewaysHttpRequest) {
      AggregatedListTargetVpnGatewaysHttpRequest that = (AggregatedListTargetVpnGatewaysHttpRequest) o;
      return
