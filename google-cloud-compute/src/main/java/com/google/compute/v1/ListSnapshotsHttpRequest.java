...
public final class ListSnapshotsHttpRequest implements ApiMessage {
  ...
  private ListSnapshotsHttpRequest() {
  ...
  public static Builder newBuilder(ListSnapshotsHttpRequest prototype) {
  ...
  public static ListSnapshotsHttpRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }
  private static final ListSnapshotsHttpRequest DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new ListSnapshotsHttpRequest();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(ListSnapshotsHttpRequest other) {
      if (other == ListSnapshotsHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(ListSnapshotsHttpRequest source) {
    ...
    public ListSnapshotsHttpRequest build() {
      String missing = "";
      ...
      return new ListSnapshotsHttpRequest(
        access_token,
        callback,
        fields,
        filter,
    ...
    public final Builder setProjectWithSnapshotsProjectName(SnapshotsProjectName value) {
      if (value == null) {
        return
            setProject("")
            ;
    ...
    public final SnapshotsProjectName getProjectAsSnapshotsProjectName() {
      return SnapshotsProjectName.create(
          getProject()
          );
    }
  }
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof ListSnapshotsHttpRequest) {
      ListSnapshotsHttpRequest that = (ListSnapshotsHttpRequest) o;
      return
