...
@Generated("by GAPIC")
@BetaApi
public final class ListZoneOperationsHttpRequest implements ApiMessage {
  ...
  private ListZoneOperationsHttpRequest() {
  ...
  public static Builder newBuilder(ListZoneOperationsHttpRequest prototype) {
  ...
  public static ListZoneOperationsHttpRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }
  private static final ListZoneOperationsHttpRequest DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new ListZoneOperationsHttpRequest();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(ListZoneOperationsHttpRequest other) {
      if (other == ListZoneOperationsHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(ListZoneOperationsHttpRequest source) {
    ...
    public ListZoneOperationsHttpRequest build() {
      String missing = "";
      ...
      return new ListZoneOperationsHttpRequest(
        access_token,
        callback,
        fields,
        filter,
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof ListZoneOperationsHttpRequest) {
      ListZoneOperationsHttpRequest that = (ListZoneOperationsHttpRequest) o;
      return
