...
/**
 * Settings class to configure an instance of {@link ForwardingRuleAdminClient}.
 *
 ...
 * <pre>
 * <code>
 * ForwardingRuleAdminSettings.Builder forwardingRuleAdminSettingsBuilder =
 *     ForwardingRuleAdminSettings.defaultBuilder();
 * forwardingRuleAdminSettingsBuilder.deleteForwardingRuleSettings().getRetrySettingsBuilder()
 *     .setTotalTimeout(Duration.ofSeconds(30));
 * ForwardingRuleAdminSettings forwardingRuleAdminSettings = forwardingRuleAdminSettingsBuilder.build();
 * </code>
 * </pre>
 */
@Generated("by GAPIC v0.0.5")
@BetaApi
public class ForwardingRuleAdminSettings extends ClientSettings {
  /**
  ...
  private static String getGapicVersion() {
    if (gapicVersion == null) {
      gapicVersion = PropertiesProvider.loadProperty(
          ForwardingRuleAdminSettings.class, PROPERTIES_FILE, META_VERSION_KEY);
  ...
  private ForwardingRuleAdminSettings(Builder settingsBuilder) throws IOException {
    super(
  ...
  /**
   * Builder for ForwardingRuleAdminSettings.
   */
  public static class Builder extends ClientSettings.Builder {
    ...
    private Builder(ForwardingRuleAdminSettings settings) {
      super(settings);
    ...
    @Override
    public ForwardingRuleAdminSettings build() throws IOException {
      return new ForwardingRuleAdminSettings(this);
    }
  }
}