...
public final class TargetInstanceName implements ResourceName {
  ...
  public static ResourceNameFactory<TargetInstanceName> newFactory() {
    return new ResourceNameFactory<TargetInstanceName>() {
      public TargetInstanceName parse(String formattedString) {return TargetInstanceName.parse(formattedString);}
    };
  }
