...
@BetaApi
public class HttpHttpsHealthCheckAdminStub extends HttpsHealthCheckAdminStub {
  ...
  public static final HttpHttpsHealthCheckAdminStub create(HttpsHealthCheckAdminSettings settings) throws IOException {
    return new HttpHttpsHealthCheckAdminStub(settings, ClientContext.create(settings));
  }

  public static final HttpHttpsHealthCheckAdminStub create(ClientContext clientContext) throws IOException {
    return new HttpHttpsHealthCheckAdminStub(HttpsHealthCheckAdminSettings.defaultBuilder().build(), clientContext);
  }

  /**
   * Constructs an instance of HttpHttpsHealthCheckAdminStub, using the given settings.
   * This is protected so that it is easy to make a subclass, but otherwise, the static
   * factory methods should be preferred.
   */
  protected HttpHttpsHealthCheckAdminStub(HttpsHealthCheckAdminSettings settings, ClientContext clientContext) throws IOException {
