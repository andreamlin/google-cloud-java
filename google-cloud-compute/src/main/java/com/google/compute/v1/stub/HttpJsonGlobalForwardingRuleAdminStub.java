...
@BetaApi
public class HttpJsonGlobalForwardingRuleAdminStub extends GlobalForwardingRuleAdminStub {
  ...
  public static final HttpJsonGlobalForwardingRuleAdminStub create(GlobalForwardingRuleAdminSettings settings) throws IOException {
    return new HttpJsonGlobalForwardingRuleAdminStub(settings, ClientContext.create(settings));
  }

  public static final HttpJsonGlobalForwardingRuleAdminStub create(ClientContext clientContext) throws IOException {
    return new HttpJsonGlobalForwardingRuleAdminStub(GlobalForwardingRuleAdminSettings.defaultBuilder().build(), clientContext);
  }

  /**
   * Constructs an instance of HttpJsonGlobalForwardingRuleAdminStub, using the given settings.
   * This is protected so that it is easy to make a subclass, but otherwise, the static
   * factory methods should be preferred.
   */
  protected HttpJsonGlobalForwardingRuleAdminStub(GlobalForwardingRuleAdminSettings settings, ClientContext clientContext) throws IOException {
