...
public class GlobalAddressSettings extends ClientSettings {
  ...
  private static String getGapicVersion() {
    if (gapicVersion == null) {
      gapicVersion = PropertiesProvider.loadProperty(
          GlobalAddressSettings.class, PROPERTIES_FILE, META_VERSION_KEY);
  ...
  private GlobalAddressSettings(Builder settingsBuilder) throws IOException {
    super(
  ...
  public static class Builder extends ClientSettings.Builder {
    ...
    private final UnaryCallSettings.Builder deleteGlobalAddressSettings;
    private final UnaryCallSettings.Builder getGlobalAddressSettings;
    private final UnaryCallSettings.Builder insertGlobalAddressSettings;
    ...
    private Builder(GlobalAddressSettings settings) {
      super(settings);
