...
@BetaApi
public class HttpMachineTypeAdminStub extends MachineTypeAdminStub {
  ...
  public static final HttpMachineTypeAdminStub create(MachineTypeAdminSettings settings) throws IOException {
    return new HttpMachineTypeAdminStub(settings, ClientContext.create(settings));
  }

  public static final HttpMachineTypeAdminStub create(ClientContext clientContext) throws IOException {
    return new HttpMachineTypeAdminStub(MachineTypeAdminSettings.defaultBuilder().build(), clientContext);
  }

  /**
   * Constructs an instance of HttpMachineTypeAdminStub, using the given settings.
   * This is protected so that it is easy to make a subclass, but otherwise, the static
   * factory methods should be preferred.
   */
  protected HttpMachineTypeAdminStub(MachineTypeAdminSettings settings, ClientContext clientContext) throws IOException {
