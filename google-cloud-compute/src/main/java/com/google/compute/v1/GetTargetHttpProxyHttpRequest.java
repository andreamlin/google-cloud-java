...
public final class GetTargetHttpProxyHttpRequest implements ApiMessage {
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(GetTargetHttpProxyHttpRequest other) {
      if (other == GetTargetHttpProxyHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(GetTargetHttpProxyHttpRequest source) {
    ...
    public final Builder setTargetHttpProxyWithTargetHttpProxyName(TargetHttpProxyName value) {
      if (value == null) {
        return
            setProject("").          setTargetHttpProxy("")
            ;
      }
      return
    ...
    public final TargetHttpProxyName getTargetHttpProxyAsTargetHttpProxyName() {
      return TargetHttpProxyName.create(
          getProject(),
          getTargetHttpProxy()
          );
    }
