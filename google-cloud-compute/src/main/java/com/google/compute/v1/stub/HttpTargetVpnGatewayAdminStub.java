...
@BetaApi
public class HttpTargetVpnGatewayAdminStub extends TargetVpnGatewayAdminStub {
  ...
  public static final HttpTargetVpnGatewayAdminStub create(TargetVpnGatewayAdminSettings settings) throws IOException {
    return new HttpTargetVpnGatewayAdminStub(settings, ClientContext.create(settings));
  }

  public static final HttpTargetVpnGatewayAdminStub create(ClientContext clientContext) throws IOException {
    return new HttpTargetVpnGatewayAdminStub(TargetVpnGatewayAdminSettings.defaultBuilder().build(), clientContext);
  }

  /**
   * Constructs an instance of HttpTargetVpnGatewayAdminStub, using the given settings.
   * This is protected so that it is easy to make a subclass, but otherwise, the static
   * factory methods should be preferred.
   */
  protected HttpTargetVpnGatewayAdminStub(TargetVpnGatewayAdminSettings settings, ClientContext clientContext) throws IOException {
