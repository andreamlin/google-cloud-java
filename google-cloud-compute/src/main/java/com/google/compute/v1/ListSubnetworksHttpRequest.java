...
public final class ListSubnetworksHttpRequest implements ApiMessage {
  ...
  private ListSubnetworksHttpRequest() {
  ...
  public static Builder newBuilder(ListSubnetworksHttpRequest prototype) {
  ...
  public static ListSubnetworksHttpRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }
  private static final ListSubnetworksHttpRequest DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new ListSubnetworksHttpRequest();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(ListSubnetworksHttpRequest other) {
      if (other == ListSubnetworksHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(ListSubnetworksHttpRequest source) {
    ...
    public ListSubnetworksHttpRequest build() {
      String missing = "";
      ...
      return new ListSubnetworksHttpRequest(
        access_token,
        callback,
        fields,
        filter,
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof ListSubnetworksHttpRequest) {
      ListSubnetworksHttpRequest that = (ListSubnetworksHttpRequest) o;
      return
