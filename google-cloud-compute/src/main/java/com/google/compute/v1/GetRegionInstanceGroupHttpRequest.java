...
public final class GetRegionInstanceGroupHttpRequest implements ApiMessage {
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(GetRegionInstanceGroupHttpRequest other) {
      if (other == GetRegionInstanceGroupHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(GetRegionInstanceGroupHttpRequest source) {
