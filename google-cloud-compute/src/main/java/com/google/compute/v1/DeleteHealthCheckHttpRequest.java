...
@Generated("by GAPIC")
@BetaApi
public final class DeleteHealthCheckHttpRequest implements ApiMessage {
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(DeleteHealthCheckHttpRequest other) {
      if (other == DeleteHealthCheckHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(DeleteHealthCheckHttpRequest source) {
