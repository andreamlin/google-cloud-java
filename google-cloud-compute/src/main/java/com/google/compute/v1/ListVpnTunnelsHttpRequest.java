...
@Generated("by GAPIC")
@BetaApi
public final class ListVpnTunnelsHttpRequest implements ApiMessage {
  ...
  private ListVpnTunnelsHttpRequest() {
  ...
  public static Builder newBuilder(ListVpnTunnelsHttpRequest prototype) {
  ...
  public static ListVpnTunnelsHttpRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }
  private static final ListVpnTunnelsHttpRequest DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new ListVpnTunnelsHttpRequest();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(ListVpnTunnelsHttpRequest other) {
      if (other == ListVpnTunnelsHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(ListVpnTunnelsHttpRequest source) {
    ...
    public ListVpnTunnelsHttpRequest build() {
      String missing = "";
      ...
      return new ListVpnTunnelsHttpRequest(
        access_token,
        callback,
        fields,
        filter,
    ...
    public final Builder setRegionWithVpnTunnelsRegionName(VpnTunnelsRegionName value) {
      if (value == null) {
        return
    ...
    public final VpnTunnelsRegionName getRegionAsVpnTunnelsRegionName() {
      return VpnTunnelsRegionName.create(
          getProject(),
          getRegion()
          );
    }
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof ListVpnTunnelsHttpRequest) {
      ListVpnTunnelsHttpRequest that = (ListVpnTunnelsHttpRequest) o;
      return
