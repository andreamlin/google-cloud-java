...
public final class InstanceGroupManagerName implements ResourceName {
  ...
  public static ResourceNameFactory<InstanceGroupManagerName> newFactory() {
    return new ResourceNameFactory<InstanceGroupManagerName>() {
      public InstanceGroupManagerName parse(String formattedString) {return InstanceGroupManagerName.parse(formattedString);}
    };
  }
