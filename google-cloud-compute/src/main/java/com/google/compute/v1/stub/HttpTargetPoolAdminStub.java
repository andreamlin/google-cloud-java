...
import com.google.compute.v1.TargetPoolsProjectName;
import com.google.compute.v1.TargetPoolsRegionName;
...
@BetaApi
public class HttpTargetPoolAdminStub extends TargetPoolAdminStub {
  ...
  public static final HttpTargetPoolAdminStub create(TargetPoolAdminSettings settings) throws IOException {
    return new HttpTargetPoolAdminStub(settings, ClientContext.create(settings));
  }

  public static final HttpTargetPoolAdminStub create(ClientContext clientContext) throws IOException {
    return new HttpTargetPoolAdminStub(TargetPoolAdminSettings.defaultBuilder().build(), clientContext);
  }

  /**
   * Constructs an instance of HttpTargetPoolAdminStub, using the given settings.
   * This is protected so that it is easy to make a subclass, but otherwise, the static
   * factory methods should be preferred.
   */
  protected HttpTargetPoolAdminStub(TargetPoolAdminSettings settings, ClientContext clientContext) throws IOException {
