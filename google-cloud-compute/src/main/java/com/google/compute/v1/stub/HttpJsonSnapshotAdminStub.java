...
@BetaApi
public class HttpJsonSnapshotAdminStub extends SnapshotAdminStub {
  ...
  public static final HttpJsonSnapshotAdminStub create(SnapshotAdminSettings settings) throws IOException {
    return new HttpJsonSnapshotAdminStub(settings, ClientContext.create(settings));
  }

  public static final HttpJsonSnapshotAdminStub create(ClientContext clientContext) throws IOException {
    return new HttpJsonSnapshotAdminStub(SnapshotAdminSettings.defaultBuilder().build(), clientContext);
  }

  /**
   * Constructs an instance of HttpJsonSnapshotAdminStub, using the given settings.
   * This is protected so that it is easy to make a subclass, but otherwise, the static
   * factory methods should be preferred.
   */
  protected HttpJsonSnapshotAdminStub(SnapshotAdminSettings settings, ClientContext clientContext) throws IOException {
