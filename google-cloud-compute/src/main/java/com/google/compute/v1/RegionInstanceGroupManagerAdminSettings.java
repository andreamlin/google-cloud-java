...
import com.google.compute.v1.stub.HttpJsonRegionInstanceGroupManagerAdminStub;
...
/**
 * Settings class to configure an instance of {@link RegionInstanceGroupManagerAdminClient}.
 *
 ...
 * <pre>
 * <code>
 * RegionInstanceGroupManagerAdminSettings.Builder regionInstanceGroupManagerAdminSettingsBuilder =
 *     RegionInstanceGroupManagerAdminSettings.defaultBuilder();
 * regionInstanceGroupManagerAdminSettingsBuilder.abandonInstancesRegionInstanceGroupManagerSettings().getRetrySettingsBuilder()
 *     .setTotalTimeout(Duration.ofSeconds(30));
 * RegionInstanceGroupManagerAdminSettings regionInstanceGroupManagerAdminSettings = regionInstanceGroupManagerAdminSettingsBuilder.build();
 * </code>
 * </pre>
 */
@Generated("by GAPIC v0.0.5")
@BetaApi
public class RegionInstanceGroupManagerAdminSettings extends ClientSettings {
  /**
  ...
  public RegionInstanceGroupManagerAdminStub createStub() throws IOException {
    if (getTransportProvider().getTransportName().equals(HttpJsonTransport.getHttpJsonTransportName())) {
      return HttpJsonRegionInstanceGroupManagerAdminStub.create(this);
    } else {
  ...
  private static String getGapicVersion() {
    if (gapicVersion == null) {
      gapicVersion = PropertiesProvider.loadProperty(
          RegionInstanceGroupManagerAdminSettings.class, PROPERTIES_FILE, META_VERSION_KEY);
  ...
  private RegionInstanceGroupManagerAdminSettings(Builder settingsBuilder) throws IOException {
    super(
  ...
  /**
   * Builder for RegionInstanceGroupManagerAdminSettings.
   */
  public static class Builder extends ClientSettings.Builder {
    ...
    private Builder(RegionInstanceGroupManagerAdminSettings settings) {
      super(settings);
    ...
    @Override
    public RegionInstanceGroupManagerAdminSettings build() throws IOException {
      return new RegionInstanceGroupManagerAdminSettings(this);
    }
  }
}