...
@Generated("by GAPIC")
@BetaApi
public final class SetSslCertificatesTargetSslProxyHttpRequest implements ApiMessage {
  ...
  @Nullable
  @Override
  public TargetSslProxiesSetSslCertificatesRequest getApiMessageRequestBody() {
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(SetSslCertificatesTargetSslProxyHttpRequest other) {
      if (other == SetSslCertificatesTargetSslProxyHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(SetSslCertificatesTargetSslProxyHttpRequest source) {
