...
@BetaApi
public class HttpJsonRegionAutoscalerAdminStub extends RegionAutoscalerAdminStub {
  ...
  public static final HttpJsonRegionAutoscalerAdminStub create(RegionAutoscalerAdminSettings settings) throws IOException {
    return new HttpJsonRegionAutoscalerAdminStub(settings, ClientContext.create(settings));
  }

  public static final HttpJsonRegionAutoscalerAdminStub create(ClientContext clientContext) throws IOException {
    return new HttpJsonRegionAutoscalerAdminStub(RegionAutoscalerAdminSettings.defaultBuilder().build(), clientContext);
  }

  /**
   * Constructs an instance of HttpJsonRegionAutoscalerAdminStub, using the given settings.
   * This is protected so that it is easy to make a subclass, but otherwise, the static
   * factory methods should be preferred.
   */
  protected HttpJsonRegionAutoscalerAdminStub(RegionAutoscalerAdminSettings settings, ClientContext clientContext) throws IOException {
