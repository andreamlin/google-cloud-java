...
@Generated("by GAPIC")
@BetaApi
public final class TargetHttpProxyList implements ApiMessage {
  private final String id;
  private final List<TargetHttpProxy> items;
  ...
  public List<TargetHttpProxy> getItemsList() {
    return items;
  }
  ...
  public static class Builder {
    private String id;
    private List<TargetHttpProxy> items;
    private String kind;
    ...
    public Builder mergeFrom(TargetHttpProxyList other) {
      if (other == TargetHttpProxyList.getDefaultInstance()) return this;
      if (other.getId() != null) {
        this.id = other.id;
      }
    ...
    Builder(TargetHttpProxyList source) {
      this.id = source.id;
    ...
    public Builder addAllItems(List<TargetHttpProxy> items) {
      if (this.items == null) {
    ...
    public Builder addItems(TargetHttpProxy items) {
