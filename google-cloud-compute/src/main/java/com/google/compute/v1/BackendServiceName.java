...
public final class BackendServiceName implements ResourceName {
  ...
  public static ResourceNameFactory<BackendServiceName> newFactory() {
    return new ResourceNameFactory<BackendServiceName>() {
      public BackendServiceName parse(String formattedString) {return BackendServiceName.parse(formattedString);}
    };
  }
