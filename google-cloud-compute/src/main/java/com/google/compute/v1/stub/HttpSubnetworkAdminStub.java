...
@BetaApi
public class HttpSubnetworkAdminStub extends SubnetworkAdminStub {
  ...
  public static final HttpSubnetworkAdminStub create(SubnetworkAdminSettings settings) throws IOException {
    return new HttpSubnetworkAdminStub(settings, ClientContext.create(settings));
  }

  public static final HttpSubnetworkAdminStub create(ClientContext clientContext) throws IOException {
    return new HttpSubnetworkAdminStub(SubnetworkAdminSettings.defaultBuilder().build(), clientContext);
  }

  /**
   * Constructs an instance of HttpSubnetworkAdminStub, using the given settings.
   * This is protected so that it is easy to make a subclass, but otherwise, the static
   * factory methods should be preferred.
   */
  protected HttpSubnetworkAdminStub(SubnetworkAdminSettings settings, ClientContext clientContext) throws IOException {
