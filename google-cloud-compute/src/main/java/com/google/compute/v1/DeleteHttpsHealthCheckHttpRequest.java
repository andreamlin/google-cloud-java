...
@Generated("by GAPIC")
@BetaApi
public final class DeleteHttpsHealthCheckHttpRequest implements ApiMessage {
  ...
  public static Builder newBuilder(DeleteHttpsHealthCheckHttpRequest prototype) {
  ...
  public static DeleteHttpsHealthCheckHttpRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }
  private static final DeleteHttpsHealthCheckHttpRequest DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new DeleteHttpsHealthCheckHttpRequest();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(DeleteHttpsHealthCheckHttpRequest other) {
      if (other == DeleteHttpsHealthCheckHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(DeleteHttpsHealthCheckHttpRequest source) {
    ...
    public DeleteHttpsHealthCheckHttpRequest build() {
      String missing = "";
      ...
      return new DeleteHttpsHealthCheckHttpRequest(
        access_token,
        callback,
        fields,
        httpsHealthCheck,
    ...
    public final Builder setHttpsHealthCheckWithHttpsHealthCheckName(HttpsHealthCheckName value) {
      if (value == null) {
        return
            setHttpsHealthCheck("").          setProject("")
            ;
      }
      return
          setHttpsHealthCheck(value.getHttpsHealthCheck()).        setProject(value.getProject())
          ;
    }
  ...
  public String toString() {
    return "DeleteHttpsHealthCheckHttpRequest{"
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof DeleteHttpsHealthCheckHttpRequest) {
      DeleteHttpsHealthCheckHttpRequest that = (DeleteHttpsHealthCheckHttpRequest) o;
      return
