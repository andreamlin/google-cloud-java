...
/**
 * Settings class to configure an instance of {@link AutoscalerAdminClient}.
 *
 ...
 * <pre>
 * <code>
 * AutoscalerAdminSettings.Builder autoscalerAdminSettingsBuilder =
 *     AutoscalerAdminSettings.defaultBuilder();
 * autoscalerAdminSettingsBuilder.deleteAutoscalerSettings().getRetrySettingsBuilder()
 *     .setTotalTimeout(Duration.ofSeconds(30));
 * AutoscalerAdminSettings autoscalerAdminSettings = autoscalerAdminSettingsBuilder.build();
 * </code>
 * </pre>
 */
@Generated("by GAPIC v0.0.5")
@BetaApi
public class AutoscalerAdminSettings extends ClientSettings {
  /**
  ...
  private static String getGapicVersion() {
    if (gapicVersion == null) {
      gapicVersion = PropertiesProvider.loadProperty(
          AutoscalerAdminSettings.class, PROPERTIES_FILE, META_VERSION_KEY);
  ...
  private AutoscalerAdminSettings(Builder settingsBuilder) throws IOException {
    super(
  ...
  /**
   * Builder for AutoscalerAdminSettings.
   */
  public static class Builder extends ClientSettings.Builder {
    ...
    private Builder(AutoscalerAdminSettings settings) {
      super(settings);
    ...
    @Override
    public AutoscalerAdminSettings build() throws IOException {
      return new AutoscalerAdminSettings(this);
    }
  }
}