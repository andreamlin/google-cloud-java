...
@Generated("by GAPIC")
@BetaApi
public final class AutoscalerList implements ApiMessage {
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(AutoscalerList other) {
      if (other == AutoscalerList.getDefaultInstance()) return this;
      if (other.getId() != null) {
        this.id = other.id;
      }
