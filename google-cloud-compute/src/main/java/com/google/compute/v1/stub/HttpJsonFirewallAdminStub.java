...
import com.google.compute.v1.FirewallAdminSettings;
...
@BetaApi
public class HttpJsonFirewallAdminStub extends FirewallAdminStub {
  ...
  public static final HttpJsonFirewallAdminStub create(FirewallAdminSettings settings) throws IOException {
    return new HttpJsonFirewallAdminStub(settings, ClientContext.create(settings));
  }

  public static final HttpJsonFirewallAdminStub create(ClientContext clientContext) throws IOException {
    return new HttpJsonFirewallAdminStub(FirewallAdminSettings.defaultBuilder().build(), clientContext);
  }

  /**
   * Constructs an instance of HttpJsonFirewallAdminStub, using the given settings.
   * This is protected so that it is easy to make a subclass, but otherwise, the static
   * factory methods should be preferred.
   */
  protected HttpJsonFirewallAdminStub(FirewallAdminSettings settings, ClientContext clientContext) throws IOException {
