...
@BetaApi
public class HttpJsonVpnTunnelAdminStub extends VpnTunnelAdminStub {
  ...
  public static final HttpJsonVpnTunnelAdminStub create(VpnTunnelAdminSettings settings) throws IOException {
    return new HttpJsonVpnTunnelAdminStub(settings, ClientContext.create(settings));
  }

  public static final HttpJsonVpnTunnelAdminStub create(ClientContext clientContext) throws IOException {
    return new HttpJsonVpnTunnelAdminStub(VpnTunnelAdminSettings.defaultBuilder().build(), clientContext);
  }

  /**
   * Constructs an instance of HttpJsonVpnTunnelAdminStub, using the given settings.
   * This is protected so that it is easy to make a subclass, but otherwise, the static
   * factory methods should be preferred.
   */
  protected HttpJsonVpnTunnelAdminStub(VpnTunnelAdminSettings settings, ClientContext clientContext) throws IOException {
