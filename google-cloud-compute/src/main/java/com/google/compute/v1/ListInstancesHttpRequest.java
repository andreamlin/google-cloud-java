...
public final class ListInstancesHttpRequest implements ApiMessage {
  ...
  private ListInstancesHttpRequest() {
  ...
  public static Builder newBuilder(ListInstancesHttpRequest prototype) {
  ...
  public static ListInstancesHttpRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }
  private static final ListInstancesHttpRequest DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new ListInstancesHttpRequest();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(ListInstancesHttpRequest other) {
      if (other == ListInstancesHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(ListInstancesHttpRequest source) {
    ...
    public ListInstancesHttpRequest build() {
      String missing = "";
      ...
      return new ListInstancesHttpRequest(
        access_token,
        callback,
        fields,
        filter,
    ...
    public final Builder setZoneWithInstancesZoneName(InstancesZoneName value) {
      if (value == null) {
        return
            setProject("").          setZone("")
            ;
    ...
    public final InstancesZoneName getZoneAsInstancesZoneName() {
      return InstancesZoneName.create(
          getProject(),
          getZone()
          );
    }
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof ListInstancesHttpRequest) {
      ListInstancesHttpRequest that = (ListInstancesHttpRequest) o;
      return
