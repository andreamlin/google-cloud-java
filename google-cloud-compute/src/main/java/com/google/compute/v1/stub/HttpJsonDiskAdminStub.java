...
import com.google.compute.v1.DiskAdminSettings;
...
import com.google.compute.v1.DisksProjectName;
import com.google.compute.v1.DisksResizeRequest;
import com.google.compute.v1.DisksZoneName;
...
@BetaApi
public class HttpJsonDiskAdminStub extends DiskAdminStub {
  ...
  public static final HttpJsonDiskAdminStub create(DiskAdminSettings settings) throws IOException {
    return new HttpJsonDiskAdminStub(settings, ClientContext.create(settings));
  }

  public static final HttpJsonDiskAdminStub create(ClientContext clientContext) throws IOException {
    return new HttpJsonDiskAdminStub(DiskAdminSettings.defaultBuilder().build(), clientContext);
  }

  /**
   * Constructs an instance of HttpJsonDiskAdminStub, using the given settings.
   * This is protected so that it is easy to make a subclass, but otherwise, the static
   * factory methods should be preferred.
   */
  protected HttpJsonDiskAdminStub(DiskAdminSettings settings, ClientContext clientContext) throws IOException {
