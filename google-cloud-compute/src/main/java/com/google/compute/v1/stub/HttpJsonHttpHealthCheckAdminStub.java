...
import com.google.compute.v1.HttpHealthCheckAdminSettings;
import com.google.compute.v1.HttpHealthCheckList;
import com.google.compute.v1.HttpHealthCheckName;
import com.google.compute.v1.HttpHealthChecksProjectName;
...
@BetaApi
public class HttpJsonHttpHealthCheckAdminStub extends HttpHealthCheckAdminStub {
  ...
  public static final HttpJsonHttpHealthCheckAdminStub create(HttpHealthCheckAdminSettings settings) throws IOException {
    return new HttpJsonHttpHealthCheckAdminStub(settings, ClientContext.create(settings));
  }

  public static final HttpJsonHttpHealthCheckAdminStub create(ClientContext clientContext) throws IOException {
    return new HttpJsonHttpHealthCheckAdminStub(HttpHealthCheckAdminSettings.defaultBuilder().build(), clientContext);
  }

  /**
   * Constructs an instance of HttpJsonHttpHealthCheckAdminStub, using the given settings.
   * This is protected so that it is easy to make a subclass, but otherwise, the static
   * factory methods should be preferred.
   */
  protected HttpJsonHttpHealthCheckAdminStub(HttpHealthCheckAdminSettings settings, ClientContext clientContext) throws IOException {
