...
@Generated("by GAPIC")
@BetaApi
public final class ListImagesHttpRequest implements ApiMessage {
  ...
  public static Builder newBuilder(ListImagesHttpRequest prototype) {
  ...
  public static ListImagesHttpRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }
  private static final ListImagesHttpRequest DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new ListImagesHttpRequest();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(ListImagesHttpRequest other) {
      if (other == ListImagesHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(ListImagesHttpRequest source) {
    ...
    public ListImagesHttpRequest build() {
      String missing = "";
      ...
      return new ListImagesHttpRequest(
        access_token,
        callback,
        fields,
        filter,
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof ListImagesHttpRequest) {
      ListImagesHttpRequest that = (ListImagesHttpRequest) o;
      return
