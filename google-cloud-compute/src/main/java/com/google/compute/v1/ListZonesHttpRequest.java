...
public final class ListZonesHttpRequest implements ApiMessage {
  ...
  public static Builder newBuilder(ListZonesHttpRequest prototype) {
  ...
  public static ListZonesHttpRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }
  private static final ListZonesHttpRequest DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new ListZonesHttpRequest();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(ListZonesHttpRequest other) {
      if (other == ListZonesHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(ListZonesHttpRequest source) {
    ...
    public ListZonesHttpRequest build() {
      String missing = "";
      ...
      return new ListZonesHttpRequest(
        access_token,
        callback,
        fields,
        filter,
    ...
    public final Builder setProjectWithZonesProjectName(ZonesProjectName value) {
      if (value == null) {
        return
            setProject("")
            ;
    ...
    public final ZonesProjectName getProjectAsZonesProjectName() {
      return ZonesProjectName.create(
          getProject()
          );
    }
  }
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof ListZonesHttpRequest) {
      ListZonesHttpRequest that = (ListZonesHttpRequest) o;
      return
