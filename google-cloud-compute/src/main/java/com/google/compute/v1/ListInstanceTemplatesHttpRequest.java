...
@Generated("by GAPIC")
@BetaApi
public final class ListInstanceTemplatesHttpRequest implements ApiMessage {
  ...
  private ListInstanceTemplatesHttpRequest() {
  ...
  public static Builder newBuilder(ListInstanceTemplatesHttpRequest prototype) {
  ...
  public static ListInstanceTemplatesHttpRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }
  private static final ListInstanceTemplatesHttpRequest DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new ListInstanceTemplatesHttpRequest();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(ListInstanceTemplatesHttpRequest other) {
      if (other == ListInstanceTemplatesHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(ListInstanceTemplatesHttpRequest source) {
    ...
    public ListInstanceTemplatesHttpRequest build() {
      String missing = "";
      ...
      return new ListInstanceTemplatesHttpRequest(
        access_token,
        callback,
        fields,
        filter,
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof ListInstanceTemplatesHttpRequest) {
      ListInstanceTemplatesHttpRequest that = (ListInstanceTemplatesHttpRequest) o;
      return
