...
@BetaApi
public class HttpSslCertificateAdminStub extends SslCertificateAdminStub {
  ...
  public static final HttpSslCertificateAdminStub create(SslCertificateAdminSettings settings) throws IOException {
    return new HttpSslCertificateAdminStub(settings, ClientContext.create(settings));
  }

  public static final HttpSslCertificateAdminStub create(ClientContext clientContext) throws IOException {
    return new HttpSslCertificateAdminStub(SslCertificateAdminSettings.defaultBuilder().build(), clientContext);
  }

  /**
   * Constructs an instance of HttpSslCertificateAdminStub, using the given settings.
   * This is protected so that it is easy to make a subclass, but otherwise, the static
   * factory methods should be preferred.
   */
  protected HttpSslCertificateAdminStub(SslCertificateAdminSettings settings, ClientContext clientContext) throws IOException {
