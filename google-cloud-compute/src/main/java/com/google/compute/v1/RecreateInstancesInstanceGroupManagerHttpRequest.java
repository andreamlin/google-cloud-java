...
@Generated("by GAPIC")
@BetaApi
public final class RecreateInstancesInstanceGroupManagerHttpRequest implements ApiMessage {
  ...
  private RecreateInstancesInstanceGroupManagerHttpRequest() {
    ...
    this.instanceGroupManagersRecreateInstancesRequestResource = null;
    this.key = null;
  ...
  public static class Builder {
    ...
    Builder(RecreateInstancesInstanceGroupManagerHttpRequest source) {
