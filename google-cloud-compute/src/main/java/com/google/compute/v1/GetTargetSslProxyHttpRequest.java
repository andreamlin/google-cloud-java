...
public final class GetTargetSslProxyHttpRequest implements ApiMessage {
  ...
  private GetTargetSslProxyHttpRequest() {
  ...
  public static Builder newBuilder(GetTargetSslProxyHttpRequest prototype) {
  ...
  public static GetTargetSslProxyHttpRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }
  private static final GetTargetSslProxyHttpRequest DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new GetTargetSslProxyHttpRequest();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(GetTargetSslProxyHttpRequest other) {
      if (other == GetTargetSslProxyHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(GetTargetSslProxyHttpRequest source) {
    ...
    public GetTargetSslProxyHttpRequest build() {
      ...
      return new GetTargetSslProxyHttpRequest(
        access_token,
        callback,
        fields,
        key,
  ...
  public String toString() {
    return "GetTargetSslProxyHttpRequest{"
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof GetTargetSslProxyHttpRequest) {
      GetTargetSslProxyHttpRequest that = (GetTargetSslProxyHttpRequest) o;
      return
