...
@Generated("by GAPIC")
@BetaApi
public final class ListHealthChecksHttpRequest implements ApiMessage {
  ...
  private ListHealthChecksHttpRequest() {
  ...
  public static Builder newBuilder(ListHealthChecksHttpRequest prototype) {
  ...
  public static ListHealthChecksHttpRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }
  private static final ListHealthChecksHttpRequest DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new ListHealthChecksHttpRequest();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(ListHealthChecksHttpRequest other) {
      if (other == ListHealthChecksHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(ListHealthChecksHttpRequest source) {
    ...
    public ListHealthChecksHttpRequest build() {
      String missing = "";
      ...
      return new ListHealthChecksHttpRequest(
        access_token,
        callback,
        fields,
        filter,
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof ListHealthChecksHttpRequest) {
      ListHealthChecksHttpRequest that = (ListHealthChecksHttpRequest) o;
      return
