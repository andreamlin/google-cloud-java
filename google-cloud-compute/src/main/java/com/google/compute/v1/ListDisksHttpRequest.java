...
public final class ListDisksHttpRequest implements ApiMessage {
  ...
  public static Builder newBuilder(ListDisksHttpRequest prototype) {
  ...
  public static ListDisksHttpRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }
  private static final ListDisksHttpRequest DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new ListDisksHttpRequest();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(ListDisksHttpRequest other) {
      if (other == ListDisksHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(ListDisksHttpRequest source) {
    ...
    public ListDisksHttpRequest build() {
      String missing = "";
      ...
      return new ListDisksHttpRequest(
        access_token,
        callback,
        fields,
        filter,
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof ListDisksHttpRequest) {
      ListDisksHttpRequest that = (ListDisksHttpRequest) o;
      return
