...
public final class OperationAggregatedList implements ApiMessage {
  ...
  public static Builder newBuilder(OperationAggregatedList prototype) {
  ...
  public static OperationAggregatedList getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }
  private static final OperationAggregatedList DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new OperationAggregatedList();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(OperationAggregatedList other) {
      if (other == OperationAggregatedList.getDefaultInstance()) return this;
      if (other.getId() != null) {
        this.id = other.id;
      }
    ...
    Builder(OperationAggregatedList source) {
      this.id = source.id;
    ...
    public OperationAggregatedList build() {
      ...
      return new OperationAggregatedList(
        id,
        items,
        kind,
        nextPageToken,
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof OperationAggregatedList) {
