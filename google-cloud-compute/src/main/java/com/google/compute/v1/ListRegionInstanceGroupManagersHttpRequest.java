...
@Generated("by GAPIC")
@BetaApi
public final class ListRegionInstanceGroupManagersHttpRequest implements ApiMessage {
  ...
  private ListRegionInstanceGroupManagersHttpRequest() {
  ...
  public static Builder newBuilder(ListRegionInstanceGroupManagersHttpRequest prototype) {
  ...
  public static ListRegionInstanceGroupManagersHttpRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }
  private static final ListRegionInstanceGroupManagersHttpRequest DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new ListRegionInstanceGroupManagersHttpRequest();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(ListRegionInstanceGroupManagersHttpRequest other) {
      if (other == ListRegionInstanceGroupManagersHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(ListRegionInstanceGroupManagersHttpRequest source) {
    ...
    public ListRegionInstanceGroupManagersHttpRequest build() {
      String missing = "";
      ...
      return new ListRegionInstanceGroupManagersHttpRequest(
        access_token,
        callback,
        fields,
        filter,
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof ListRegionInstanceGroupManagersHttpRequest) {
      ListRegionInstanceGroupManagersHttpRequest that = (ListRegionInstanceGroupManagersHttpRequest) o;
      return
