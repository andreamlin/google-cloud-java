...
import com.google.compute.v1.ForwardingRulesProjectName;
import com.google.compute.v1.ForwardingRulesRegionName;
...
@BetaApi
public class HttpForwardingRuleAdminStub extends ForwardingRuleAdminStub {
  ...
  public static final HttpForwardingRuleAdminStub create(ForwardingRuleAdminSettings settings) throws IOException {
    return new HttpForwardingRuleAdminStub(settings, ClientContext.create(settings));
  }

  public static final HttpForwardingRuleAdminStub create(ClientContext clientContext) throws IOException {
    return new HttpForwardingRuleAdminStub(ForwardingRuleAdminSettings.defaultBuilder().build(), clientContext);
  }

  /**
   * Constructs an instance of HttpForwardingRuleAdminStub, using the given settings.
   * This is protected so that it is easy to make a subclass, but otherwise, the static
   * factory methods should be preferred.
   */
  protected HttpForwardingRuleAdminStub(ForwardingRuleAdminSettings settings, ClientContext clientContext) throws IOException {
