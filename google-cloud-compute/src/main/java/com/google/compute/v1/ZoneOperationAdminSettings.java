...
import com.google.compute.v1.stub.HttpJsonZoneOperationAdminStub;
...
/**
 * Settings class to configure an instance of {@link ZoneOperationAdminClient}.
 *
 ...
 * <pre>
 * <code>
 * ZoneOperationAdminSettings.Builder zoneOperationAdminSettingsBuilder =
 *     ZoneOperationAdminSettings.defaultBuilder();
 * zoneOperationAdminSettingsBuilder.deleteZoneOperationSettings().getRetrySettingsBuilder()
 *     .setTotalTimeout(Duration.ofSeconds(30));
 * ZoneOperationAdminSettings zoneOperationAdminSettings = zoneOperationAdminSettingsBuilder.build();
 * </code>
 * </pre>
 */
@Generated("by GAPIC v0.0.5")
@BetaApi
public class ZoneOperationAdminSettings extends ClientSettings {
  /**
  ...
  public ZoneOperationAdminStub createStub() throws IOException {
    if (getTransportProvider().getTransportName().equals(HttpJsonTransport.getHttpJsonTransportName())) {
      return HttpJsonZoneOperationAdminStub.create(this);
    } else {
  ...
  private static String getGapicVersion() {
    if (gapicVersion == null) {
      gapicVersion = PropertiesProvider.loadProperty(
          ZoneOperationAdminSettings.class, PROPERTIES_FILE, META_VERSION_KEY);
  ...
  private ZoneOperationAdminSettings(Builder settingsBuilder) throws IOException {
    super(
  ...
  /**
   * Builder for ZoneOperationAdminSettings.
   */
  public static class Builder extends ClientSettings.Builder {
    ...
    private Builder(ZoneOperationAdminSettings settings) {
      super(settings);
    ...
    @Override
    public ZoneOperationAdminSettings build() throws IOException {
      return new ZoneOperationAdminSettings(this);
    }
  }
}