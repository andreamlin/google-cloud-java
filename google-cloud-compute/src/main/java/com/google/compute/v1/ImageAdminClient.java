 ...
 * </pre>
 *
 * <p>Note: close() needs to be called on the imageAdminClient object to clean up resources such
 ...
 * returned.
 *
 * <p>This class can be customized by passing in a custom instance of ImageAdminSettings to
 * create(). For example:
 *
 ...
 * <pre>
 * <code>
 * ImageAdminSettings imageAdminSettings =
 *     ImageAdminSettings.defaultBuilder()
 *         .setCredentialsProvider(FixedCredentialsProvider.create(myCredentials))
 *         .build();
 * ImageAdminClient imageAdminClient =
 *     ImageAdminClient.create(imageAdminSettings);
 * </code>
 * </pre>
 *
 ...
 * ImageAdminSettings imageAdminSettings =
 *     ImageAdminSettings.defaultBuilder()
 *         .setTransportProvider(ImageAdminSettings.defaultGrpcTransportProviderBuilder()
 *             .setChannelProvider(ImageAdminSettings.defaultGrpcChannelProviderBuilder()
...
@BetaApi
public class ImageAdminClient implements BackgroundResource {
  private final ImageAdminSettings settings;
  private final ImageAdminStub stub;



  /**
   * Constructs an instance of ImageAdminClient with default settings.
   */
  public static final ImageAdminClient create() throws IOException {
    return create(ImageAdminSettings.defaultBuilder().build());
  }

  /**
   * Constructs an instance of ImageAdminClient, using the given settings.
   * The channels are created based on the settings passed in, or defaults for any
   * settings that are not set.
   */
  public static final ImageAdminClient create(ImageAdminSettings settings) throws IOException {
    return new ImageAdminClient(settings);
  }

  /**
   * Constructs an instance of ImageAdminClient, using the given stub for making calls. This is for
   * advanced usage - prefer to use ImageAdminSettings}.
   */
  public static final ImageAdminClient create(ImageAdminStub stub) {
    return new ImageAdminClient(stub);
  }
   ...
   */
  protected ImageAdminClient(ImageAdminSettings settings) throws IOException {
    this.settings = settings;
    this.stub = settings.createStub();
  }

  protected ImageAdminClient(ImageAdminStub stub) {
    this.settings = null;
    this.stub = stub;
  }

  public final ImageAdminSettings getSettings() {
    return settings;
  }

  public ImageAdminStub getStub() {
    return stub;
  }
   ...
   * try (ImageAdminClient imageAdminClient = ImageAdminClient.create()) {
   *
   *   ApiFuture&lt;Operation&gt; future = imageAdminClient.deleteImageCallable().futureCall();
   *   // Do something
   ...
   * try (ImageAdminClient imageAdminClient = ImageAdminClient.create()) {
   *
   *   Operation response = imageAdminClient.deprecateImage();
   * }
   * </code></pre>
   *
   ...
   * try (ImageAdminClient imageAdminClient = ImageAdminClient.create()) {
   *
   *   ApiFuture&lt;Operation&gt; future = imageAdminClient.deprecateImageCallable().futureCall();
   *   // Do something
   *   Operation response = future.get();
   * }
   * </code></pre>
   ...
   * try (ImageAdminClient imageAdminClient = ImageAdminClient.create()) {
   *
   *   Image response = imageAdminClient.getImage();
   * }
   * </code></pre>
   *
   ...
   * try (ImageAdminClient imageAdminClient = ImageAdminClient.create()) {
   *
   *   ApiFuture&lt;Image&gt; future = imageAdminClient.getImageCallable().futureCall();
   *   // Do something
   ...
   * try (ImageAdminClient imageAdminClient = ImageAdminClient.create()) {
   *
   *   Image response = imageAdminClient.getFromFamilyImage();
   * }
   * </code></pre>
   *
   ...
   * try (ImageAdminClient imageAdminClient = ImageAdminClient.create()) {
   *
   *   ApiFuture&lt;Image&gt; future = imageAdminClient.getFromFamilyImageCallable().futureCall();
   *   // Do something
   *   Image response = future.get();
   * }
   * </code></pre>
   ...
   * try (ImageAdminClient imageAdminClient = ImageAdminClient.create()) {
   *
   *   Operation response = imageAdminClient.insertImage();
   * }
   * </code></pre>
   *
   ...
   * try (ImageAdminClient imageAdminClient = ImageAdminClient.create()) {
   *
   *   ApiFuture&lt;Operation&gt; future = imageAdminClient.insertImageCallable().futureCall();
   *   // Do something
   *   Operation response = future.get();
   * }
   * </code></pre>
   ...
   * try (ImageAdminClient imageAdminClient = ImageAdminClient.create()) {
   *
   *   for (Image element : imageAdminClient.listImages().iterateAll()) {
   ...
   * try (ImageAdminClient imageAdminClient = ImageAdminClient.create()) {
   *
   *   ApiFuture&lt;ListImagesPagedResponse&gt; future = imageAdminClient.listImagesPagedCallable().futureCall();
   *   // Do something
   ...
   *
   *   while (true) {
   *     ImageList response = imageAdminClient.listImagesCallable().call();
