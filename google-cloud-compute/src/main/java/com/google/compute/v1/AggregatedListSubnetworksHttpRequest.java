...
public final class AggregatedListSubnetworksHttpRequest implements ApiMessage {
  ...
  private AggregatedListSubnetworksHttpRequest() {
  ...
  public static Builder newBuilder(AggregatedListSubnetworksHttpRequest prototype) {
  ...
  public static AggregatedListSubnetworksHttpRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }
  private static final AggregatedListSubnetworksHttpRequest DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new AggregatedListSubnetworksHttpRequest();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(AggregatedListSubnetworksHttpRequest other) {
      if (other == AggregatedListSubnetworksHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(AggregatedListSubnetworksHttpRequest source) {
    ...
    public AggregatedListSubnetworksHttpRequest build() {
      String missing = "";
      ...
      return new AggregatedListSubnetworksHttpRequest(
        access_token,
        callback,
        fields,
        filter,
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof AggregatedListSubnetworksHttpRequest) {
      AggregatedListSubnetworksHttpRequest that = (AggregatedListSubnetworksHttpRequest) o;
      return
