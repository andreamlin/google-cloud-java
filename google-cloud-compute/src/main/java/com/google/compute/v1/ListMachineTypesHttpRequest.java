...
@Generated("by GAPIC")
@BetaApi
public final class ListMachineTypesHttpRequest implements ApiMessage {
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(ListMachineTypesHttpRequest other) {
      if (other == ListMachineTypesHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(ListMachineTypesHttpRequest source) {
