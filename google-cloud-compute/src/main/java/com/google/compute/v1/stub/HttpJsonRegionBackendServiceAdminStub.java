...
@BetaApi
public class HttpJsonRegionBackendServiceAdminStub extends RegionBackendServiceAdminStub {
  ...
  public static final HttpJsonRegionBackendServiceAdminStub create(RegionBackendServiceAdminSettings settings) throws IOException {
    return new HttpJsonRegionBackendServiceAdminStub(settings, ClientContext.create(settings));
  }

  public static final HttpJsonRegionBackendServiceAdminStub create(ClientContext clientContext) throws IOException {
    return new HttpJsonRegionBackendServiceAdminStub(RegionBackendServiceAdminSettings.defaultBuilder().build(), clientContext);
  }

  /**
   * Constructs an instance of HttpJsonRegionBackendServiceAdminStub, using the given settings.
   * This is protected so that it is easy to make a subclass, but otherwise, the static
   * factory methods should be preferred.
   */
  protected HttpJsonRegionBackendServiceAdminStub(RegionBackendServiceAdminSettings settings, ClientContext clientContext) throws IOException {
