...
public final class AggregatedListDisksHttpRequest implements ApiMessage {
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(AggregatedListDisksHttpRequest other) {
      if (other == AggregatedListDisksHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(AggregatedListDisksHttpRequest source) {
    ...
    public final Builder setProjectWithDisksProjectName(DisksProjectName value) {
      if (value == null) {
        return
            setProject("")
            ;
    ...
    public final DisksProjectName getProjectAsDisksProjectName() {
      return DisksProjectName.create(
          getProject()
          );
    }
  }
