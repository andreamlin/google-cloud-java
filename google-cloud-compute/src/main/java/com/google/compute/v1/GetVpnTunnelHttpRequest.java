...
public final class GetVpnTunnelHttpRequest implements ApiMessage {
  ...
  private GetVpnTunnelHttpRequest(
    ...
    VpnTunnelName resourceName = VpnTunnelName.parse(vpnTunnel);
    mapBuilder.put("project", resourceName.getProject());
    mapBuilder.put("region", resourceName.getRegion());
    mapBuilder.put("vpnTunnel", resourceName.getVpnTunnel());
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(GetVpnTunnelHttpRequest other) {
      if (other == GetVpnTunnelHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(GetVpnTunnelHttpRequest source) {
