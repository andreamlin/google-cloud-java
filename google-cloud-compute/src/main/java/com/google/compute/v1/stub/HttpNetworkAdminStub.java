...
@BetaApi
public class HttpNetworkAdminStub extends NetworkAdminStub {
  ...
  public static final HttpNetworkAdminStub create(NetworkAdminSettings settings) throws IOException {
    return new HttpNetworkAdminStub(settings, ClientContext.create(settings));
  }

  public static final HttpNetworkAdminStub create(ClientContext clientContext) throws IOException {
    return new HttpNetworkAdminStub(NetworkAdminSettings.defaultBuilder().build(), clientContext);
  }

  /**
   * Constructs an instance of HttpNetworkAdminStub, using the given settings.
   * This is protected so that it is easy to make a subclass, but otherwise, the static
   * factory methods should be preferred.
   */
  protected HttpNetworkAdminStub(NetworkAdminSettings settings, ClientContext clientContext) throws IOException {
