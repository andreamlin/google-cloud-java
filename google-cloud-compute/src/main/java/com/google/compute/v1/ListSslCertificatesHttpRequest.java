...
@Generated("by GAPIC")
@BetaApi
public final class ListSslCertificatesHttpRequest implements ApiMessage {
  ...
  private ListSslCertificatesHttpRequest() {
  ...
  public static Builder newBuilder(ListSslCertificatesHttpRequest prototype) {
  ...
  public static ListSslCertificatesHttpRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }
  private static final ListSslCertificatesHttpRequest DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new ListSslCertificatesHttpRequest();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(ListSslCertificatesHttpRequest other) {
      if (other == ListSslCertificatesHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(ListSslCertificatesHttpRequest source) {
    ...
    public ListSslCertificatesHttpRequest build() {
      String missing = "";
      ...
      return new ListSslCertificatesHttpRequest(
        access_token,
        callback,
        fields,
        filter,
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof ListSslCertificatesHttpRequest) {
      ListSslCertificatesHttpRequest that = (ListSslCertificatesHttpRequest) o;
      return
