...
public final class GetTargetPoolHttpRequest implements ApiMessage {
  ...
  private GetTargetPoolHttpRequest() {
  ...
  public static Builder newBuilder(GetTargetPoolHttpRequest prototype) {
  ...
  public static GetTargetPoolHttpRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }
  private static final GetTargetPoolHttpRequest DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new GetTargetPoolHttpRequest();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(GetTargetPoolHttpRequest other) {
      if (other == GetTargetPoolHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(GetTargetPoolHttpRequest source) {
    ...
    public GetTargetPoolHttpRequest build() {
      String missing = "";
      ...
      return new GetTargetPoolHttpRequest(
        access_token,
        callback,
        fields,
        key,
  ...
  public String toString() {
    return "GetTargetPoolHttpRequest{"
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof GetTargetPoolHttpRequest) {
      GetTargetPoolHttpRequest that = (GetTargetPoolHttpRequest) o;
      return
