...
public final class ListRegionBackendServicesHttpRequest implements ApiMessage {
  ...
  private ListRegionBackendServicesHttpRequest() {
  ...
  public static Builder newBuilder(ListRegionBackendServicesHttpRequest prototype) {
  ...
  public static ListRegionBackendServicesHttpRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }
  private static final ListRegionBackendServicesHttpRequest DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new ListRegionBackendServicesHttpRequest();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(ListRegionBackendServicesHttpRequest other) {
      if (other == ListRegionBackendServicesHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(ListRegionBackendServicesHttpRequest source) {
    ...
    public ListRegionBackendServicesHttpRequest build() {
      String missing = "";
      ...
      return new ListRegionBackendServicesHttpRequest(
        access_token,
        callback,
        fields,
        filter,
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof ListRegionBackendServicesHttpRequest) {
      ListRegionBackendServicesHttpRequest that = (ListRegionBackendServicesHttpRequest) o;
      return
