...
public final class LicenseName implements ResourceName {
  ...
  public static ResourceNameFactory<LicenseName> newFactory() {
    return new ResourceNameFactory<LicenseName>() {
      public LicenseName parse(String formattedString) {return LicenseName.parse(formattedString);}
    };
  }
