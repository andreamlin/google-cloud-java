...
public final class DeleteInstancesInstanceGroupManagerHttpRequest implements ApiMessage {
  ...
  private DeleteInstancesInstanceGroupManagerHttpRequest() {
    ...
    this.instanceGroupManagersDeleteInstancesRequestResource = null;
    this.key = null;
  ...
  @Nullable
  @Override
  public InstanceGroupManagersDeleteInstancesRequest getApiMessageRequestBody() {
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(DeleteInstancesInstanceGroupManagerHttpRequest other) {
      if (other == DeleteInstancesInstanceGroupManagerHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(DeleteInstancesInstanceGroupManagerHttpRequest source) {
