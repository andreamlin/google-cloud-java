...
public class GlobalOperationSettings extends ClientSettings {
  ...
  private static String getGapicVersion() {
    if (gapicVersion == null) {
      gapicVersion = PropertiesProvider.loadProperty(
          GlobalOperationSettings.class, PROPERTIES_FILE, META_VERSION_KEY);
  ...
  private GlobalOperationSettings(Builder settingsBuilder) throws IOException {
    super(
  ...
  public static class Builder extends ClientSettings.Builder {
    ...
    private Builder(GlobalOperationSettings settings) {
      super(settings);
