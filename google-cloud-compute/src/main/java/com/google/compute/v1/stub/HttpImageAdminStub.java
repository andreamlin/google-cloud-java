...
@BetaApi
public class HttpImageAdminStub extends ImageAdminStub {
  ...
  public static final HttpImageAdminStub create(ImageAdminSettings settings) throws IOException {
    return new HttpImageAdminStub(settings, ClientContext.create(settings));
  }

  public static final HttpImageAdminStub create(ClientContext clientContext) throws IOException {
    return new HttpImageAdminStub(ImageAdminSettings.defaultBuilder().build(), clientContext);
  }

  /**
   * Constructs an instance of HttpImageAdminStub, using the given settings.
   * This is protected so that it is easy to make a subclass, but otherwise, the static
   * factory methods should be preferred.
   */
  protected HttpImageAdminStub(ImageAdminSettings settings, ClientContext clientContext) throws IOException {
