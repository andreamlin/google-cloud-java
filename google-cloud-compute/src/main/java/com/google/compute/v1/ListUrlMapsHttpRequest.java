...
@Generated("by GAPIC")
@BetaApi
public final class ListUrlMapsHttpRequest implements ApiMessage {
  ...
  private ListUrlMapsHttpRequest() {
  ...
  public static Builder newBuilder(ListUrlMapsHttpRequest prototype) {
  ...
  public static ListUrlMapsHttpRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }
  private static final ListUrlMapsHttpRequest DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new ListUrlMapsHttpRequest();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(ListUrlMapsHttpRequest other) {
      if (other == ListUrlMapsHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(ListUrlMapsHttpRequest source) {
    ...
    public ListUrlMapsHttpRequest build() {
      String missing = "";
      ...
      return new ListUrlMapsHttpRequest(
        access_token,
        callback,
        fields,
        filter,
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof ListUrlMapsHttpRequest) {
      ListUrlMapsHttpRequest that = (ListUrlMapsHttpRequest) o;
      return
