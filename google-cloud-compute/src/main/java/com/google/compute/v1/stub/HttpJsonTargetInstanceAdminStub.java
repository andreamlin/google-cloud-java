...
import com.google.compute.v1.TargetInstanceAdminSettings;
...
import com.google.compute.v1.TargetInstancesProjectName;
import com.google.compute.v1.TargetInstancesZoneName;
...
@BetaApi
public class HttpJsonTargetInstanceAdminStub extends TargetInstanceAdminStub {
  ...
  public static final HttpJsonTargetInstanceAdminStub create(TargetInstanceAdminSettings settings) throws IOException {
    return new HttpJsonTargetInstanceAdminStub(settings, ClientContext.create(settings));
  }

  public static final HttpJsonTargetInstanceAdminStub create(ClientContext clientContext) throws IOException {
    return new HttpJsonTargetInstanceAdminStub(TargetInstanceAdminSettings.defaultBuilder().build(), clientContext);
  }

  /**
   * Constructs an instance of HttpJsonTargetInstanceAdminStub, using the given settings.
   * This is protected so that it is easy to make a subclass, but otherwise, the static
   * factory methods should be preferred.
   */
  protected HttpJsonTargetInstanceAdminStub(TargetInstanceAdminSettings settings, ClientContext clientContext) throws IOException {
