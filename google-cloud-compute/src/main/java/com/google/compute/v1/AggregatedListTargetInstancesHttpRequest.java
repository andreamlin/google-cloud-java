...
public final class AggregatedListTargetInstancesHttpRequest implements ApiMessage {
  ...
  private AggregatedListTargetInstancesHttpRequest() {
  ...
  public static Builder newBuilder(AggregatedListTargetInstancesHttpRequest prototype) {
  ...
  public static AggregatedListTargetInstancesHttpRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }
  private static final AggregatedListTargetInstancesHttpRequest DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new AggregatedListTargetInstancesHttpRequest();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(AggregatedListTargetInstancesHttpRequest other) {
      if (other == AggregatedListTargetInstancesHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(AggregatedListTargetInstancesHttpRequest source) {
    ...
    public AggregatedListTargetInstancesHttpRequest build() {
      String missing = "";
      ...
      return new AggregatedListTargetInstancesHttpRequest(
        access_token,
        callback,
        fields,
        filter,
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof AggregatedListTargetInstancesHttpRequest) {
      AggregatedListTargetInstancesHttpRequest that = (AggregatedListTargetInstancesHttpRequest) o;
      return
