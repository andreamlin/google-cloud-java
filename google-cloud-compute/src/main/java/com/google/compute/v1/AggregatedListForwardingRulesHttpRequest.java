...
public final class AggregatedListForwardingRulesHttpRequest implements ApiMessage {
  ...
  private AggregatedListForwardingRulesHttpRequest() {
  ...
  public static Builder newBuilder(AggregatedListForwardingRulesHttpRequest prototype) {
  ...
  public static AggregatedListForwardingRulesHttpRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }
  private static final AggregatedListForwardingRulesHttpRequest DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new AggregatedListForwardingRulesHttpRequest();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(AggregatedListForwardingRulesHttpRequest other) {
      if (other == AggregatedListForwardingRulesHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(AggregatedListForwardingRulesHttpRequest source) {
    ...
    public AggregatedListForwardingRulesHttpRequest build() {
      String missing = "";
      ...
      return new AggregatedListForwardingRulesHttpRequest(
        access_token,
        callback,
        fields,
        filter,
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof AggregatedListForwardingRulesHttpRequest) {
      AggregatedListForwardingRulesHttpRequest that = (AggregatedListForwardingRulesHttpRequest) o;
      return
