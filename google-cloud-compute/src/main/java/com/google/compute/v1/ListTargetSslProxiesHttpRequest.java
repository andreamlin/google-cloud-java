...
@Generated("by GAPIC")
@BetaApi
public final class ListTargetSslProxiesHttpRequest implements ApiMessage {
  ...
  public static Builder newBuilder(ListTargetSslProxiesHttpRequest prototype) {
  ...
  public static ListTargetSslProxiesHttpRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }
  private static final ListTargetSslProxiesHttpRequest DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new ListTargetSslProxiesHttpRequest();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(ListTargetSslProxiesHttpRequest other) {
      if (other == ListTargetSslProxiesHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(ListTargetSslProxiesHttpRequest source) {
    ...
    public ListTargetSslProxiesHttpRequest build() {
      String missing = "";
      ...
      return new ListTargetSslProxiesHttpRequest(
        access_token,
        callback,
        fields,
        filter,
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof ListTargetSslProxiesHttpRequest) {
      ListTargetSslProxiesHttpRequest that = (ListTargetSslProxiesHttpRequest) o;
      return
