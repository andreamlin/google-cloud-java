...
public final class InsertTargetVpnGatewayHttpRequest implements ApiMessage {
  ...
  public Map<String, List<String>> populateFieldsInMap(Set<String> fieldNames) {
    ...
    if (fieldNames.contains("targetVpnGatewayResource") && targetVpnGatewayResource != null) {
      fieldMap.put("targetVpnGatewayResource", Collections.singletonList(String.valueOf(targetVpnGatewayResource)));
    }
  ...
  @Nullable
  @Override
  public TargetVpnGateway requestBody() {
  ...
  public String toString() {
    return "InsertTargetVpnGatewayHttpRequest{"
        ...
        + "quotaUser=" + quotaUser + ", "
        + "region=" + region + ", "
        + "targetVpnGatewayResource=" + targetVpnGatewayResource + ", "
        + "userIp=" + userIp
        + "}";
  }
