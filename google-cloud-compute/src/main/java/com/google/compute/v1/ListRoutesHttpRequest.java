...
@Generated("by GAPIC")
@BetaApi
public final class ListRoutesHttpRequest implements ApiMessage {
  ...
  public static Builder newBuilder(ListRoutesHttpRequest prototype) {
  ...
  public static ListRoutesHttpRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }
  private static final ListRoutesHttpRequest DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new ListRoutesHttpRequest();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(ListRoutesHttpRequest other) {
      if (other == ListRoutesHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(ListRoutesHttpRequest source) {
    ...
    public ListRoutesHttpRequest build() {
      String missing = "";
      ...
      return new ListRoutesHttpRequest(
        access_token,
        callback,
        fields,
        filter,
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof ListRoutesHttpRequest) {
      ListRoutesHttpRequest that = (ListRoutesHttpRequest) o;
      return
