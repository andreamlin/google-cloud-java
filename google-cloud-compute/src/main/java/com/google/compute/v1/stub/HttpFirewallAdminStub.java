...
@BetaApi
public class HttpFirewallAdminStub extends FirewallAdminStub {
  ...
  public static final HttpFirewallAdminStub create(FirewallAdminSettings settings) throws IOException {
    return new HttpFirewallAdminStub(settings, ClientContext.create(settings));
  }

  public static final HttpFirewallAdminStub create(ClientContext clientContext) throws IOException {
    return new HttpFirewallAdminStub(FirewallAdminSettings.defaultBuilder().build(), clientContext);
  }

  /**
   * Constructs an instance of HttpFirewallAdminStub, using the given settings.
   * This is protected so that it is easy to make a subclass, but otherwise, the static
   * factory methods should be preferred.
   */
  protected HttpFirewallAdminStub(FirewallAdminSettings settings, ClientContext clientContext) throws IOException {
