...
@BetaApi
public class HttpGlobalAddressAdminStub extends GlobalAddressAdminStub {
  ...
  public static final HttpGlobalAddressAdminStub create(GlobalAddressAdminSettings settings) throws IOException {
    return new HttpGlobalAddressAdminStub(settings, ClientContext.create(settings));
  }

  public static final HttpGlobalAddressAdminStub create(ClientContext clientContext) throws IOException {
    return new HttpGlobalAddressAdminStub(GlobalAddressAdminSettings.defaultBuilder().build(), clientContext);
  }

  /**
   * Constructs an instance of HttpGlobalAddressAdminStub, using the given settings.
   * This is protected so that it is easy to make a subclass, but otherwise, the static
   * factory methods should be preferred.
   */
  protected HttpGlobalAddressAdminStub(GlobalAddressAdminSettings settings, ClientContext clientContext) throws IOException {
