...
@Generated("by GAPIC")
@BetaApi
public final class HealthCheckList implements ApiMessage {
  private final String id;
  private final List<HealthCheck> items;
  ...
  public static class Builder {
    private String id;
    private List<HealthCheck> items;
    private String kind;
    ...
    public Builder mergeFrom(HealthCheckList other) {
      if (other == HealthCheckList.getDefaultInstance()) return this;
      if (other.getId() != null) {
        this.id = other.id;
      }
    ...
    Builder(HealthCheckList source) {
      this.id = source.id;
    ...
    public Builder addAllItems(List<HealthCheck> items) {
      this.items.addAll(items);
      return this;
    }

    public Builder addItems(HealthCheck items) {
