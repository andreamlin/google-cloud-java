...
@Generated("by GAPIC")
@BetaApi
public final class ListGlobalAddressesHttpRequest implements ApiMessage {
  ...
  private ListGlobalAddressesHttpRequest() {
  ...
  public static Builder newBuilder(ListGlobalAddressesHttpRequest prototype) {
  ...
  public static ListGlobalAddressesHttpRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }
  private static final ListGlobalAddressesHttpRequest DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new ListGlobalAddressesHttpRequest();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(ListGlobalAddressesHttpRequest other) {
      if (other == ListGlobalAddressesHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(ListGlobalAddressesHttpRequest source) {
    ...
    public ListGlobalAddressesHttpRequest build() {
      String missing = "";
      ...
      return new ListGlobalAddressesHttpRequest(
        access_token,
        callback,
        fields,
        filter,
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof ListGlobalAddressesHttpRequest) {
      ListGlobalAddressesHttpRequest that = (ListGlobalAddressesHttpRequest) o;
      return
