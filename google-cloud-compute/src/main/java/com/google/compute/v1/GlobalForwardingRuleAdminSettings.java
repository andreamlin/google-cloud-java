...
import com.google.compute.v1.stub.HttpJsonGlobalForwardingRuleAdminStub;
...
/**
 * Settings class to configure an instance of {@link GlobalForwardingRuleAdminClient}.
 *
 ...
 * <pre>
 * <code>
 * GlobalForwardingRuleAdminSettings.Builder globalForwardingRuleAdminSettingsBuilder =
 *     GlobalForwardingRuleAdminSettings.defaultBuilder();
 * globalForwardingRuleAdminSettingsBuilder.deleteGlobalForwardingRuleSettings().getRetrySettingsBuilder()
 *     .setTotalTimeout(Duration.ofSeconds(30));
 * GlobalForwardingRuleAdminSettings globalForwardingRuleAdminSettings = globalForwardingRuleAdminSettingsBuilder.build();
 * </code>
 * </pre>
 */
@Generated("by GAPIC v0.0.5")
@BetaApi
public class GlobalForwardingRuleAdminSettings extends ClientSettings {
  /**
  ...
  public GlobalForwardingRuleAdminStub createStub() throws IOException {
    if (getTransportProvider().getTransportName().equals(HttpJsonTransport.getHttpJsonTransportName())) {
      return HttpJsonGlobalForwardingRuleAdminStub.create(this);
    } else {
  ...
  private static String getGapicVersion() {
    if (gapicVersion == null) {
      gapicVersion = PropertiesProvider.loadProperty(
          GlobalForwardingRuleAdminSettings.class, PROPERTIES_FILE, META_VERSION_KEY);
  ...
  private GlobalForwardingRuleAdminSettings(Builder settingsBuilder) throws IOException {
    super(
  ...
  /**
   * Builder for GlobalForwardingRuleAdminSettings.
   */
  public static class Builder extends ClientSettings.Builder {
    ...
    private Builder(GlobalForwardingRuleAdminSettings settings) {
      super(settings);
    ...
    @Override
    public GlobalForwardingRuleAdminSettings build() throws IOException {
      return new GlobalForwardingRuleAdminSettings(this);
    }
  }
}