...
@Generated("by GAPIC")
@BetaApi
public final class DeleteInstanceGroupManagerHttpRequest implements ApiMessage {
  ...
  public static Builder newBuilder(DeleteInstanceGroupManagerHttpRequest prototype) {
  ...
  public static DeleteInstanceGroupManagerHttpRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }
  private static final DeleteInstanceGroupManagerHttpRequest DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new DeleteInstanceGroupManagerHttpRequest();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(DeleteInstanceGroupManagerHttpRequest other) {
      if (other == DeleteInstanceGroupManagerHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(DeleteInstanceGroupManagerHttpRequest source) {
    ...
    public DeleteInstanceGroupManagerHttpRequest build() {
      String missing = "";
      ...
      return new DeleteInstanceGroupManagerHttpRequest(
        access_token,
        callback,
        fields,
  ...
  public String toString() {
    return "DeleteInstanceGroupManagerHttpRequest{"
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof DeleteInstanceGroupManagerHttpRequest) {
      DeleteInstanceGroupManagerHttpRequest that = (DeleteInstanceGroupManagerHttpRequest) o;
      return
