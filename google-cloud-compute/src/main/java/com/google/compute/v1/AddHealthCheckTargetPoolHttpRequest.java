...
public final class AddHealthCheckTargetPoolHttpRequest implements ApiMessage {
  ...
  private final TargetPoolsAddHealthCheckRequest targetPoolsAddHealthCheckRequestResource;
  ...
  private AddHealthCheckTargetPoolHttpRequest() {
    ...
    this.targetPoolsAddHealthCheckRequestResource = null;
    this.userIp = null;
  }
  ...
  public String getFieldStringValue(String fieldName) {
    ...
    if (fieldName.equals("targetPoolsAddHealthCheckRequestResource")) {
  ...
  @Nullable
  @Override
  public TargetPoolsAddHealthCheckRequest getApiMessageRequestBody() {
  ...
  public TargetPoolsAddHealthCheckRequest getTargetPoolsAddHealthCheckRequestResource() {
    return targetPoolsAddHealthCheckRequestResource;
  }
  ...
  public static class Builder {
    ...
    private TargetPoolsAddHealthCheckRequest targetPoolsAddHealthCheckRequestResource;
    private String userIp;

    Builder() {}

    public Builder mergeFrom(AddHealthCheckTargetPoolHttpRequest other) {
      if (other == AddHealthCheckTargetPoolHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(AddHealthCheckTargetPoolHttpRequest source) {
