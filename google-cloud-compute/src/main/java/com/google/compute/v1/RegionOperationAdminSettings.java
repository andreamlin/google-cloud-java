...
import com.google.compute.v1.stub.HttpJsonRegionOperationAdminStub;
...
/**
 * Settings class to configure an instance of {@link RegionOperationAdminClient}.
 *
 ...
 * <pre>
 * <code>
 * RegionOperationAdminSettings.Builder regionOperationAdminSettingsBuilder =
 *     RegionOperationAdminSettings.defaultBuilder();
 * regionOperationAdminSettingsBuilder.deleteRegionOperationSettings().getRetrySettingsBuilder()
 *     .setTotalTimeout(Duration.ofSeconds(30));
 * RegionOperationAdminSettings regionOperationAdminSettings = regionOperationAdminSettingsBuilder.build();
 * </code>
 * </pre>
 */
@Generated("by GAPIC v0.0.5")
@BetaApi
public class RegionOperationAdminSettings extends ClientSettings {
  /**
   ...
   */
  public SimpleCallSettings<GetRegionOperationHttpRequest, Operation> getRegionOperationSettings() {
  ...
  public RegionOperationAdminStub createStub() throws IOException {
    if (getTransportProvider().getTransportName().equals(HttpJsonTransport.getHttpJsonTransportName())) {
      return HttpJsonRegionOperationAdminStub.create(this);
    } else {
  ...
  private static String getGapicVersion() {
    if (gapicVersion == null) {
      gapicVersion = PropertiesProvider.loadProperty(
          RegionOperationAdminSettings.class, PROPERTIES_FILE, META_VERSION_KEY);
  ...
  private RegionOperationAdminSettings(Builder settingsBuilder) throws IOException {
    super(
  ...
  /**
   * Builder for RegionOperationAdminSettings.
   */
  public static class Builder extends ClientSettings.Builder {
    ...
    private Builder(ClientContext clientContext) {
      ...
      deleteRegionOperationSettings = SimpleCallSettings.newBuilder();

      getRegionOperationSettings = SimpleCallSettings.newBuilder();
    ...
    private Builder(RegionOperationAdminSettings settings) {
      super(settings);
     ...
     */
    public SimpleCallSettings.Builder<GetRegionOperationHttpRequest, Operation> getRegionOperationSettings() {
      return getRegionOperationSettings;
    }
    ...
    @Override
    public RegionOperationAdminSettings build() throws IOException {
      return new RegionOperationAdminSettings(this);
    }
  }
}