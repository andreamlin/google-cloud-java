...
@Generated("by GAPIC")
@BetaApi
public final class NetworkList implements ApiMessage {
  ...
  public List<Network> getItemsList() {
    return items;
  }
  ...
  public static class Builder {
    ...
    public Builder addAllItems(List<Network> items) {
      if (this.items == null) {
    ...
    public Builder addItems(Network items) {
