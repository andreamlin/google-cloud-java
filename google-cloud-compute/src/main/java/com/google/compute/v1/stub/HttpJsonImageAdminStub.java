...
import com.google.compute.v1.ImageAdminSettings;
...
@BetaApi
public class HttpJsonImageAdminStub extends ImageAdminStub {
  ...
  public static final HttpJsonImageAdminStub create(ImageAdminSettings settings) throws IOException {
    return new HttpJsonImageAdminStub(settings, ClientContext.create(settings));
  }

  public static final HttpJsonImageAdminStub create(ClientContext clientContext) throws IOException {
    return new HttpJsonImageAdminStub(ImageAdminSettings.defaultBuilder().build(), clientContext);
  }

  /**
   * Constructs an instance of HttpJsonImageAdminStub, using the given settings.
   * This is protected so that it is easy to make a subclass, but otherwise, the static
   * factory methods should be preferred.
   */
  protected HttpJsonImageAdminStub(ImageAdminSettings settings, ClientContext clientContext) throws IOException {
