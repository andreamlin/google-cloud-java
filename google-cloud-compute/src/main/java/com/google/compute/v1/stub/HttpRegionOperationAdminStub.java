...
public class HttpRegionOperationAdminStub extends RegionOperationAdminStub {
  ...
  public static final HttpRegionOperationAdminStub create(RegionOperationAdminSettings settings) throws IOException {
    return new HttpRegionOperationAdminStub(settings, ClientContext.create(settings));
  }

  public static final HttpRegionOperationAdminStub create(ClientContext clientContext) throws IOException {
    return new HttpRegionOperationAdminStub(RegionOperationAdminSettings.defaultBuilder().build(), clientContext);
  }

  /**
   * Constructs an instance of HttpRegionOperationAdminStub, using the given settings.
   * This is protected so that it is easy to make a subclass, but otherwise, the static
   * factory methods should be preferred.
   */
  protected HttpRegionOperationAdminStub(RegionOperationAdminSettings settings, ClientContext clientContext) throws IOException {
