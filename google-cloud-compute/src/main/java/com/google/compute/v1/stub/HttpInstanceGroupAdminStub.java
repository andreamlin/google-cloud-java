...
@BetaApi
public class HttpInstanceGroupAdminStub extends InstanceGroupAdminStub {
  ...
  public static final HttpInstanceGroupAdminStub create(InstanceGroupAdminSettings settings) throws IOException {
    return new HttpInstanceGroupAdminStub(settings, ClientContext.create(settings));
  }

  public static final HttpInstanceGroupAdminStub create(ClientContext clientContext) throws IOException {
    return new HttpInstanceGroupAdminStub(InstanceGroupAdminSettings.defaultBuilder().build(), clientContext);
  }

  /**
   * Constructs an instance of HttpInstanceGroupAdminStub, using the given settings.
   * This is protected so that it is easy to make a subclass, but otherwise, the static
   * factory methods should be preferred.
   */
  protected HttpInstanceGroupAdminStub(InstanceGroupAdminSettings settings, ClientContext clientContext) throws IOException {
