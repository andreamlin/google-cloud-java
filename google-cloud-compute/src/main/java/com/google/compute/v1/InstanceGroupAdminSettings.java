...
/**
 * Settings class to configure an instance of {@link InstanceGroupAdminClient}.
 *
 ...
 * <pre>
 * <code>
 * InstanceGroupAdminSettings.Builder instanceGroupAdminSettingsBuilder =
 *     InstanceGroupAdminSettings.defaultBuilder();
 * instanceGroupAdminSettingsBuilder.addInstancesInstanceGroupSettings().getRetrySettingsBuilder()
 *     .setTotalTimeout(Duration.ofSeconds(30));
 * InstanceGroupAdminSettings instanceGroupAdminSettings = instanceGroupAdminSettingsBuilder.build();
 * </code>
 * </pre>
 */
@Generated("by GAPIC v0.0.5")
@BetaApi
public class InstanceGroupAdminSettings extends ClientSettings {
  /**
  ...
  private static String getGapicVersion() {
    if (gapicVersion == null) {
      gapicVersion = PropertiesProvider.loadProperty(
          InstanceGroupAdminSettings.class, PROPERTIES_FILE, META_VERSION_KEY);
  ...
  private InstanceGroupAdminSettings(Builder settingsBuilder) throws IOException {
    super(
  ...
  private static final PagedListDescriptor<AggregatedListInstanceGroupsHttpRequest, InstanceGroupAggregatedList, InstanceGroup> AGGREGATED_LIST_INSTANCE_GROUPS_PAGE_STR_DESC =
      new PagedListDescriptor<AggregatedListInstanceGroupsHttpRequest, InstanceGroupAggregatedList, InstanceGroup>() {
        ...
        public Iterable<InstanceGroup> extractResources(InstanceGroupAggregatedList payload) {
          return payload.getInstanceGroups();
        }
      };
  ...
  /**
   * Builder for InstanceGroupAdminSettings.
   */
  public static class Builder extends ClientSettings.Builder {
    ...
    private Builder(InstanceGroupAdminSettings settings) {
      super(settings);
    ...
    @Override
    public InstanceGroupAdminSettings build() throws IOException {
      return new InstanceGroupAdminSettings(this);
    }
  }
}