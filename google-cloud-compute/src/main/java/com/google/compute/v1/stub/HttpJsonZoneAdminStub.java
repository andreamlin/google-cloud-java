...
@BetaApi
public class HttpJsonZoneAdminStub extends ZoneAdminStub {
  ...
  public static final HttpJsonZoneAdminStub create(ZoneAdminSettings settings) throws IOException {
    return new HttpJsonZoneAdminStub(settings, ClientContext.create(settings));
  }

  public static final HttpJsonZoneAdminStub create(ClientContext clientContext) throws IOException {
    return new HttpJsonZoneAdminStub(ZoneAdminSettings.defaultBuilder().build(), clientContext);
  }

  /**
   * Constructs an instance of HttpJsonZoneAdminStub, using the given settings.
   * This is protected so that it is easy to make a subclass, but otherwise, the static
   * factory methods should be preferred.
   */
  protected HttpJsonZoneAdminStub(ZoneAdminSettings settings, ClientContext clientContext) throws IOException {
