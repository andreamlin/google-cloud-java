...
public class ITComputeTest {
  ...
  // private static final String DEFAULT_PROJECT = "debian-cloud";
  ...
  public void testGetDiskType() {
    ...
    DiskTypeName.parse("//googleapis.com/projects/proj/zones/z/diskTypes/disk");
    // DiskTypeName returnDiskName = DiskTypeName.parse("//" + diskType.getSelfLink());
  ...
  public void testListDiskTypes() {
    Page<DiskType> diskPage = diskTypeClient.listDiskTypes(ZONE).getPage();
    ...
    while (diskTypeIterator.hasNext()) {
      ...
      assertNotNull(diskType.getId());
      DiskTypeName returnDiskName = DiskTypeName.parse(diskType.getId());
  ...
  //   Page<Image> imagePage = compute.listImages(DEFAULT_PROJECT);
  ...
  //       compute.listImages(DEFAULT_PROJECT, Compute.ImageListOption.fields(Compute.ImageField.ID));
  //   Iterator<Image> imageIterator = imagePage.iterateAll().iterator();
  //   int count = 0;
  //   while (imageIterator.hasNext()) {
  //     count++;
  ...
  //   Page<Image> imagePage = compute.listImages(DEFAULT_PROJECT, Compute.ImageListOption.filter(
