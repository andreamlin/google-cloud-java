...
import static com.google.compute.v1.stub.HttpJsonHealthCheckStub.deleteHealthCheckMethodDescriptor;
import static com.google.compute.v1.stub.HttpJsonHealthCheckStub.getHealthCheckMethodDescriptor;
import static com.google.compute.v1.stub.HttpJsonHealthCheckStub.insertHealthCheckMethodDescriptor;
import static com.google.compute.v1.stub.HttpJsonHealthCheckStub.listHealthChecksMethodDescriptor;
import static com.google.compute.v1.stub.HttpJsonHealthCheckStub.patchHealthCheckMethodDescriptor;
import static com.google.compute.v1.stub.HttpJsonHealthCheckStub.updateHealthCheckMethodDescriptor;
...
public class HealthCheckClientTest {
  ...
  public void deleteHealthCheckTest() {
    ...
    Operation expectedResponse = Operation.newBuilder()
      ...
      .setStatus(status)
      .build();
    MOCK_SERVICE.addResponse(expectedResponse);MOCK_SERVICE.setSerializer(deleteHealthCheckMethodDescriptor);
  ...
  public void getHealthCheckTest() {
    ...
    HealthCheck expectedResponse = HealthCheck.newBuilder()
      ...
      .setId(id)
      .build();
    MOCK_SERVICE.addResponse(expectedResponse);MOCK_SERVICE.setSerializer(getHealthCheckMethodDescriptor);
  ...
  public void insertHealthCheckTest() {
    ...
    Operation expectedResponse = Operation.newBuilder()
      ...
      .setStatus(status)
      .build();
    MOCK_SERVICE.addResponse(expectedResponse);MOCK_SERVICE.setSerializer(insertHealthCheckMethodDescriptor);
  ...
  public void listHealthChecksTest() {
    ...
    HealthCheckList expectedResponse = HealthCheckList.newBuilder()
      ...
      .addAllItems(items)
      .build();
    MOCK_SERVICE.addResponse(expectedResponse);MOCK_SERVICE.setSerializer(listHealthChecksMethodDescriptor);
  ...
  public void patchHealthCheckTest() {
    ...
    Operation expectedResponse = Operation.newBuilder()
      ...
      .setStatus(status)
      .build();
    MOCK_SERVICE.addResponse(expectedResponse);MOCK_SERVICE.setSerializer(patchHealthCheckMethodDescriptor);
  ...
  public void updateHealthCheckTest() {
    ...
    Operation expectedResponse = Operation.newBuilder()
      ...
      .setStatus(status)
      .build();
    MOCK_SERVICE.addResponse(expectedResponse);MOCK_SERVICE.setSerializer(updateHealthCheckMethodDescriptor);
