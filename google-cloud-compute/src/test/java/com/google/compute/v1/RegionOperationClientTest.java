...
public class RegionOperationClientTest {
  ...
  private RegionOperationClient client;
  ...
  public void setUp() throws IOException {
    serviceHelper.reset();
    RegionOperationSettings settings = RegionOperationSettings.newBuilder()
        .setTransportChannelProvider(serviceHelper.createChannelProvider())
        .setCredentialsProvider(NoCredentialsProvider.create())
        .build();
    client = RegionOperationClient.create(settings);
  }
  ...
  public void deleteRegionOperationTest() {
    ...
    mockRegionOperations.addResponse(expectedResponse);
    ...
    List<GeneratedMessageV3> actualRequests = mockRegionOperations.getRequests();
    Assert.assertEquals(1, actualRequests.size());
    DeleteRegionOperationHttpRequest actualRequest = (DeleteRegionOperationHttpRequest)actualRequests.get(0);

    Assert.assertEquals(operation, actualRequest.getOperationAsRegionOperationsOperationName());
  }
  ...
  public void deleteRegionOperationExceptionTest() throws Exception {
    ...
    mockRegionOperations.addException(exception);
  ...
  public void getRegionOperationTest() {
    ...
    List<GeneratedMessageV3> actualRequests = mockRegionOperations.getRequests();
    Assert.assertEquals(1, actualRequests.size());
    GetRegionOperationHttpRequest actualRequest = (GetRegionOperationHttpRequest)actualRequests.get(0);
  ...
  public void listRegionOperationsTest() {
    ...
    List<GeneratedMessageV3> actualRequests = mockRegionOperations.getRequests();
    Assert.assertEquals(1, actualRequests.size());
    ListRegionOperationsHttpRequest actualRequest = (ListRegionOperationsHttpRequest)actualRequests.get(0);
