...
public class ZoneOperationClientTest {
  ...
  private ZoneOperationClient client;
  ...
  public void setUp() throws IOException {
    serviceHelper.reset();
    ZoneOperationSettings settings = ZoneOperationSettings.newBuilder()
        .setTransportChannelProvider(serviceHelper.createChannelProvider())
        .setCredentialsProvider(NoCredentialsProvider.create())
        .build();
    client = ZoneOperationClient.create(settings);
  }
  ...
  public void deleteZoneOperationTest() {
    ...
    mockZoneOperations.addResponse(expectedResponse);
    ...
    List<GeneratedMessageV3> actualRequests = mockZoneOperations.getRequests();
    Assert.assertEquals(1, actualRequests.size());
    DeleteZoneOperationHttpRequest actualRequest = (DeleteZoneOperationHttpRequest)actualRequests.get(0);

    Assert.assertEquals(operation, actualRequest.getOperationAsZoneOperationsOperationName());
  }
  ...
  public void deleteZoneOperationExceptionTest() throws Exception {
    ...
    mockZoneOperations.addException(exception);
  ...
  public void getZoneOperationTest() {
    ...
    List<GeneratedMessageV3> actualRequests = mockZoneOperations.getRequests();
    Assert.assertEquals(1, actualRequests.size());
    GetZoneOperationHttpRequest actualRequest = (GetZoneOperationHttpRequest)actualRequests.get(0);
  ...
  public void listZoneOperationsTest() {
    ...
    List<GeneratedMessageV3> actualRequests = mockZoneOperations.getRequests();
    Assert.assertEquals(1, actualRequests.size());
    ListZoneOperationsHttpRequest actualRequest = (ListZoneOperationsHttpRequest)actualRequests.get(0);
