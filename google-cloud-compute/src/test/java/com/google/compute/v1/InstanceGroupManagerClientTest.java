...
import com.google.compute.v1.stub.InstanceGroupManagerStubSettings;
...
public class InstanceGroupManagerClientTest {
  ...
  public void aggregatedListInstanceGroupManagersTest() {
    ...
    Assert.assertEquals(expectedResponse.getItems().getInstanceGroupManagersList().get(0), resources.get(0));
