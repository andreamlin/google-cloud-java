...
import google.compute.v1.AddressesHttp.AddressesImplBase;
...
public class MockAddressesImpl extends AddressesImplBase {
  ...
  @Override
  public void aggregatedListAddresses(AggregatedListAddressesHttpRequest request,
    StreamObserver<AddressAggregatedList> responseObserver) {
    Object response = responses.remove();
    if (response instanceof AddressAggregatedList) {
      requests.add(request);
      responseObserver.onNext((AddressAggregatedList) response);
