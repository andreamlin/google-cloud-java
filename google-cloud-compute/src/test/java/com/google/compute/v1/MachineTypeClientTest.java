...
public class MachineTypeClientTest {
  ...
  public void aggregatedListMachineTypesTest() {
    ...
    MachineTypeAggregatedList expectedResponse = MachineTypeAggregatedList.newBuilder()
      ...
      .setItems(items)
      .build();
    MOCK_SERVICE.addResponse(expectedResponse);MOCK_SERVICE.setSerializer(aggregatedListMachineTypesMethodDescriptor);
  ...
  public void getMachineTypeTest() {
    ...
    MachineType expectedResponse = MachineType.newBuilder()
      ...
      .build();
    MOCK_SERVICE.addResponse(expectedResponse);MOCK_SERVICE.setSerializer(getMachineTypeMethodDescriptor);
  ...
  public void listMachineTypesTest() {
    ...
    MachineTypeList expectedResponse = MachineTypeList.newBuilder()
      ...
      .addAllItems(items)
      .build();
    MOCK_SERVICE.addResponse(expectedResponse);MOCK_SERVICE.setSerializer(listMachineTypesMethodDescriptor);
