  ...
  static {
    java.lang.String[] descriptorData = {
      "\n3google/cloud/bigquery/storage/v1beta1/"
          ...
          + "1/avro.proto\0328google/cloud/bigquery/stor"
          + "age/v1beta1/read_options.proto\032;google/c"
          + "loud/bigquery/storage/v1beta1/table_refe"
          + "rence.proto\032\033google/protobuf/empty.proto"
          + "\032\037google/protobuf/timestamp.proto\")\n\006Str"
          + "eam\022\014\n\004name\030\001 \001(\t\022\021\n\trow_count\030\002 \001(\003\"_\n\016"
          + "StreamPosition\022=\n\006stream\030\001 \001(\0132-.google."
          + "cloud.bigquery.storage.v1beta1.Stream\022\016\n"
          + "\006offset\030\002 \001(\003\"\200\003\n\013ReadSession\022\014\n\004name\030\001 "
          + "\001(\t\022/\n\013expire_time\030\002 \001(\0132\032.google.protob"
          + "uf.Timestamp\022H\n\013avro_schema\030\005 \001(\01321.goog"
          + "le.cloud.bigquery.storage.v1beta1.AvroSc"
          + "hemaH\000\022>\n\007streams\030\004 \003(\0132-.google.cloud.b"
          + "igquery.storage.v1beta1.Stream\022N\n\017table_"
          + "reference\030\007 \001(\01325.google.cloud.bigquery."
          + "storage.v1beta1.TableReference\022N\n\017table_"
          + "modifiers\030\010 \001(\01325.google.cloud.bigquery."
          + "storage.v1beta1.TableModifiersB\010\n\006schema"
          + "\"\367\002\n\030CreateReadSessionRequest\022N\n\017table_r"
          + "eference\030\001 \001(\01325.google.cloud.bigquery.s"
          + "torage.v1beta1.TableReference\022\016\n\006parent\030"
          + "\006 \001(\t\022N\n\017table_modifiers\030\002 \001(\01325.google."
          + "cloud.bigquery.storage.v1beta1.TableModi"
          + "fiers\022\031\n\021requested_streams\030\003 \001(\005\022M\n\014read"
          + "_options\030\004 \001(\01327.google.cloud.bigquery.s"
          + "torage.v1beta1.TableReadOptions\022A\n\006forma"
          + "t\030\005 \001(\01621.google.cloud.bigquery.storage."
          + "v1beta1.DataFormat\"_\n\017ReadRowsRequest\022L\n"
          + "\rread_position\030\001 \001(\01325.google.cloud.bigq"
          + "uery.storage.v1beta1.StreamPosition\"+\n\014S"
          ...
          + "eta1.AvroRowsH\000\022C\n\006status\030\002 \001(\01323.google"
          + ".cloud.bigquery.storage.v1beta1.StreamSt"
          + "atus\022N\n\017throttle_status\030\005 \001(\01325.google.c"
          + "loud.bigquery.storage.v1beta1.ThrottleSt"
          + "atusB\006\n\004rows\"\206\001\n$BatchCreateReadSessionS"
          + "treamsRequest\022C\n\007session\030\001 \001(\01322.google."
          + "cloud.bigquery.storage.v1beta1.ReadSessi"
          + "on\022\031\n\021requested_streams\030\002 \001(\005\"g\n%BatchCr"
          + "eateReadSessionStreamsResponse\022>\n\007stream"
          + "s\030\001 \003(\0132-.google.cloud.bigquery.storage."
          + "v1beta1.Stream\"V\n\025FinalizeStreamRequest\022"
          + "=\n\006stream\030\002 \001(\0132-.google.cloud.bigquery."
          + "storage.v1beta1.Stream\"`\n\026SplitReadStrea"
          + "mRequest\022F\n\017original_stream\030\001 \001(\0132-.goog"
          + "le.cloud.bigquery.storage.v1beta1.Stream"
          + "\"\251\001\n\027SplitReadStreamResponse\022E\n\016primary_"
          + "stream\030\001 \001(\0132-.google.cloud.bigquery.sto"
          + "rage.v1beta1.Stream\022G\n\020remainder_stream\030"
          + "\002 \001(\0132-.google.cloud.bigquery.storage.v1"
          + "beta1.Stream*3\n\nDataFormat\022\033\n\027DATA_FORMA"
          + "T_UNSPECIFIED\020\000\022\010\n\004AVRO\020\0012\307\010\n\017BigQuerySt"
          + "orage\022\207\002\n\021CreateReadSession\022?.google.clo"
          + "ud.bigquery.storage.v1beta1.CreateReadSe"
          + "ssionRequest\0322.google.cloud.bigquery.sto"
          + "rage.v1beta1.ReadSession\"}\202\323\344\223\002w\"0/v1bet"
          + "a1/{table_reference.project_id=projects/"
          + "*}:\001*Z@\";/v1beta1/{table_reference.datas"
          + "et_id=projects/*/datasets/*}:\001*\022\300\001\n\010Read"
          + "Rows\0226.google.cloud.bigquery.storage.v1b"
          + "eta1.ReadRowsRequest\0327.google.cloud.bigq"
          + "uery.storage.v1beta1.ReadRowsResponse\"A\202"
          + "\323\344\223\002;\0229/v1beta1/{read_position.stream.na"
          + "me=projects/*/streams/*}0\001\022\364\001\n\035BatchCrea"
          + "teReadSessionStreams\022K.google.cloud.bigq"
          + "uery.storage.v1beta1.BatchCreateReadSess"
          + "ionStreamsRequest\032L.google.cloud.bigquer"
          + "y.storage.v1beta1.BatchCreateReadSession"
          + "StreamsResponse\"8\202\323\344\223\0022\"-/v1beta1/{sessi"
          + "on.name=projects/*/sessions/*}:\001*\022\236\001\n\016Fi"
          + "nalizeStream\022<.google.cloud.bigquery.sto"
          + "rage.v1beta1.FinalizeStreamRequest\032\026.goo"
          + "gle.protobuf.Empty\"6\202\323\344\223\0020\"+/v1beta1/{st"
          + "ream.name=projects/*/streams/*}:\001*\022\316\001\n\017S"
          ...
          + "litReadStreamResponse\"<\202\323\344\223\0026\0224/v1beta1/"
          + "{original_stream.name=projects/*/streams"
          + "/*}By\n)com.google.cloud.bigquery.storage"
          + ".v1beta1ZLgoogle.golang.org/genproto/goo"
          + "gleapis/cloud/bigquery/storage/v1beta1;s"
          + "torageb\006proto3"
    };
    ...
    internal_static_google_cloud_bigquery_storage_v1beta1_ReadRowsResponse_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
            internal_static_google_cloud_bigquery_storage_v1beta1_ReadRowsResponse_descriptor,
            new java.lang.String[] {
              "AvroRows", "Status", "ThrottleStatus", "Rows",
            });
    internal_static_google_cloud_bigquery_storage_v1beta1_BatchCreateReadSessionStreamsRequest_descriptor =
