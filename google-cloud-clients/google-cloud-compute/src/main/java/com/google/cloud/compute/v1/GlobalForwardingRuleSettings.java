...
public class GlobalForwardingRuleSettings extends ClientSettings<GlobalForwardingRuleSettings> {
  ...
  protected GlobalForwardingRuleSettings(Builder settingsBuilder) throws IOException {
    super(settingsBuilder);
  }

  /** Builder for GlobalForwardingRuleSettings. */
  public static class Builder
      extends ClientSettings.Builder<GlobalForwardingRuleSettings, Builder> {
    ...
    protected Builder(GlobalForwardingRuleSettings settings) {
      super(settings.getStubSettings().toBuilder());
    }

    protected Builder(GlobalForwardingRuleStubSettings.Builder stubSettings) {
      super(stubSettings);
    }
