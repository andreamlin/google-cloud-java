...
/**
 * Settings class to configure an instance of {@link InterconnectStub}.
 *
...
@BetaApi
public class InterconnectStubSettings extends StubSettings<InterconnectStubSettings> {
  ...
  private static final PagedListDescriptor<
      ...
      LIST_INTERCONNECTS_PAGE_STR_DESC =
          new PagedListDescriptor<ListInterconnectsHttpRequest, InterconnectList, Interconnect>() {
            @Override
      ...
      LIST_INTERCONNECTS_PAGE_STR_FACT =
          new PagedListResponseFactory<
            ...
            public ApiFuture<ListInterconnectsPagedResponse> getFuturePagedResponse(
                UnaryCallable<ListInterconnectsHttpRequest, InterconnectList> callable,
                ListInterconnectsHttpRequest request,
                ApiCallContext context,
                ApiFuture<InterconnectList> futureResponse) {
              PageContext<ListInterconnectsHttpRequest, InterconnectList, Interconnect>
                  pageContext =
                      PageContext.create(
  ...
  public static class Builder extends StubSettings.Builder<InterconnectStubSettings, Builder> {
