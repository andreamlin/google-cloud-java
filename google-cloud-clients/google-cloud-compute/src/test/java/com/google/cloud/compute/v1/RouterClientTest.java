...
import static com.google.cloud.compute.v1.stub.HttpJsonRouterStub.listRoutersMethodDescriptor;
import static com.google.cloud.compute.v1.stub.HttpJsonRouterStub.patchRouterMethodDescriptor;
import static com.google.cloud.compute.v1.stub.HttpJsonRouterStub.previewRouterMethodDescriptor;
import static com.google.cloud.compute.v1.stub.HttpJsonRouterStub.updateRouterMethodDescriptor;
...
public class RouterClientTest {
  ...
  public static void setUp() throws IOException {
    clientSettings =
        RouterSettings.newBuilder()
            ...
            .build();
    client = RouterClient.create(clientSettings);
  }
  ...
  public void aggregatedListRoutersTest() {
    ...
    RoutersScopedList itemsItem = RoutersScopedList.newBuilder().build();
    Map<String, RoutersScopedList> items = new HashMap<>();
  ...
  public void getRouterTest() {
    ...
    Router actualResponse = client.getRouter(router);
    Assert.assertEquals(expectedResponse, actualResponse);
  ...
  public void getRouterStatusRouterTest() {
    String kind = "kind3292052";
    RouterStatusResponse expectedResponse = RouterStatusResponse.newBuilder().setKind(kind).build();
    mockService.addResponse(expectedResponse);

    ProjectRegionRouterName router =
        ProjectRegionRouterName.of("[PROJECT]", "[REGION]", "[ROUTER]");

    RouterStatusResponse actualResponse = client.getRouterStatusRouter(router);
    Assert.assertEquals(expectedResponse, actualResponse);
